...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<BlockRecordHandlingOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<BlockRecordHandlingOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<BlockRecordHandlingOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<BlockRecordHandlingOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<BlockRecordHandlingOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.BlockRecordHandlingOp: Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Tags = {systemUnderTest.Tags?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<BlockRecordHandlingOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<BlockRecordHandlingOp>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<BlockRecordHandlingOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<BlockRecordHandlingOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<BlockRecordHandlingOp>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<BlockRecordHandlingOp>
                        {
                            SystemUnderTest = new BlockRecordHandlingOp(
                                                      referenceObject.Details,
                                                      referenceObject.Tags),
        ...
        private static readonly DeepCloneWithTestScenarios<BlockRecordHandlingOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<BlockRecordHandlingOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BlockRecordHandlingOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<BlockRecordHandlingOp>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));

                        var result = new SystemUnderTestDeepCloneWithValue<BlockRecordHandlingOp>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<BlockRecordHandlingOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<BlockRecordHandlingOp>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
        ...
        private static readonly BlockRecordHandlingOp ReferenceObjectForEquatableTestScenarios = A.Dummy<BlockRecordHandlingOp>();

        private static readonly EquatableTestScenarios<BlockRecordHandlingOp> EquatableTestScenarios = new EquatableTestScenarios<BlockRecordHandlingOp>()
            .AddScenario(() =>
                new EquatableTestScenario<BlockRecordHandlingOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new BlockRecordHandlingOp[]
                    {
                        new BlockRecordHandlingOp(
                                ReferenceObjectForEquatableTestScenarios.Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new BlockRecordHandlingOp[]
                    {
                        new BlockRecordHandlingOp(
                                A.Dummy<BlockRecordHandlingOp>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new BlockRecordHandlingOp(
                                ReferenceObjectForEquatableTestScenarios.Details,
                                A.Dummy<BlockRecordHandlingOp>().Whose(_ => !_.Tags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Tags)).Tags),
                    },
        ...
        public static class Structural
        {
            ...
            public static void BlockRecordHandlingOp___Should_implement_IModel_of_BlockRecordHandlingOp___When_reflecting()
            {
                // Arrange
                var type = typeof(BlockRecordHandlingOp);

                var expectedModelMethods = typeof(IModel<BlockRecordHandlingOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<BlockRecordHandlingOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void BlockRecordHandlingOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(BlockRecordHandlingOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (BlockRecordHandlingOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (BlockRecordHandlingOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(BlockRecordHandlingOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<BlockRecordHandlingOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                BlockRecordHandlingOp systemUnderTest1 = null;
                BlockRecordHandlingOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    BlockRecordHandlingOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BlockRecordHandlingOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BlockRecordHandlingOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BlockRecordHandlingOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BlockRecordHandlingOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_BlockRecordHandlingOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
