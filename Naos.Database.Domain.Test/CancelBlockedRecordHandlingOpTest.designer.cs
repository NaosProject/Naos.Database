...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CancelBlockedRecordHandlingOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CancelBlockedRecordHandlingOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CancelBlockedRecordHandlingOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CancelBlockedRecordHandlingOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CancelBlockedRecordHandlingOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.CancelBlockedRecordHandlingOp: Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Tags = {systemUnderTest.Tags?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CancelBlockedRecordHandlingOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CancelBlockedRecordHandlingOp>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CancelBlockedRecordHandlingOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CancelBlockedRecordHandlingOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CancelBlockedRecordHandlingOp>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CancelBlockedRecordHandlingOp>
                        {
                            SystemUnderTest = new CancelBlockedRecordHandlingOp(
                                                      referenceObject.Details,
                                                      referenceObject.Tags),
        ...
        private static readonly DeepCloneWithTestScenarios<CancelBlockedRecordHandlingOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CancelBlockedRecordHandlingOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CancelBlockedRecordHandlingOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CancelBlockedRecordHandlingOp>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));

                        var result = new SystemUnderTestDeepCloneWithValue<CancelBlockedRecordHandlingOp>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CancelBlockedRecordHandlingOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CancelBlockedRecordHandlingOp>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
        ...
        private static readonly CancelBlockedRecordHandlingOp ReferenceObjectForEquatableTestScenarios = A.Dummy<CancelBlockedRecordHandlingOp>();

        private static readonly EquatableTestScenarios<CancelBlockedRecordHandlingOp> EquatableTestScenarios = new EquatableTestScenarios<CancelBlockedRecordHandlingOp>()
            .AddScenario(() =>
                new EquatableTestScenario<CancelBlockedRecordHandlingOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CancelBlockedRecordHandlingOp[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new CancelBlockedRecordHandlingOp[]
                    {
                        new CancelBlockedRecordHandlingOp(
                                A.Dummy<CancelBlockedRecordHandlingOp>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new CancelBlockedRecordHandlingOp(
                                ReferenceObjectForEquatableTestScenarios.Details,
                                A.Dummy<CancelBlockedRecordHandlingOp>().Whose(_ => !_.Tags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Tags)).Tags),
                    },
        ...
        public static class Structural
        {
            ...
            public static void CancelBlockedRecordHandlingOp___Should_implement_IModel_of_CancelBlockedRecordHandlingOp___When_reflecting()
            {
                // Arrange
                var type = typeof(CancelBlockedRecordHandlingOp);

                var expectedModelMethods = typeof(IModel<CancelBlockedRecordHandlingOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CancelBlockedRecordHandlingOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CancelBlockedRecordHandlingOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CancelBlockedRecordHandlingOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CancelBlockedRecordHandlingOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CancelBlockedRecordHandlingOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CancelBlockedRecordHandlingOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CancelBlockedRecordHandlingOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CancelBlockedRecordHandlingOp systemUnderTest1 = null;
                CancelBlockedRecordHandlingOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CancelBlockedRecordHandlingOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CancelBlockedRecordHandlingOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CancelBlockedRecordHandlingOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CancelBlockedRecordHandlingOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CancelBlockedRecordHandlingOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CancelBlockedRecordHandlingOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
