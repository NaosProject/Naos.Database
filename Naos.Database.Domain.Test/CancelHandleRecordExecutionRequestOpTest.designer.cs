...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CancelHandleRecordExecutionRequestOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CancelHandleRecordExecutionRequestOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CancelHandleRecordExecutionRequestOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<CancelHandleRecordExecutionRequestOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.CancelHandleRecordExecutionRequestOp: Id = {systemUnderTest.Id.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Tags = {systemUnderTest.Tags?.ToString() ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CancelHandleRecordExecutionRequestOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CancelHandleRecordExecutionRequestOp>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CancelHandleRecordExecutionRequestOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CancelHandleRecordExecutionRequestOp>()
            .AddScenario(() =>
        ...
        private static readonly DeepCloneWithTestScenarios<CancelHandleRecordExecutionRequestOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CancelHandleRecordExecutionRequestOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CancelHandleRecordExecutionRequestOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CancelHandleRecordExecutionRequestOp>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CancelHandleRecordExecutionRequestOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CancelHandleRecordExecutionRequestOp>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
        ...
        private static readonly CancelHandleRecordExecutionRequestOp ReferenceObjectForEquatableTestScenarios = A.Dummy<CancelHandleRecordExecutionRequestOp>();

        private static readonly EquatableTestScenarios<CancelHandleRecordExecutionRequestOp> EquatableTestScenarios = new EquatableTestScenarios<CancelHandleRecordExecutionRequestOp>()
            .AddScenario(() =>
                new EquatableTestScenario<CancelHandleRecordExecutionRequestOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CancelHandleRecordExecutionRequestOp[]
                    {
        ...
        public static class Structural
        {
            ...
            public static void CancelHandleRecordExecutionRequestOp___Should_implement_IModel_of_CancelHandleRecordExecutionRequestOp___When_reflecting()
            {
                // Arrange
                var type = typeof(CancelHandleRecordExecutionRequestOp);

                var expectedModelMethods = typeof(IModel<CancelHandleRecordExecutionRequestOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CancelHandleRecordExecutionRequestOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CancelHandleRecordExecutionRequestOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CancelHandleRecordExecutionRequestOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CancelHandleRecordExecutionRequestOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CancelHandleRecordExecutionRequestOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CancelHandleRecordExecutionRequestOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CancelHandleRecordExecutionRequestOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CancelHandleRecordExecutionRequestOp systemUnderTest1 = null;
                CancelHandleRecordExecutionRequestOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CancelHandleRecordExecutionRequestOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CancelHandleRecordExecutionRequestOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CancelHandleRecordExecutionRequestOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CancelHandleRecordExecutionRequestOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CancelHandleRecordExecutionRequestOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CancelHandleRecordExecutionRequestOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
