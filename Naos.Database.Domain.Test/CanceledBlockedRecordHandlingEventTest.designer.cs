...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CanceledBlockedRecordHandlingEvent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CanceledBlockedRecordHandlingEvent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CanceledBlockedRecordHandlingEvent>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CanceledBlockedRecordHandlingEvent>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CanceledBlockedRecordHandlingEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.CanceledBlockedRecordHandlingEvent: TimestampUtc = {systemUnderTest.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CanceledBlockedRecordHandlingEvent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CanceledBlockedRecordHandlingEvent>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CanceledBlockedRecordHandlingEvent>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'details' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CanceledBlockedRecordHandlingEvent>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CanceledBlockedRecordHandlingEvent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CanceledBlockedRecordHandlingEvent>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CanceledBlockedRecordHandlingEvent>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CanceledBlockedRecordHandlingEvent>
                        {
                            SystemUnderTest = new CanceledBlockedRecordHandlingEvent(
        ...
        private static readonly DeepCloneWithTestScenarios<CanceledBlockedRecordHandlingEvent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CanceledBlockedRecordHandlingEvent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CanceledBlockedRecordHandlingEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CanceledBlockedRecordHandlingEvent>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));

                        var result = new SystemUnderTestDeepCloneWithValue<CanceledBlockedRecordHandlingEvent>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CanceledBlockedRecordHandlingEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CanceledBlockedRecordHandlingEvent>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
        ...
        private static readonly CanceledBlockedRecordHandlingEvent ReferenceObjectForEquatableTestScenarios = A.Dummy<CanceledBlockedRecordHandlingEvent>();

        private static readonly EquatableTestScenarios<CanceledBlockedRecordHandlingEvent> EquatableTestScenarios = new EquatableTestScenarios<CanceledBlockedRecordHandlingEvent>()
            .AddScenario(() =>
                new EquatableTestScenario<CanceledBlockedRecordHandlingEvent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CanceledBlockedRecordHandlingEvent[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new CanceledBlockedRecordHandlingEvent[]
                    {
                        new CanceledBlockedRecordHandlingEvent(
                                ReferenceObjectForEquatableTestScenarios.Details,
                                A.Dummy<CanceledBlockedRecordHandlingEvent>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc),
                        new CanceledBlockedRecordHandlingEvent(
                                A.Dummy<CanceledBlockedRecordHandlingEvent>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc),
                    },
        ...
        public static class Structural
        {
            ...
            public static void CanceledBlockedRecordHandlingEvent___Should_implement_IModel_of_CanceledBlockedRecordHandlingEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(CanceledBlockedRecordHandlingEvent);

                var expectedModelMethods = typeof(IModel<CanceledBlockedRecordHandlingEvent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CanceledBlockedRecordHandlingEvent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CanceledBlockedRecordHandlingEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CanceledBlockedRecordHandlingEvent);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CanceledBlockedRecordHandlingEvent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CanceledBlockedRecordHandlingEvent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CanceledBlockedRecordHandlingEvent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CanceledBlockedRecordHandlingEvent>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CanceledBlockedRecordHandlingEvent systemUnderTest1 = null;
                CanceledBlockedRecordHandlingEvent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CanceledBlockedRecordHandlingEvent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CanceledBlockedRecordHandlingEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CanceledBlockedRecordHandlingEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CanceledBlockedRecordHandlingEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CanceledBlockedRecordHandlingEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CanceledBlockedRecordHandlingEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
