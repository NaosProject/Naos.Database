...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CanceledRequestedHandleRecordExecutionEvent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CanceledRequestedHandleRecordExecutionEvent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CanceledRequestedHandleRecordExecutionEvent>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CanceledRequestedHandleRecordExecutionEvent>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CanceledRequestedHandleRecordExecutionEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.CanceledRequestedHandleRecordExecutionEvent: TimestampUtc = {systemUnderTest.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Id = {systemUnderTest.Id.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CanceledRequestedHandleRecordExecutionEvent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CanceledRequestedHandleRecordExecutionEvent>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CanceledRequestedHandleRecordExecutionEvent>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'details' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CanceledRequestedHandleRecordExecutionEvent>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CanceledRequestedHandleRecordExecutionEvent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CanceledRequestedHandleRecordExecutionEvent>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CanceledRequestedHandleRecordExecutionEvent>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CanceledRequestedHandleRecordExecutionEvent>
                        {
                            SystemUnderTest = new CanceledRequestedHandleRecordExecutionEvent(
                                                      referenceObject.Id,
        ...
        private static readonly DeepCloneWithTestScenarios<CanceledRequestedHandleRecordExecutionEvent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CanceledRequestedHandleRecordExecutionEvent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CanceledRequestedHandleRecordExecutionEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CanceledRequestedHandleRecordExecutionEvent>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));

                        var result = new SystemUnderTestDeepCloneWithValue<CanceledRequestedHandleRecordExecutionEvent>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CanceledRequestedHandleRecordExecutionEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CanceledRequestedHandleRecordExecutionEvent>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CanceledRequestedHandleRecordExecutionEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CanceledRequestedHandleRecordExecutionEvent>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
        ...
        private static readonly CanceledRequestedHandleRecordExecutionEvent ReferenceObjectForEquatableTestScenarios = A.Dummy<CanceledRequestedHandleRecordExecutionEvent>();

        private static readonly EquatableTestScenarios<CanceledRequestedHandleRecordExecutionEvent> EquatableTestScenarios = new EquatableTestScenarios<CanceledRequestedHandleRecordExecutionEvent>()
            .AddScenario(() =>
                new EquatableTestScenario<CanceledRequestedHandleRecordExecutionEvent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CanceledRequestedHandleRecordExecutionEvent[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new CanceledRequestedHandleRecordExecutionEvent[]
                    {
                        new CanceledRequestedHandleRecordExecutionEvent(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                A.Dummy<CanceledRequestedHandleRecordExecutionEvent>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc),
                        new CanceledRequestedHandleRecordExecutionEvent(
                                A.Dummy<CanceledRequestedHandleRecordExecutionEvent>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc),
                        new CanceledRequestedHandleRecordExecutionEvent(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<CanceledRequestedHandleRecordExecutionEvent>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc),
                    },
        ...
        public static class Structural
        {
            ...
            public static void CanceledRequestedHandleRecordExecutionEvent___Should_implement_IModel_of_CanceledRequestedHandleRecordExecutionEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(CanceledRequestedHandleRecordExecutionEvent);

                var expectedModelMethods = typeof(IModel<CanceledRequestedHandleRecordExecutionEvent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CanceledRequestedHandleRecordExecutionEvent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CanceledRequestedHandleRecordExecutionEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CanceledRequestedHandleRecordExecutionEvent);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CanceledRequestedHandleRecordExecutionEvent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CanceledRequestedHandleRecordExecutionEvent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CanceledRequestedHandleRecordExecutionEvent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CanceledRequestedHandleRecordExecutionEvent>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CanceledRequestedHandleRecordExecutionEvent systemUnderTest1 = null;
                CanceledRequestedHandleRecordExecutionEvent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CanceledRequestedHandleRecordExecutionEvent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CanceledRequestedHandleRecordExecutionEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CanceledRequestedHandleRecordExecutionEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CanceledRequestedHandleRecordExecutionEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CanceledRequestedHandleRecordExecutionEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CanceledRequestedHandleRecordExecutionEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
