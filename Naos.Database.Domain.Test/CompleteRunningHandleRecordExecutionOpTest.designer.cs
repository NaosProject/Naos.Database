...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CompleteRunningHandleRecordExecutionOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CompleteRunningHandleRecordExecutionOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CompleteRunningHandleRecordExecutionOp>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CompleteRunningHandleRecordExecutionOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CompleteRunningHandleRecordExecutionOp>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CompleteRunningHandleRecordExecutionOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CompleteRunningHandleRecordExecutionOp>()
            .AddScenario(() =>
        ...
        private static readonly DeepCloneWithTestScenarios<CompleteRunningHandleRecordExecutionOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CompleteRunningHandleRecordExecutionOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompleteRunningHandleRecordExecutionOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompleteRunningHandleRecordExecutionOp>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompleteRunningHandleRecordExecutionOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompleteRunningHandleRecordExecutionOp>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompleteRunningHandleRecordExecutionOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompleteRunningHandleRecordExecutionOp>().ThatIs(_ => !systemUnderTest.SpecifiedResourceLocator.IsEqualTo(_.SpecifiedResourceLocator));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompleteRunningHandleRecordExecutionOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompleteRunningHandleRecordExecutionOp>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
        ...
        private static readonly CompleteRunningHandleRecordExecutionOp ReferenceObjectForEquatableTestScenarios = A.Dummy<CompleteRunningHandleRecordExecutionOp>();

        private static readonly EquatableTestScenarios<CompleteRunningHandleRecordExecutionOp> EquatableTestScenarios = new EquatableTestScenarios<CompleteRunningHandleRecordExecutionOp>()
            .AddScenario(() =>
                new EquatableTestScenario<CompleteRunningHandleRecordExecutionOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CompleteRunningHandleRecordExecutionOp[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new CompleteRunningHandleRecordExecutionOp[]
                    {
                        ...
                        new CompleteRunningHandleRecordExecutionOp(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Concern,
                                A.Dummy<CompleteRunningHandleRecordExecutionOp>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details,
                                ReferenceObjectForEquatableTestScenarios.SpecifiedResourceLocator,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new CompleteRunningHandleRecordExecutionOp(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Concern,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                A.Dummy<CompleteRunningHandleRecordExecutionOp>().Whose(_ => !_.SpecifiedResourceLocator.IsEqualTo(ReferenceObjectForEquatableTestScenarios.SpecifiedResourceLocator)).SpecifiedResourceLocator,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new CompleteRunningHandleRecordExecutionOp(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Concern,
        ...
        public static class Structural
        {
            ...
            public static void CompleteRunningHandleRecordExecutionOp___Should_implement_IModel_of_CompleteRunningHandleRecordExecutionOp___When_reflecting()
            {
                // Arrange
                var type = typeof(CompleteRunningHandleRecordExecutionOp);

                var expectedModelMethods = typeof(IModel<CompleteRunningHandleRecordExecutionOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CompleteRunningHandleRecordExecutionOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CompleteRunningHandleRecordExecutionOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CompleteRunningHandleRecordExecutionOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CompleteRunningHandleRecordExecutionOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CompleteRunningHandleRecordExecutionOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CompleteRunningHandleRecordExecutionOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CompleteRunningHandleRecordExecutionOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CompleteRunningHandleRecordExecutionOp systemUnderTest1 = null;
                CompleteRunningHandleRecordExecutionOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CompleteRunningHandleRecordExecutionOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompleteRunningHandleRecordExecutionOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompleteRunningHandleRecordExecutionOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompleteRunningHandleRecordExecutionOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompleteRunningHandleRecordExecutionOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompleteRunningHandleRecordExecutionOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
