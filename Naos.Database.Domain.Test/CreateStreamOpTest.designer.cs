                ...
                new StringRepresentationTestScenario<CreateStreamOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<CreateStreamOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.CreateStreamOp: StreamRepresentation = {systemUnderTest.StreamRepresentation?.ToString() ?? "<null>"}, ExistingStreamEncounteredStrategy = {systemUnderTest.ExistingStreamEncounteredStrategy.ToString() ?? "<null>"}."),
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CreateStreamOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CreateStreamOp>().ThatIs(_ => !systemUnderTest.ExistingStreamEncounteredStrategy.IsEqualTo(_.ExistingStreamEncounteredStrategy));
            ...
            .AddScenario(() =>
                new EquatableTestScenario<CreateStreamOp>
                {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new CreateStreamOp[]
                    {
                        ...
                        new CreateStreamOp(
                                ReferenceObjectForEquatableTestScenarios.StreamRepresentation,
                                A.Dummy<CreateStreamOp>().Whose(_ => !_.ExistingStreamEncounteredStrategy.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ExistingStreamEncounteredStrategy)).ExistingStreamEncounteredStrategy),
                    },
