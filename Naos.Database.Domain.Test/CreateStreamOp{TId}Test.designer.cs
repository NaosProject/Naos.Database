    ...
    public static partial class CreateStreamOpTest
    {
                ...
                new StringRepresentationTestScenario<CreateStreamOp<Version>>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<CreateStreamOp<Version>>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.CreateStreamOp<Version>: StreamRepresentation = {systemUnderTest.StreamRepresentation?.ToString() ?? "<null>"}, ExistingStreamEncounteredStrategy = {systemUnderTest.ExistingStreamEncounteredStrategy.ToString() ?? "<null>"}."),
                        };
        ...
        public static class Structural
        {
            ...
            public static void CreateStreamOp___Should_implement_IModel_of_CreateStreamOp___When_reflecting()
            {
                ...
                var expectedModelMethods = typeof(IModel<CreateStreamOp<Version>>).GetInterfaceDeclaredAndImplementedMethods();
        ...
        public static class Cloning
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(CreateStreamOp<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
