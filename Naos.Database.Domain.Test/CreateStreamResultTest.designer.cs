...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class CreateStreamResultTest
    {
        ...
        private static readonly DeepCloneWithTestScenarios<CreateStreamResult> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CreateStreamResult>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CreateStreamResult>
                {
                    Name = "DeepCloneWithAlreadyExisted should deep clone object and replace AlreadyExisted with the provided alreadyExisted",
                    WithPropertyName = "AlreadyExisted",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CreateStreamResult>();

                        var referenceObject = A.Dummy<CreateStreamResult>().ThatIs(_ => !systemUnderTest.AlreadyExisted.IsEqualTo(_.AlreadyExisted));

                        var result = new SystemUnderTestDeepCloneWithValue<CreateStreamResult>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.AlreadyExisted,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CreateStreamResult>
                {
                    Name = "DeepCloneWithWasCreated should deep clone object and replace WasCreated with the provided wasCreated",
                    WithPropertyName = "WasCreated",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CreateStreamResult>();

                        var referenceObject = A.Dummy<CreateStreamResult>().ThatIs(_ => !systemUnderTest.WasCreated.IsEqualTo(_.WasCreated));

                        var result = new SystemUnderTestDeepCloneWithValue<CreateStreamResult>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.WasCreated,
                        };
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "AlreadyExisted", "WasCreated" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CreateStreamResult)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CreateStreamResult).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Equality
        {
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateStreamResult___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateStreamResult___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateStreamResult___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateStreamResult___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateStreamResult___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
