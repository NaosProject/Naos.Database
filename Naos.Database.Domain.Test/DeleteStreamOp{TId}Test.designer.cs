...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<DeleteStreamOp<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<DeleteStreamOp<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<DeleteStreamOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<DeleteStreamOp<Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<DeleteStreamOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.DeleteStreamOp<Version>: StreamRepresentation = {systemUnderTest.StreamRepresentation?.ToString() ?? "<null>"}, ExistingStreamNotEncounteredStrategy = {systemUnderTest.ExistingStreamNotEncounteredStrategy.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<DeleteStreamOp<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<DeleteStreamOp<Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<DeleteStreamOp<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'streamRepresentation' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<DeleteStreamOp<Version>>();

                        var result = new DeleteStreamOp<Version>(
                                             null,
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<DeleteStreamOp<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<DeleteStreamOp<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<DeleteStreamOp<Version>>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<DeleteStreamOp<Version>>
                        {
                            SystemUnderTest = new DeleteStreamOp<Version>(
        ...
        private static readonly DeepCloneWithTestScenarios<DeleteStreamOp<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<DeleteStreamOp<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DeleteStreamOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DeleteStreamOp<Version>>().ThatIs(_ => !systemUnderTest.StreamRepresentation.IsEqualTo(_.StreamRepresentation));

                        var result = new SystemUnderTestDeepCloneWithValue<DeleteStreamOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DeleteStreamOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DeleteStreamOp<Version>>().ThatIs(_ => !systemUnderTest.ExistingStreamNotEncounteredStrategy.IsEqualTo(_.ExistingStreamNotEncounteredStrategy));
        ...
        private static readonly DeleteStreamOp<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<DeleteStreamOp<Version>>();

        private static readonly EquatableTestScenarios<DeleteStreamOp<Version>> EquatableTestScenarios = new EquatableTestScenarios<DeleteStreamOp<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<DeleteStreamOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new DeleteStreamOp<Version>[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new DeleteStreamOp<Version>[]
                    {
                        new DeleteStreamOp<Version>(
                                A.Dummy<DeleteStreamOp<Version>>().Whose(_ => !_.StreamRepresentation.IsEqualTo(ReferenceObjectForEquatableTestScenarios.StreamRepresentation)).StreamRepresentation,
                                ReferenceObjectForEquatableTestScenarios.ExistingStreamNotEncounteredStrategy),
                        new DeleteStreamOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.StreamRepresentation,
                                A.Dummy<DeleteStreamOp<Version>>().Whose(_ => !_.ExistingStreamNotEncounteredStrategy.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ExistingStreamNotEncounteredStrategy)).ExistingStreamNotEncounteredStrategy),
                    },
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(DeleteStreamOp<Version>);

                var expectedModelMethods = typeof(IModel<DeleteStreamOp<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<DeleteStreamOp<Version>>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (DeleteStreamOp<Version>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (DeleteStreamOp<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(DeleteStreamOp<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<DeleteStreamOp<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                DeleteStreamOp<Version> systemUnderTest1 = null;
                DeleteStreamOp<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    DeleteStreamOp<Version> systemUnderTest = null;
