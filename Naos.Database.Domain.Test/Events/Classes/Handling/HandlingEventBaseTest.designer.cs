...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly HandlingEventBase ReferenceObjectForEquatableTestScenarios = A.Dummy<HandlingEventBase>();

        private static readonly EquatableTestScenarios<HandlingEventBase> EquatableTestScenarios = new EquatableTestScenarios<HandlingEventBase>()
            .AddScenario(() =>
                new EquatableTestScenario<HandlingEventBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new HandlingEventBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new HandlingEventBase[]
                    {
                        ...
                        // (HandlingEventBase)ReferenceObjectForEquatableTestScenarios.DeepCloneWithTimestampUtc(A.Dummy<HandlingEventBase>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithDetails(A.Dummy<HandlingEventBase>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new HandlingEventBase[]
                    {
                        A.Dummy<HandlingEventBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class StructuralTesting
        {
            ...
            public static void HandlingEventBase___Should_implement_IModel_of_HandlingEventBase___When_reflecting()
            {
                // Arrange
                var type = typeof(HandlingEventBase);

                var expectedModelMethods = typeof(IModel<HandlingEventBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<HandlingEventBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void HandlingEventBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(HandlingEventBase);
        ...
        public static class CloningTesting
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<HandlingEventBase>();

                // Act
                var actual = (HandlingEventBase)systemUnderTest.Clone();
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<HandlingEventBase>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                HandlingEventBase systemUnderTest1 = null;
                HandlingEventBase systemUnderTest2 = null;
