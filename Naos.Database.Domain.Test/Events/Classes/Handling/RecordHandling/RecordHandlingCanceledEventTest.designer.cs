...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class RecordHandlingCanceledEventTest
    {
        ...
        private static readonly ValidModelTestScenarios<RecordHandlingCanceledEvent> ValidModelTestScenarios = new ValidModelTestScenarios<RecordHandlingCanceledEvent>()
            .AddScenario(() =>
                new ValidModelTestScenario<RecordHandlingCanceledEvent>
                {
                    Name = "a dummy RecordHandlingCanceledEvent should be valid",
                    SystemUnderTest = A.Dummy<RecordHandlingCanceledEvent>(),
                });
