...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<RecordHandlingFailedEvent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<RecordHandlingFailedEvent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<RecordHandlingFailedEvent>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<RecordHandlingFailedEvent>();

                        var result = new SystemUnderTestExpectedStringRepresentation<RecordHandlingFailedEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.RecordHandlingFailedEvent: TimestampUtc = {systemUnderTest.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Concern = {systemUnderTest.Concern?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, InternalRecordId = {systemUnderTest.InternalRecordId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<RecordHandlingFailedEvent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<RecordHandlingFailedEvent>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<RecordHandlingFailedEvent>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'concern' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<RecordHandlingFailedEvent>();

                        var result = new RecordHandlingFailedEvent(
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<RecordHandlingFailedEvent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<RecordHandlingFailedEvent>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<RecordHandlingFailedEvent>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<RecordHandlingFailedEvent>
                        {
                            SystemUnderTest = new RecordHandlingFailedEvent(
                                                      referenceObject.InternalRecordId,
                                                      referenceObject.Concern,
                                                      referenceObject.TimestampUtc,
                                                      referenceObject.Details),
        ...
        private static readonly DeepCloneWithTestScenarios<RecordHandlingFailedEvent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<RecordHandlingFailedEvent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RecordHandlingFailedEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RecordHandlingFailedEvent>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));

                        var result = new SystemUnderTestDeepCloneWithValue<RecordHandlingFailedEvent>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RecordHandlingFailedEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RecordHandlingFailedEvent>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RecordHandlingFailedEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RecordHandlingFailedEvent>().ThatIs(_ => !systemUnderTest.Concern.IsEqualTo(_.Concern));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RecordHandlingFailedEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RecordHandlingFailedEvent>().ThatIs(_ => !systemUnderTest.InternalRecordId.IsEqualTo(_.InternalRecordId));
        ...
        private static readonly RecordHandlingFailedEvent ReferenceObjectForEquatableTestScenarios = A.Dummy<RecordHandlingFailedEvent>();

        private static readonly EquatableTestScenarios<RecordHandlingFailedEvent> EquatableTestScenarios = new EquatableTestScenarios<RecordHandlingFailedEvent>()
            .AddScenario(() =>
                new EquatableTestScenario<RecordHandlingFailedEvent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new RecordHandlingFailedEvent[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new RecordHandlingFailedEvent[]
                    {
                        new RecordHandlingFailedEvent(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Concern,
                                A.Dummy<RecordHandlingFailedEvent>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details),
                        new RecordHandlingFailedEvent(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Concern,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                A.Dummy<RecordHandlingFailedEvent>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details),
                        new RecordHandlingFailedEvent(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                A.Dummy<RecordHandlingFailedEvent>().Whose(_ => !_.Concern.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Concern)).Concern,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details),
                        new RecordHandlingFailedEvent(
                                A.Dummy<RecordHandlingFailedEvent>().Whose(_ => !_.InternalRecordId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.InternalRecordId)).InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Concern,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details),
                    },
        ...
        private static readonly ValidModelTestScenarios<RecordHandlingFailedEvent> ValidModelTestScenarios = new ValidModelTestScenarios<RecordHandlingFailedEvent>()
            .AddScenario(() =>
                new ValidModelTestScenario<RecordHandlingFailedEvent>
                {
                    Name = "a dummy RecordHandlingFailedEvent should be valid",
                    SystemUnderTest = A.Dummy<RecordHandlingFailedEvent>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void RecordHandlingFailedEvent___Should_implement_IModel_of_RecordHandlingFailedEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(RecordHandlingFailedEvent);

                var expectedModelMethods = typeof(IModel<RecordHandlingFailedEvent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<RecordHandlingFailedEvent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void RecordHandlingFailedEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(RecordHandlingFailedEvent);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (RecordHandlingFailedEvent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (RecordHandlingFailedEvent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(RecordHandlingFailedEvent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<RecordHandlingFailedEvent>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                RecordHandlingFailedEvent systemUnderTest1 = null;
                RecordHandlingFailedEvent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    RecordHandlingFailedEvent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordHandlingFailedEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordHandlingFailedEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordHandlingFailedEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordHandlingFailedEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordHandlingFailedEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
