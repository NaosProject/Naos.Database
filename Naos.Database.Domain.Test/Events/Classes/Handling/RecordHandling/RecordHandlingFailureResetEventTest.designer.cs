...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<RecordHandlingFailureResetEvent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<RecordHandlingFailureResetEvent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<RecordHandlingFailureResetEvent>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<RecordHandlingFailureResetEvent>();

                        var result = new SystemUnderTestExpectedStringRepresentation<RecordHandlingFailureResetEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.RecordHandlingFailureResetEvent: TimestampUtc = {systemUnderTest.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Concern = {systemUnderTest.Concern?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, InternalRecordId = {systemUnderTest.InternalRecordId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<RecordHandlingFailureResetEvent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<RecordHandlingFailureResetEvent>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<RecordHandlingFailureResetEvent>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'concern' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<RecordHandlingFailureResetEvent>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<RecordHandlingFailureResetEvent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<RecordHandlingFailureResetEvent>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<RecordHandlingFailureResetEvent>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<RecordHandlingFailureResetEvent>
                        {
                            SystemUnderTest = new RecordHandlingFailureResetEvent(
                                                      referenceObject.InternalRecordId,
                                                      referenceObject.Concern,
                                                      referenceObject.TimestampUtc,
                                                      referenceObject.Details),
        ...
        private static readonly DeepCloneWithTestScenarios<RecordHandlingFailureResetEvent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<RecordHandlingFailureResetEvent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RecordHandlingFailureResetEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RecordHandlingFailureResetEvent>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));

                        var result = new SystemUnderTestDeepCloneWithValue<RecordHandlingFailureResetEvent>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RecordHandlingFailureResetEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RecordHandlingFailureResetEvent>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RecordHandlingFailureResetEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RecordHandlingFailureResetEvent>().ThatIs(_ => !systemUnderTest.Concern.IsEqualTo(_.Concern));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RecordHandlingFailureResetEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RecordHandlingFailureResetEvent>().ThatIs(_ => !systemUnderTest.InternalRecordId.IsEqualTo(_.InternalRecordId));
        ...
        private static readonly RecordHandlingFailureResetEvent ReferenceObjectForEquatableTestScenarios = A.Dummy<RecordHandlingFailureResetEvent>();

        private static readonly EquatableTestScenarios<RecordHandlingFailureResetEvent> EquatableTestScenarios = new EquatableTestScenarios<RecordHandlingFailureResetEvent>()
            .AddScenario(() =>
                new EquatableTestScenario<RecordHandlingFailureResetEvent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new RecordHandlingFailureResetEvent[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new RecordHandlingFailureResetEvent[]
                    {
                        new RecordHandlingFailureResetEvent(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Concern,
                                A.Dummy<RecordHandlingFailureResetEvent>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details),
                        new RecordHandlingFailureResetEvent(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Concern,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                A.Dummy<RecordHandlingFailureResetEvent>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details),
                        new RecordHandlingFailureResetEvent(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                A.Dummy<RecordHandlingFailureResetEvent>().Whose(_ => !_.Concern.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Concern)).Concern,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details),
                        new RecordHandlingFailureResetEvent(
                                A.Dummy<RecordHandlingFailureResetEvent>().Whose(_ => !_.InternalRecordId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.InternalRecordId)).InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Concern,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details),
                    },
        ...
        private static readonly ValidModelTestScenarios<RecordHandlingFailureResetEvent> ValidModelTestScenarios = new ValidModelTestScenarios<RecordHandlingFailureResetEvent>()
            .AddScenario(() =>
                new ValidModelTestScenario<RecordHandlingFailureResetEvent>
                {
                    Name = "a dummy RecordHandlingFailureResetEvent should be valid",
                    SystemUnderTest = A.Dummy<RecordHandlingFailureResetEvent>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void RecordHandlingFailureResetEvent___Should_implement_IModel_of_RecordHandlingFailureResetEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(RecordHandlingFailureResetEvent);

                var expectedModelMethods = typeof(IModel<RecordHandlingFailureResetEvent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<RecordHandlingFailureResetEvent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void RecordHandlingFailureResetEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(RecordHandlingFailureResetEvent);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (RecordHandlingFailureResetEvent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (RecordHandlingFailureResetEvent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(RecordHandlingFailureResetEvent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<RecordHandlingFailureResetEvent>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                RecordHandlingFailureResetEvent systemUnderTest1 = null;
                RecordHandlingFailureResetEvent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    RecordHandlingFailureResetEvent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordHandlingFailureResetEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordHandlingFailureResetEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordHandlingFailureResetEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordHandlingFailureResetEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordHandlingFailureResetEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
