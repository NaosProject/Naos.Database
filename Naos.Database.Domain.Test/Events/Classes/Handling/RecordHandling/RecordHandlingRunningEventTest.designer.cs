...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<RecordHandlingRunningEvent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<RecordHandlingRunningEvent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<RecordHandlingRunningEvent>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<RecordHandlingRunningEvent>();

                        var result = new SystemUnderTestExpectedStringRepresentation<RecordHandlingRunningEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.RecordHandlingRunningEvent: TimestampUtc = {systemUnderTest.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Concern = {systemUnderTest.Concern?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, InternalRecordId = {systemUnderTest.InternalRecordId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<RecordHandlingRunningEvent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<RecordHandlingRunningEvent>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<RecordHandlingRunningEvent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<RecordHandlingRunningEvent>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<RecordHandlingRunningEvent>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<RecordHandlingRunningEvent>
                        {
                            SystemUnderTest = new RecordHandlingRunningEvent(
                                                      referenceObject.InternalRecordId,
                                                      referenceObject.Concern,
                                                      referenceObject.TimestampUtc,
                                                      referenceObject.Details),
        ...
        private static readonly DeepCloneWithTestScenarios<RecordHandlingRunningEvent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<RecordHandlingRunningEvent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RecordHandlingRunningEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RecordHandlingRunningEvent>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));

                        var result = new SystemUnderTestDeepCloneWithValue<RecordHandlingRunningEvent>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RecordHandlingRunningEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RecordHandlingRunningEvent>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RecordHandlingRunningEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RecordHandlingRunningEvent>().ThatIs(_ => !systemUnderTest.Concern.IsEqualTo(_.Concern));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RecordHandlingRunningEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RecordHandlingRunningEvent>().ThatIs(_ => !systemUnderTest.InternalRecordId.IsEqualTo(_.InternalRecordId));
        ...
        private static readonly RecordHandlingRunningEvent ReferenceObjectForEquatableTestScenarios = A.Dummy<RecordHandlingRunningEvent>();

        private static readonly EquatableTestScenarios<RecordHandlingRunningEvent> EquatableTestScenarios = new EquatableTestScenarios<RecordHandlingRunningEvent>()
            .AddScenario(() =>
                new EquatableTestScenario<RecordHandlingRunningEvent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new RecordHandlingRunningEvent[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new RecordHandlingRunningEvent[]
                    {
                        new RecordHandlingRunningEvent(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Concern,
                                A.Dummy<RecordHandlingRunningEvent>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details),
                        new RecordHandlingRunningEvent(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Concern,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                A.Dummy<RecordHandlingRunningEvent>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details),
                        new RecordHandlingRunningEvent(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                A.Dummy<RecordHandlingRunningEvent>().Whose(_ => !_.Concern.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Concern)).Concern,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details),
                        new RecordHandlingRunningEvent(
                                A.Dummy<RecordHandlingRunningEvent>().Whose(_ => !_.InternalRecordId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.InternalRecordId)).InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Concern,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details),
                    },
        ...
        private static readonly ValidModelTestScenarios<RecordHandlingRunningEvent> ValidModelTestScenarios = new ValidModelTestScenarios<RecordHandlingRunningEvent>()
            .AddScenario(() =>
                new ValidModelTestScenario<RecordHandlingRunningEvent>
                {
                    Name = "a dummy RecordHandlingRunningEvent should be valid",
                    SystemUnderTest = A.Dummy<RecordHandlingRunningEvent>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void RecordHandlingRunningEvent___Should_implement_IModel_of_RecordHandlingRunningEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(RecordHandlingRunningEvent);

                var expectedModelMethods = typeof(IModel<RecordHandlingRunningEvent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<RecordHandlingRunningEvent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void RecordHandlingRunningEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(RecordHandlingRunningEvent);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (RecordHandlingRunningEvent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (RecordHandlingRunningEvent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(RecordHandlingRunningEvent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<RecordHandlingRunningEvent>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                RecordHandlingRunningEvent systemUnderTest1 = null;
                RecordHandlingRunningEvent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    RecordHandlingRunningEvent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordHandlingRunningEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordHandlingRunningEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordHandlingRunningEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordHandlingRunningEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordHandlingRunningEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
