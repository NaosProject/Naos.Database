...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ChecksPerformedEvent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ChecksPerformedEvent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ChecksPerformedEvent>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ChecksPerformedEvent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ChecksPerformedEvent>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ChecksPerformedEvent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ChecksPerformedEvent>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ChecksPerformedEvent>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<ChecksPerformedEvent>
                        {
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ChecksPerformedEvent>
                {
                    Name = "CheckDrivesReport should return same 'checkDrivesReport' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ChecksPerformedEvent>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<ChecksPerformedEvent>
                        {
                            SystemUnderTest = new ChecksPerformedEvent(
                                                      ...
                                                      referenceObject.CheckJobsReport,
                                                      referenceObject.CheckStreamsReport),
                            ExpectedPropertyValue = referenceObject.CheckDrivesReport,
                        };

                        return result;
                    },
                    PropertyName = "CheckDrivesReport",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ChecksPerformedEvent>
                {
                    Name = "CheckJobsReport should return same 'checkJobsReport' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ChecksPerformedEvent>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<ChecksPerformedEvent>
                        {
                            SystemUnderTest = new ChecksPerformedEvent(
                                                      ...
                                                      referenceObject.CheckJobsReport,
                                                      referenceObject.CheckStreamsReport),
                            ExpectedPropertyValue = referenceObject.CheckJobsReport,
                        };

                        return result;
                    },
                    PropertyName = "CheckJobsReport",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ChecksPerformedEvent>
                {
                    Name = "CheckStreamsReport should return same 'checkStreamsReport' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ChecksPerformedEvent>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<ChecksPerformedEvent>
                        {
                            SystemUnderTest = new ChecksPerformedEvent(
                                                      ...
                                                      referenceObject.CheckJobsReport,
                                                      referenceObject.CheckStreamsReport),
                            ExpectedPropertyValue = referenceObject.CheckStreamsReport,
                        };

                        return result;
                    },
                    PropertyName = "CheckStreamsReport",
                });

        private static readonly DeepCloneWithTestScenarios<ChecksPerformedEvent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ChecksPerformedEvent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ChecksPerformedEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ChecksPerformedEvent>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ChecksPerformedEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ChecksPerformedEvent>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ChecksPerformedEvent>
                {
                    Name = "DeepCloneWithCheckDrivesReport should deep clone object and replace CheckDrivesReport with the provided checkDrivesReport",
                    WithPropertyName = "CheckDrivesReport",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ChecksPerformedEvent>();

                        var referenceObject = A.Dummy<ChecksPerformedEvent>().ThatIs(_ => !systemUnderTest.CheckDrivesReport.IsEqualTo(_.CheckDrivesReport));

                        var result = new SystemUnderTestDeepCloneWithValue<ChecksPerformedEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.CheckDrivesReport,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ChecksPerformedEvent>
                {
                    Name = "DeepCloneWithCheckJobsReport should deep clone object and replace CheckJobsReport with the provided checkJobsReport",
                    WithPropertyName = "CheckJobsReport",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ChecksPerformedEvent>();

                        var referenceObject = A.Dummy<ChecksPerformedEvent>().ThatIs(_ => !systemUnderTest.CheckJobsReport.IsEqualTo(_.CheckJobsReport));

                        var result = new SystemUnderTestDeepCloneWithValue<ChecksPerformedEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.CheckJobsReport,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ChecksPerformedEvent>
                {
                    Name = "DeepCloneWithCheckStreamsReport should deep clone object and replace CheckStreamsReport with the provided checkStreamsReport",
                    WithPropertyName = "CheckStreamsReport",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ChecksPerformedEvent>();

                        var referenceObject = A.Dummy<ChecksPerformedEvent>().ThatIs(_ => !systemUnderTest.CheckStreamsReport.IsEqualTo(_.CheckStreamsReport));

                        var result = new SystemUnderTestDeepCloneWithValue<ChecksPerformedEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.CheckStreamsReport,
                        };
        ...
        private static readonly ChecksPerformedEvent ReferenceObjectForEquatableTestScenarios = A.Dummy<ChecksPerformedEvent>();

        private static readonly EquatableTestScenarios<ChecksPerformedEvent> EquatableTestScenarios = new EquatableTestScenarios<ChecksPerformedEvent>()
            .AddScenario(() =>
                new EquatableTestScenario<ChecksPerformedEvent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ChecksPerformedEvent[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new ChecksPerformedEvent[]
                    {
                        new ChecksPerformedEvent(
                                ReferenceObjectForEquatableTestScenarios.Id,
        ...
        private static readonly ValidModelTestScenarios<ChecksPerformedEvent> ValidModelTestScenarios = new ValidModelTestScenarios<ChecksPerformedEvent>()
            .AddScenario(() =>
                new ValidModelTestScenario<ChecksPerformedEvent>
                {
                    Name = "a dummy ChecksPerformedEvent should be valid",
                    SystemUnderTest = A.Dummy<ChecksPerformedEvent>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void ChecksPerformedEvent___Should_implement_IModel_of_ChecksPerformedEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(ChecksPerformedEvent);

                var expectedModelMethods = typeof(IModel<ChecksPerformedEvent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ChecksPerformedEvent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ChecksPerformedEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ChecksPerformedEvent);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ChecksPerformedEvent)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.CheckDrivesReport == null)
                {
                    actual.CheckDrivesReport.AsTest().Must().BeNull();
                }
                else if (!actual.CheckDrivesReport.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.CheckDrivesReport.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.CheckDrivesReport);
                }

                if (systemUnderTest.CheckJobsReport == null)
                {
                    actual.CheckJobsReport.AsTest().Must().BeNull();
                }
                else if (!actual.CheckJobsReport.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.CheckJobsReport.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.CheckJobsReport);
                }

                if (systemUnderTest.CheckStreamsReport == null)
                {
                    actual.CheckStreamsReport.AsTest().Must().BeNull();
                }
                else if (!actual.CheckStreamsReport.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.CheckStreamsReport.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.CheckStreamsReport);
                }
            }
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ChecksPerformedEvent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ChecksPerformedEvent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ChecksPerformedEvent>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ChecksPerformedEvent systemUnderTest1 = null;
                ChecksPerformedEvent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ChecksPerformedEvent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ChecksPerformedEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ChecksPerformedEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ChecksPerformedEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ChecksPerformedEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ChecksPerformedEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
