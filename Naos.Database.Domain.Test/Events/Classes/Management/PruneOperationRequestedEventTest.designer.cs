...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<PruneOperationRequestedEvent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<PruneOperationRequestedEvent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<PruneOperationRequestedEvent>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<PruneOperationRequestedEvent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<PruneOperationRequestedEvent>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PruneOperationRequestedEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PruneOperationRequestedEvent>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PruneOperationRequestedEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PruneOperationRequestedEvent>().ThatIs(_ => !systemUnderTest.PruneOperation.IsEqualTo(_.PruneOperation));
        ...
        private static readonly EquatableTestScenarios<PruneOperationRequestedEvent> EquatableTestScenarios = new EquatableTestScenarios<PruneOperationRequestedEvent>()
            .AddScenario(() =>
                new EquatableTestScenario<PruneOperationRequestedEvent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new PruneOperationRequestedEvent[]
                    {
        ...
        private static readonly ValidModelTestScenarios<PruneOperationRequestedEvent> ValidModelTestScenarios = new ValidModelTestScenarios<PruneOperationRequestedEvent>()
            .AddScenario(() =>
                new ValidModelTestScenario<PruneOperationRequestedEvent>
                {
                    Name = "a dummy PruneOperationRequestedEvent should be valid",
                    SystemUnderTest = A.Dummy<PruneOperationRequestedEvent>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void PruneOperationRequestedEvent___Should_implement_IModel_of_PruneOperationRequestedEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(PruneOperationRequestedEvent);

                var expectedModelMethods = typeof(IModel<PruneOperationRequestedEvent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<PruneOperationRequestedEvent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void PruneOperationRequestedEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(PruneOperationRequestedEvent);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (PruneOperationRequestedEvent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (PruneOperationRequestedEvent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(PruneOperationRequestedEvent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<PruneOperationRequestedEvent>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                PruneOperationRequestedEvent systemUnderTest1 = null;
                PruneOperationRequestedEvent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    PruneOperationRequestedEvent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneOperationRequestedEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneOperationRequestedEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneOperationRequestedEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneOperationRequestedEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneOperationRequestedEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
