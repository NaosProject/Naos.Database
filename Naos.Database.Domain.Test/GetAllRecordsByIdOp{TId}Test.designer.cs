...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class GetAllRecordsByIdOpTIdTest
    {
                ...
                new StringRepresentationTestScenario<GetAllRecordsByIdOp<Version>>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<GetAllRecordsByIdOp<Version>>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.GetAllRecordsByIdOp<Version>: ObjectType = {systemUnderTest.ObjectType?.ToString() ?? "<null>"}, VersionMatchStrategy = {systemUnderTest.VersionMatchStrategy.ToString() ?? "<null>"}, ExistingRecordNotEncounteredStrategy = {systemUnderTest.ExistingRecordNotEncounteredStrategy.ToString() ?? "<null>"}, OrderRecordsStrategy = {systemUnderTest.OrderRecordsStrategy.ToString() ?? "<null>"}, Id = {systemUnderTest.Id?.ToString() ?? "<null>"}."),
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetAllRecordsByIdOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetAllRecordsByIdOp<Version>>().ThatIs(_ => !systemUnderTest.ExistingRecordNotEncounteredStrategy.IsEqualTo(_.ExistingRecordNotEncounteredStrategy));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetAllRecordsByIdOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetAllRecordsByIdOp<Version>>().ThatIs(_ => !systemUnderTest.OrderRecordsStrategy.IsEqualTo(_.OrderRecordsStrategy));
                ...
                new EquatableTestScenario<GetAllRecordsByIdOp<Version>>
                {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new GetAllRecordsByIdOp<Version>[]
                    {
                        ...
                        new GetAllRecordsByIdOp<Version>(
                                ...
                                ReferenceObjectForEquatableTestScenarios.ObjectType,
                                ReferenceObjectForEquatableTestScenarios.VersionMatchStrategy,
                                A.Dummy<GetAllRecordsByIdOp<Version>>().Whose(_ => !_.ExistingRecordNotEncounteredStrategy.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ExistingRecordNotEncounteredStrategy)).ExistingRecordNotEncounteredStrategy,
                                ReferenceObjectForEquatableTestScenarios.OrderRecordsStrategy),
                        new GetAllRecordsByIdOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.ObjectType,
                                ReferenceObjectForEquatableTestScenarios.VersionMatchStrategy,
                                ReferenceObjectForEquatableTestScenarios.ExistingRecordNotEncounteredStrategy,
                                A.Dummy<GetAllRecordsByIdOp<Version>>().Whose(_ => !_.OrderRecordsStrategy.IsEqualTo(ReferenceObjectForEquatableTestScenarios.OrderRecordsStrategy)).OrderRecordsStrategy),
                        new GetAllRecordsByIdOp<Version>(
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "ObjectType", "VersionMatchStrategy", "ExistingRecordNotEncounteredStrategy", "OrderRecordsStrategy", "Id" };
