            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetAllRecordsMetadataByIdOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetAllRecordsMetadataByIdOp>().ThatIs(_ => !systemUnderTest.TypeVersionMatchStrategy.IsEqualTo(_.TypeVersionMatchStrategy));
                ...
                new EquatableTestScenario<GetAllRecordsMetadataByIdOp>
                {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new GetAllRecordsMetadataByIdOp[]
                    {
                        ...
                        new GetAllRecordsMetadataByIdOp(
                                ...
                                ReferenceObjectForEquatableTestScenarios.IdentifierType,
                                ReferenceObjectForEquatableTestScenarios.ObjectType,
                                A.Dummy<GetAllRecordsMetadataByIdOp>().Whose(_ => !_.TypeVersionMatchStrategy.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TypeVersionMatchStrategy)).TypeVersionMatchStrategy,
                                ReferenceObjectForEquatableTestScenarios.ExistingRecordNotEncounteredStrategy,
                                ReferenceObjectForEquatableTestScenarios.OrderRecordsStrategy,
                                ReferenceObjectForEquatableTestScenarios.SpecifiedResourceLocator),
                        new GetAllRecordsMetadataByIdOp(
