...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class GetAllRecordsMetadataByIdOpTIdTest
    {
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetAllRecordsMetadataByIdOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetAllRecordsMetadataByIdOp<Version>>().ThatIs(_ => !systemUnderTest.ExistingRecordNotEncounteredStrategy.IsEqualTo(_.ExistingRecordNotEncounteredStrategy));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetAllRecordsMetadataByIdOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetAllRecordsMetadataByIdOp<Version>>().ThatIs(_ => !systemUnderTest.OrderRecordsStrategy.IsEqualTo(_.OrderRecordsStrategy));
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Id", "ObjectType", "VersionMatchStrategy", "ExistingRecordNotEncounteredStrategy", "OrderRecordsStrategy" };
