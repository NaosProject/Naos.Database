...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class GetDistinctStringSerializedIdsOpTest
    {
                ...
                new StringRepresentationTestScenario<GetDistinctStringSerializedIdsOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<GetDistinctStringSerializedIdsOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.GetDistinctStringSerializedIdsOp: IdentifierType = {systemUnderTest.IdentifierType?.ToString() ?? "<null>"}, ObjectType = {systemUnderTest.ObjectType?.ToString() ?? "<null>"}, VersionMatchStrategy = {systemUnderTest.VersionMatchStrategy.ToString() ?? "<null>"}, TagMatchStrategy = {systemUnderTest.TagMatchStrategy?.ToString() ?? "<null>"}, TagsToMatch = {systemUnderTest.TagsToMatch?.ToString() ?? "<null>"}, SpecifiedResourceLocator = {systemUnderTest.SpecifiedResourceLocator?.ToString() ?? "<null>"}."),
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetDistinctStringSerializedIdsOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetDistinctStringSerializedIdsOp>().ThatIs(_ => !systemUnderTest.VersionMatchStrategy.IsEqualTo(_.VersionMatchStrategy));
                ...
                new EquatableTestScenario<GetDistinctStringSerializedIdsOp>
                {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new GetDistinctStringSerializedIdsOp[]
                    {
                        ...
                        new GetDistinctStringSerializedIdsOp(
                                ReferenceObjectForEquatableTestScenarios.IdentifierType,
                                ReferenceObjectForEquatableTestScenarios.ObjectType,
                                A.Dummy<GetDistinctStringSerializedIdsOp>().Whose(_ => !_.VersionMatchStrategy.IsEqualTo(ReferenceObjectForEquatableTestScenarios.VersionMatchStrategy)).VersionMatchStrategy,
                                ReferenceObjectForEquatableTestScenarios.TagsToMatch,
                                ReferenceObjectForEquatableTestScenarios.TagMatchStrategy,
                                ReferenceObjectForEquatableTestScenarios.SpecifiedResourceLocator),
                        new GetDistinctStringSerializedIdsOp(
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "IdentifierType", "ObjectType", "VersionMatchStrategy", "TagMatchStrategy", "TagsToMatch", "SpecifiedResourceLocator" };
