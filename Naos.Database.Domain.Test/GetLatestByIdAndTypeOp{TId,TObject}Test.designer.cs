    ...
    public static partial class GetLatestByIdAndTypeOpTest
    {
                ...
                new StringRepresentationTestScenario<GetLatestByIdAndTypeOp<Version, Version>>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<GetLatestByIdAndTypeOp<Version, Version>>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.GetLatestByIdAndTypeOp<Version, Version>: Id = {systemUnderTest.Id?.ToString() ?? "<null>"}, TypeVersionMatchStrategy = {systemUnderTest.TypeVersionMatchStrategy.ToString() ?? "<null>"}."),
                        };
        ...
        public static class Structural
        {
            ...
            public static void GetLatestByIdAndTypeOp___Should_implement_IModel_of_GetLatestByIdAndTypeOp___When_reflecting()
            {
                ...
                var expectedModelMethods = typeof(IModel<GetLatestByIdAndTypeOp<Version, Version>>).GetInterfaceDeclaredAndImplementedMethods();
        ...
        public static class Cloning
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(GetLatestByIdAndTypeOp<Version, Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
