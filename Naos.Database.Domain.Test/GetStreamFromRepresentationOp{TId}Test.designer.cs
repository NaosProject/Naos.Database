    ...
    public static partial class GetStreamFromRepresentationOpTest
    {
                ...
                new StringRepresentationTestScenario<GetStreamFromRepresentationOp<Version>>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<GetStreamFromRepresentationOp<Version>>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.GetStreamFromRepresentationOp<Version>: StreamRepresentation = {systemUnderTest.StreamRepresentation?.ToString() ?? "<null>"}."),
                        };
        ...
        public static class Structural
        {
            ...
            public static void GetStreamFromRepresentationOp___Should_implement_IModel_of_GetStreamFromRepresentationOp___When_reflecting()
            {
                ...
                var expectedModelMethods = typeof(IModel<GetStreamFromRepresentationOp<Version>>).GetInterfaceDeclaredAndImplementedMethods();
        ...
        public static class Cloning
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(GetStreamFromRepresentationOp<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
