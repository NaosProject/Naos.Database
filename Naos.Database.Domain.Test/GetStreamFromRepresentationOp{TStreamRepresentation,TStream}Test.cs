    ...
    public static partial class GetStreamFromRepresentationOpTStreamRepresentationTStreamTest
    {
        ...
        static GetStreamFromRepresentationOpTStreamRepresentationTStreamTest()
        {
            ConstructorArgumentValidationTestScenarios
               .RemoveAllScenarios()
               .AddScenario(ConstructorArgumentValidationTestScenario<GetStreamFromRepresentationOp<NullStreamRepresentation, NullReadWriteStream>>.ForceGeneratedTestsToPassAndWriteMyOwnScenario);
        }
    }
}