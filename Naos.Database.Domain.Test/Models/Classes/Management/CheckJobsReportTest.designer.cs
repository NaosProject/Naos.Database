...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CheckJobsReport> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CheckJobsReport>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CheckJobsReport>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CheckJobsReport> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CheckJobsReport>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CheckJobsReport>
                {
                    ...
                    ExpectedExceptionMessageContains = new[] { "jobNameToInformationMap", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CheckJobsReport>
                {
                    Name = "constructor should throw ArgumentException when parameter 'jobNameToInformationMap' is an empty dictionary scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CheckJobsReport>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "jobNameToInformationMap", "is an empty dictionary", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CheckJobsReport>
                {
                    Name = "constructor should throw ArgumentException when parameter 'jobNameToInformationMap' contains a key-value pair with a null value scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CheckJobsReport>();

                        var dictionaryWithNullValue = referenceObject.JobNameToInformationMap.ToDictionary(_ => _.Key, _ => _.Value);
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "jobNameToInformationMap", "contains at least one key-value pair with a null value", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CheckJobsReport>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CheckJobsReport> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CheckJobsReport>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CheckJobsReport>
                {
                    Name = "JobNameToInformationMap should return same 'jobNameToInformationMap' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CheckJobsReport>();
                    ...
                    PropertyName = "JobNameToInformationMap",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CheckJobsReport>
                {
        ...
        private static readonly DeepCloneWithTestScenarios<CheckJobsReport> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CheckJobsReport>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CheckJobsReport>
                {
                    Name = "DeepCloneWithJobNameToInformationMap should deep clone object and replace JobNameToInformationMap with the provided jobNameToInformationMap",
                    WithPropertyName = "JobNameToInformationMap",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CheckJobsReport>();

                        var referenceObject = A.Dummy<CheckJobsReport>().ThatIs(_ => !systemUnderTest.JobNameToInformationMap.IsEqualTo(_.JobNameToInformationMap));

                        var result = new SystemUnderTestDeepCloneWithValue<CheckJobsReport>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.JobNameToInformationMap,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CheckJobsReport>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CheckJobsReport>().ThatIs(_ => !systemUnderTest.SampleTimeUtc.IsEqualTo(_.SampleTimeUtc));
        ...
        private static readonly CheckJobsReport ReferenceObjectForEquatableTestScenarios = A.Dummy<CheckJobsReport>();

        private static readonly EquatableTestScenarios<CheckJobsReport> EquatableTestScenarios = new EquatableTestScenarios<CheckJobsReport>()
            .AddScenario(() =>
                new EquatableTestScenario<CheckJobsReport>
                {
                    Name = "Default Code Generated Scenario",
        ...
        private static readonly ValidModelTestScenarios<CheckJobsReport> ValidModelTestScenarios = new ValidModelTestScenarios<CheckJobsReport>()
            .AddScenario(() =>
                new ValidModelTestScenario<CheckJobsReport>
                {
                    Name = "a dummy CheckJobsReport should be valid",
                    SystemUnderTest = A.Dummy<CheckJobsReport>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void CheckJobsReport___Should_implement_IModel_of_CheckJobsReport___When_reflecting()
            {
                // Arrange
                var type = typeof(CheckJobsReport);

                var expectedModelMethods = typeof(IModel<CheckJobsReport>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CheckJobsReport>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CheckJobsReport___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CheckJobsReport);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CheckJobsReport)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.JobNameToInformationMap == null)
                {
                    actual.JobNameToInformationMap.AsTest().Must().BeNull();
                }
                else if (!actual.JobNameToInformationMap.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.JobNameToInformationMap.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.JobNameToInformationMap);
                }
            }
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CheckJobsReport)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CheckJobsReport).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CheckJobsReport>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                CheckJobsReport systemUnderTest1 = null;
                CheckJobsReport systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CheckJobsReport systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckJobsReport___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckJobsReport___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckJobsReport___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckJobsReport___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckJobsReport___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
