...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CheckSingleStreamReport> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CheckSingleStreamReport>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CheckSingleStreamReport>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CheckSingleStreamReport> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CheckSingleStreamReport>()
            .AddScenario(() =>
        ...
        private static readonly CheckSingleStreamReport ReferenceObjectForEquatableTestScenarios = A.Dummy<CheckSingleStreamReport>();

        private static readonly EquatableTestScenarios<CheckSingleStreamReport> EquatableTestScenarios = new EquatableTestScenarios<CheckSingleStreamReport>()
            .AddScenario(() =>
                new EquatableTestScenario<CheckSingleStreamReport>
                {
                    Name = "Default Code Generated Scenario",
        ...
        private static readonly ValidModelTestScenarios<CheckSingleStreamReport> ValidModelTestScenarios = new ValidModelTestScenarios<CheckSingleStreamReport>()
            .AddScenario(() =>
                new ValidModelTestScenario<CheckSingleStreamReport>
                {
                    Name = "a dummy CheckSingleStreamReport should be valid",
                    SystemUnderTest = A.Dummy<CheckSingleStreamReport>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void CheckSingleStreamReport___Should_implement_IModel_of_CheckSingleStreamReport___When_reflecting()
            {
                // Arrange
                var type = typeof(CheckSingleStreamReport);

                var expectedModelMethods = typeof(IModel<CheckSingleStreamReport>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CheckSingleStreamReport>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CheckSingleStreamReport___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CheckSingleStreamReport);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CheckSingleStreamReport)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CheckSingleStreamReport)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CheckSingleStreamReport).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CheckSingleStreamReport>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                CheckSingleStreamReport systemUnderTest1 = null;
                CheckSingleStreamReport systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CheckSingleStreamReport systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckSingleStreamReport___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckSingleStreamReport___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckSingleStreamReport___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckSingleStreamReport___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckSingleStreamReport___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
