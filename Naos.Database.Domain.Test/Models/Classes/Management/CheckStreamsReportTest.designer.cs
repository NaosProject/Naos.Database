...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class CheckStreamsReportTest
    {
                ...
                new StringRepresentationTestScenario<CheckStreamsReport>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<CheckStreamsReport>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.CheckStreamsReport: ShouldAlert = {systemUnderTest.ShouldAlert.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, StreamNameToReportMap = {systemUnderTest.StreamNameToReportMap?.ToString() ?? "<null>"}, SampleTimeUtc = {systemUnderTest.SampleTimeUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CheckStreamsReport>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CheckStreamsReport>().ThatIs(_ => !systemUnderTest.ShouldAlert.IsEqualTo(_.ShouldAlert));
        ...
        private static readonly EquatableTestScenarios<CheckStreamsReport> EquatableTestScenarios = new EquatableTestScenarios<CheckStreamsReport>()
            .AddScenario(() =>
                new EquatableTestScenario<CheckStreamsReport>
                {
                    ...
                    {
                        new CheckStreamsReport(
                                A.Dummy<CheckStreamsReport>().Whose(_ => !_.ShouldAlert.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ShouldAlert)).ShouldAlert,
                                ReferenceObjectForEquatableTestScenarios.StreamNameToReportMap,
                                ReferenceObjectForEquatableTestScenarios.SampleTimeUtc),
                        new CheckStreamsReport(
                                ReferenceObjectForEquatableTestScenarios.ShouldAlert,
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "ShouldAlert", "StreamNameToReportMap", "SampleTimeUtc" };
