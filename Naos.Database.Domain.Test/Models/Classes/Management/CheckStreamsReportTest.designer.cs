...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class CheckStreamsReportTest
    {
        ...
        private static readonly ValidModelTestScenarios<CheckStreamsReport> ValidModelTestScenarios = new ValidModelTestScenarios<CheckStreamsReport>()
            .AddScenario(() =>
                new ValidModelTestScenario<CheckStreamsReport>
                {
                    Name = "a dummy CheckStreamsReport should be valid",
                    SystemUnderTest = A.Dummy<CheckStreamsReport>(),
                });
