...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ExpectedJobWithinThreshold> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ExpectedJobWithinThreshold>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ExpectedJobWithinThreshold>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ExpectedJobWithinThreshold>();

                        var result = new SystemUnderTestExpectedStringRepresentation<ExpectedJobWithinThreshold>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.ExpectedJobWithinThreshold: Name = {systemUnderTest.Name?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Threshold = {systemUnderTest.Threshold.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ExpectedJobWithinThreshold> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ExpectedJobWithinThreshold>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ExpectedJobWithinThreshold> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ExpectedJobWithinThreshold>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ExpectedJobWithinThreshold>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<ExpectedJobWithinThreshold>
                        {
                            SystemUnderTest = new ExpectedJobWithinThreshold(
        ...
        private static readonly DeepCloneWithTestScenarios<ExpectedJobWithinThreshold> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ExpectedJobWithinThreshold>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ExpectedJobWithinThreshold>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ExpectedJobWithinThreshold>().ThatIs(_ => !systemUnderTest.Name.IsEqualTo(_.Name));

                        var result = new SystemUnderTestDeepCloneWithValue<ExpectedJobWithinThreshold>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ExpectedJobWithinThreshold>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ExpectedJobWithinThreshold>().ThatIs(_ => !systemUnderTest.Threshold.IsEqualTo(_.Threshold));
        ...
        private static readonly ExpectedJobWithinThreshold ReferenceObjectForEquatableTestScenarios = A.Dummy<ExpectedJobWithinThreshold>();

        private static readonly EquatableTestScenarios<ExpectedJobWithinThreshold> EquatableTestScenarios = new EquatableTestScenarios<ExpectedJobWithinThreshold>()
            .AddScenario(() =>
                new EquatableTestScenario<ExpectedJobWithinThreshold>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ExpectedJobWithinThreshold[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new ExpectedJobWithinThreshold[]
                    {
                        new ExpectedJobWithinThreshold(
                                A.Dummy<ExpectedJobWithinThreshold>().Whose(_ => !_.Name.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Name)).Name,
                                ReferenceObjectForEquatableTestScenarios.Threshold),
                        new ExpectedJobWithinThreshold(
                                ReferenceObjectForEquatableTestScenarios.Name,
                                A.Dummy<ExpectedJobWithinThreshold>().Whose(_ => !_.Threshold.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Threshold)).Threshold),
                    },
        ...
        private static readonly ValidModelTestScenarios<ExpectedJobWithinThreshold> ValidModelTestScenarios = new ValidModelTestScenarios<ExpectedJobWithinThreshold>()
            .AddScenario(() =>
                new ValidModelTestScenario<ExpectedJobWithinThreshold>
                {
                    Name = "a dummy ExpectedJobWithinThreshold should be valid",
                    SystemUnderTest = A.Dummy<ExpectedJobWithinThreshold>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void ExpectedJobWithinThreshold___Should_implement_IModel_of_ExpectedJobWithinThreshold___When_reflecting()
            {
                // Arrange
                var type = typeof(ExpectedJobWithinThreshold);

                var expectedModelMethods = typeof(IModel<ExpectedJobWithinThreshold>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ExpectedJobWithinThreshold>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ExpectedJobWithinThreshold___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ExpectedJobWithinThreshold);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ExpectedJobWithinThreshold)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Name", "Threshold" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ExpectedJobWithinThreshold)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ExpectedJobWithinThreshold).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ExpectedJobWithinThreshold>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ExpectedJobWithinThreshold systemUnderTest1 = null;
                ExpectedJobWithinThreshold systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ExpectedJobWithinThreshold systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExpectedJobWithinThreshold___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExpectedJobWithinThreshold___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExpectedJobWithinThreshold___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExpectedJobWithinThreshold___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExpectedJobWithinThreshold___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
