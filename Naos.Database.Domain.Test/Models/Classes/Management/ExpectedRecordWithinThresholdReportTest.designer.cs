    ...
    public static partial class ExpectedRecordWithinThresholdReportTest
    {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ExpectedRecordWithinThresholdReport> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ExpectedRecordWithinThresholdReport>()
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ExpectedRecordWithinThresholdReport>
                {
                    Name = "constructor should throw ArgumentException when parameter 'latestMatchingRecordTimestampUtc' is not a UTC DateTime (it's Local)",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ExpectedRecordWithinThresholdReport>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "latestMatchingRecordTimestampUtc", "Kind that is not DateTimeKind.Utc", "DateTimeKind.Local" },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ExpectedRecordWithinThresholdReport>
                {
                    Name = "constructor should throw ArgumentException when parameter 'latestMatchingRecordTimestampUtc' is not a UTC DateTime (it's Unspecified)",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ExpectedRecordWithinThresholdReport>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "latestMatchingRecordTimestampUtc", "Kind that is not DateTimeKind.Utc", "DateTimeKind.Unspecified" },
                });
        ...
        private static readonly ValidModelTestScenarios<ExpectedRecordWithinThresholdReport> ValidModelTestScenarios = new ValidModelTestScenarios<ExpectedRecordWithinThresholdReport>()
            .AddScenario(() =>
                new ValidModelTestScenario<ExpectedRecordWithinThresholdReport>
                {
                    Name = "a dummy ExpectedRecordWithinThresholdReport should be valid",
                    SystemUnderTest = A.Dummy<ExpectedRecordWithinThresholdReport>(),
                });
