...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ExpectedRecordWithinThreshold> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ExpectedRecordWithinThreshold>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ExpectedRecordWithinThreshold>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ExpectedRecordWithinThreshold> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ExpectedRecordWithinThreshold>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ExpectedRecordWithinThreshold> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ExpectedRecordWithinThreshold>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ExpectedRecordWithinThreshold>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ExpectedRecordWithinThreshold>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ExpectedRecordWithinThreshold>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ExpectedRecordWithinThreshold>().ThatIs(_ => !systemUnderTest.RecordFilter.IsEqualTo(_.RecordFilter));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ExpectedRecordWithinThreshold>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ExpectedRecordWithinThreshold>().ThatIs(_ => !systemUnderTest.Threshold.IsEqualTo(_.Threshold));
        ...
        private static readonly EquatableTestScenarios<ExpectedRecordWithinThreshold> EquatableTestScenarios = new EquatableTestScenarios<ExpectedRecordWithinThreshold>()
            .AddScenario(() =>
                new EquatableTestScenario<ExpectedRecordWithinThreshold>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ExpectedRecordWithinThreshold[]
                    {
        ...
        private static readonly ValidModelTestScenarios<ExpectedRecordWithinThreshold> ValidModelTestScenarios = new ValidModelTestScenarios<ExpectedRecordWithinThreshold>()
            .AddScenario(() =>
                new ValidModelTestScenario<ExpectedRecordWithinThreshold>
                {
                    Name = "a dummy ExpectedRecordWithinThreshold should be valid",
                    SystemUnderTest = A.Dummy<ExpectedRecordWithinThreshold>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void ExpectedRecordWithinThreshold___Should_implement_IModel_of_ExpectedRecordWithinThreshold___When_reflecting()
            {
                // Arrange
                var type = typeof(ExpectedRecordWithinThreshold);

                var expectedModelMethods = typeof(IModel<ExpectedRecordWithinThreshold>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ExpectedRecordWithinThreshold>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ExpectedRecordWithinThreshold___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ExpectedRecordWithinThreshold);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ExpectedRecordWithinThreshold)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ExpectedRecordWithinThreshold)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ExpectedRecordWithinThreshold).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ExpectedRecordWithinThreshold>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ExpectedRecordWithinThreshold systemUnderTest1 = null;
                ExpectedRecordWithinThreshold systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ExpectedRecordWithinThreshold systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExpectedRecordWithinThreshold___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExpectedRecordWithinThreshold___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExpectedRecordWithinThreshold___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExpectedRecordWithinThreshold___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExpectedRecordWithinThreshold___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
