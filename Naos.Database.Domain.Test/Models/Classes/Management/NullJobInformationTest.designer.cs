...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<NullJobInformation> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<NullJobInformation>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<NullJobInformation>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<NullJobInformation>();

                        var result = new SystemUnderTestExpectedStringRepresentation<NullJobInformation>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.NullJobInformation: JobName = {systemUnderTest.JobName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<NullJobInformation> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<NullJobInformation>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<NullJobInformation>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'jobName' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new NullJobInformation(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<NullJobInformation> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<NullJobInformation>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<NullJobInformation>
                {
                    Name = "JobName should return same 'jobName' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<NullJobInformation>();

                        var result = new SystemUnderTestExpectedPropertyValue<NullJobInformation>
                        {
                            SystemUnderTest = new NullJobInformation(
        ...
        private static readonly DeepCloneWithTestScenarios<NullJobInformation> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<NullJobInformation>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<NullJobInformation>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<NullJobInformation>().ThatIs(_ => !systemUnderTest.JobName.IsEqualTo(_.JobName));

                        var result = new SystemUnderTestDeepCloneWithValue<NullJobInformation>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly NullJobInformation ReferenceObjectForEquatableTestScenarios = A.Dummy<NullJobInformation>();

        private static readonly EquatableTestScenarios<NullJobInformation> EquatableTestScenarios = new EquatableTestScenarios<NullJobInformation>()
            .AddScenario(() =>
                new EquatableTestScenario<NullJobInformation>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new NullJobInformation[]
                    {
                        new NullJobInformation(
                                ReferenceObjectForEquatableTestScenarios.JobName),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new NullJobInformation[]
                    {
                        new NullJobInformation(
                                A.Dummy<NullJobInformation>().Whose(_ => !_.JobName.IsEqualTo(ReferenceObjectForEquatableTestScenarios.JobName)).JobName),
                    },
        ...
        private static readonly ValidModelTestScenarios<NullJobInformation> ValidModelTestScenarios = new ValidModelTestScenarios<NullJobInformation>()
            .AddScenario(() =>
                new ValidModelTestScenario<NullJobInformation>
                {
                    Name = "a dummy NullJobInformation should be valid",
                    SystemUnderTest = A.Dummy<NullJobInformation>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void NullJobInformation___Should_implement_IModel_of_NullJobInformation___When_reflecting()
            {
                // Arrange
                var type = typeof(NullJobInformation);

                var expectedModelMethods = typeof(IModel<NullJobInformation>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<NullJobInformation>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void NullJobInformation___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(NullJobInformation);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (NullJobInformation)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (NullJobInformation)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(NullJobInformation).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<NullJobInformation>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                NullJobInformation systemUnderTest1 = null;
                NullJobInformation systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    NullJobInformation systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NullJobInformation___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NullJobInformation___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NullJobInformation___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NullJobInformation___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NullJobInformation___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
