...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class RecordExpectedToBeHandledReportTest
    {
        ...
        private static readonly ValidModelTestScenarios<RecordExpectedToBeHandledReport> ValidModelTestScenarios = new ValidModelTestScenarios<RecordExpectedToBeHandledReport>()
            .AddScenario(() =>
                new ValidModelTestScenario<RecordExpectedToBeHandledReport>
                {
                    Name = "a dummy RecordExpectedToBeHandledReport should be valid",
                    SystemUnderTest = A.Dummy<RecordExpectedToBeHandledReport>(),
                });
