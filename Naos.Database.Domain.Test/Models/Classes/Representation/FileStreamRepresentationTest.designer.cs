...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class FileStreamRepresentationTest
    {
        ...
        private static readonly ValidModelTestScenarios<FileStreamRepresentation> ValidModelTestScenarios = new ValidModelTestScenarios<FileStreamRepresentation>()
            .AddScenario(() =>
                new ValidModelTestScenario<FileStreamRepresentation>
                {
                    Name = "a dummy FileStreamRepresentation should be valid",
                    SystemUnderTest = A.Dummy<FileStreamRepresentation>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                else if (!actual.FileSystemDatabaseLocators.GetType().IsValueType)
                {
