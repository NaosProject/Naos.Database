...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StreamRepresentationBase ReferenceObjectForEquatableTestScenarios = A.Dummy<StreamRepresentationBase>();

        private static readonly EquatableTestScenarios<StreamRepresentationBase> EquatableTestScenarios = new EquatableTestScenarios<StreamRepresentationBase>()
            .AddScenario(() =>
                new EquatableTestScenario<StreamRepresentationBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new StreamRepresentationBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new StreamRepresentationBase[]
                    {
                        ...
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithName(A.Dummy<StreamRepresentationBase>().Whose(_ => !_.Name.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Name)).Name),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new StreamRepresentationBase[]
                    {
                        A.Dummy<StreamRepresentationBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class StructuralTesting
        {
            ...
            {
                // Arrange
                var type = typeof(StreamRepresentationBase);

                var expectedModelMethods = typeof(IModel<StreamRepresentationBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<StreamRepresentationBase>));
        ...
        public static class CloningTesting
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<StreamRepresentationBase>();

                // Act
                var actual = (StreamRepresentationBase)systemUnderTest.Clone();
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<StreamRepresentationBase>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                StreamRepresentationBase systemUnderTest1 = null;
                StreamRepresentationBase systemUnderTest2 = null;
