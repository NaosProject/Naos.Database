...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<StreamRepresentation> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<StreamRepresentation>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<StreamRepresentation>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<StreamRepresentation>();

                        var result = new SystemUnderTestExpectedStringRepresentation<StreamRepresentation>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.StreamRepresentation: Name = {systemUnderTest.Name?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<StreamRepresentation> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<StreamRepresentation>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<StreamRepresentation>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<StreamRepresentation> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<StreamRepresentation>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<StreamRepresentation>
                {
                    Name = "Name should return same 'name' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<StreamRepresentation>();

                        var result = new SystemUnderTestExpectedPropertyValue<StreamRepresentation>
                        {
                            SystemUnderTest = new StreamRepresentation(
        ...
        private static readonly DeepCloneWithTestScenarios<StreamRepresentation> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<StreamRepresentation>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StreamRepresentation>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StreamRepresentation>().ThatIs(_ => !systemUnderTest.Name.IsEqualTo(_.Name));

                        var result = new SystemUnderTestDeepCloneWithValue<StreamRepresentation>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly StreamRepresentation ReferenceObjectForEquatableTestScenarios = A.Dummy<StreamRepresentation>();

        private static readonly EquatableTestScenarios<StreamRepresentation> EquatableTestScenarios = new EquatableTestScenarios<StreamRepresentation>()
            .AddScenario(() =>
                new EquatableTestScenario<StreamRepresentation>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new StreamRepresentation[]
                    {
                        new StreamRepresentation(
                                ReferenceObjectForEquatableTestScenarios.Name),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new StreamRepresentation[]
                    {
                        new StreamRepresentation(
                                A.Dummy<StreamRepresentation>().Whose(_ => !_.Name.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Name)).Name),
                    },
        ...
        private static readonly ValidModelTestScenarios<StreamRepresentation> ValidModelTestScenarios = new ValidModelTestScenarios<StreamRepresentation>()
            .AddScenario(() =>
                new ValidModelTestScenario<StreamRepresentation>
                {
                    Name = "a dummy StreamRepresentation should be valid",
                    SystemUnderTest = A.Dummy<StreamRepresentation>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            {
                // Arrange
                var type = typeof(StreamRepresentation);

                var expectedModelMethods = typeof(IModel<StreamRepresentation>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<StreamRepresentation>));
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (StreamRepresentation)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (StreamRepresentation)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(StreamRepresentation).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<StreamRepresentation>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                StreamRepresentation systemUnderTest1 = null;
                StreamRepresentation systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    StreamRepresentation systemUnderTest = null;
