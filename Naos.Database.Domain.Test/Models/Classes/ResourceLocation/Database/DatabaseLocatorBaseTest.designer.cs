...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class DatabaseLocatorBaseTest
    {
        private static readonly DatabaseLocatorBase ReferenceObjectForEquatableTestScenarios = A.Dummy<DatabaseLocatorBase>();

        private static readonly EquatableTestScenarios<DatabaseLocatorBase> EquatableTestScenarios = new EquatableTestScenarios<DatabaseLocatorBase>()
            .AddScenario(() =>
                new EquatableTestScenario<DatabaseLocatorBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new DatabaseLocatorBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new DatabaseLocatorBase[]
                    {
                    ...
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new DatabaseLocatorBase[]
                    {
                        A.Dummy<DatabaseLocatorBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class StructuralTesting
        {
            ...
            public static void DatabaseLocatorBase___Should_implement_IModel_of_DatabaseLocatorBase___When_reflecting()
            {
                // Arrange
                var type = typeof(DatabaseLocatorBase);

                var expectedModelMethods = typeof(IModel<DatabaseLocatorBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<DatabaseLocatorBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void DatabaseLocatorBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(DatabaseLocatorBase);
        ...
        public static class CloningTesting
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<DatabaseLocatorBase>();

                // Act
                var actual = (DatabaseLocatorBase)systemUnderTest.Clone();
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<DatabaseLocatorBase>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                DatabaseLocatorBase systemUnderTest1 = null;
                DatabaseLocatorBase systemUnderTest2 = null;
