...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class FileSystemDatabaseLocatorTest
    {
        ...
        private static readonly ValidModelTestScenarios<FileSystemDatabaseLocator> ValidModelTestScenarios = new ValidModelTestScenarios<FileSystemDatabaseLocator>()
            .AddScenario(() =>
                new ValidModelTestScenario<FileSystemDatabaseLocator>
                {
                    Name = "a dummy FileSystemDatabaseLocator should be valid",
                    SystemUnderTest = A.Dummy<FileSystemDatabaseLocator>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void FileSystemDatabaseLocator___Should_implement_IModel_of_FileSystemDatabaseLocator___When_reflecting()
            {
                ...
                var expectedModelMethods = typeof(IModel<FileSystemDatabaseLocator>).GetInterfaceDeclaredAndImplementedMethods();
        ...
        public static class CloningTesting
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(FileSystemDatabaseLocator).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
