...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class NullResourceLocatorTest
    {
        ...
        private static readonly ValidModelTestScenarios<NullResourceLocator> ValidModelTestScenarios = new ValidModelTestScenarios<NullResourceLocator>()
            .AddScenario(() =>
                new ValidModelTestScenario<NullResourceLocator>
                {
                    Name = "a dummy NullResourceLocator should be valid",
                    SystemUnderTest = A.Dummy<NullResourceLocator>(),
                });
