...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class RecordFilterTest
    {
        ...
        private static readonly ValidModelTestScenarios<RecordFilter> ValidModelTestScenarios = new ValidModelTestScenarios<RecordFilter>()
            .AddScenario(() =>
                new ValidModelTestScenario<RecordFilter>
                {
                    Name = "a dummy RecordFilter should be valid",
                    SystemUnderTest = A.Dummy<RecordFilter>(),
                });
