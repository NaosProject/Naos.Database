...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<RecordLocator> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<RecordLocator>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<RecordLocator>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<RecordLocator>();

                        var result = new SystemUnderTestExpectedStringRepresentation<RecordLocator>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.RecordLocator: ResourceLocator = {systemUnderTest.ResourceLocator?.ToString() ?? "<null>"}, InternalRecordId = {systemUnderTest.InternalRecordId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<RecordLocator> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<RecordLocator>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<RecordLocator>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'resourceLocator' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<RecordLocator>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<RecordLocator> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<RecordLocator>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<RecordLocator>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<RecordLocator>
                        {
                            SystemUnderTest = new RecordLocator(
        ...
        private static readonly DeepCloneWithTestScenarios<RecordLocator> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<RecordLocator>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RecordLocator>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RecordLocator>().ThatIs(_ => !systemUnderTest.ResourceLocator.IsEqualTo(_.ResourceLocator));

                        var result = new SystemUnderTestDeepCloneWithValue<RecordLocator>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RecordLocator>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RecordLocator>().ThatIs(_ => !systemUnderTest.InternalRecordId.IsEqualTo(_.InternalRecordId));
        ...
        private static readonly RecordLocator ReferenceObjectForEquatableTestScenarios = A.Dummy<RecordLocator>();

        private static readonly EquatableTestScenarios<RecordLocator> EquatableTestScenarios = new EquatableTestScenarios<RecordLocator>()
            .AddScenario(() =>
                new EquatableTestScenario<RecordLocator>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new RecordLocator[]
                    {
                        new RecordLocator(
                                ReferenceObjectForEquatableTestScenarios.ResourceLocator,
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new RecordLocator[]
                    {
                        new RecordLocator(
                                A.Dummy<RecordLocator>().Whose(_ => !_.ResourceLocator.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ResourceLocator)).ResourceLocator,
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId),
                        new RecordLocator(
                                ReferenceObjectForEquatableTestScenarios.ResourceLocator,
                                A.Dummy<RecordLocator>().Whose(_ => !_.InternalRecordId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.InternalRecordId)).InternalRecordId),
                    },
        ...
        private static readonly ValidModelTestScenarios<RecordLocator> ValidModelTestScenarios = new ValidModelTestScenarios<RecordLocator>()
            .AddScenario(() =>
                new ValidModelTestScenario<RecordLocator>
                {
                    Name = "a dummy RecordLocator should be valid",
                    SystemUnderTest = A.Dummy<RecordLocator>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void RecordLocator___Should_implement_IModel_of_RecordLocator___When_reflecting()
            {
                // Arrange
                var type = typeof(RecordLocator);

                var expectedModelMethods = typeof(IModel<RecordLocator>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<RecordLocator>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void RecordLocator___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(RecordLocator);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (RecordLocator)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                else if (!actual.ResourceLocator.GetType().IsValueType)
                {
            ...
            {
                var propertyNames = new string[] { "ResourceLocator", "InternalRecordId" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (RecordLocator)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(RecordLocator).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<RecordLocator>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                RecordLocator systemUnderTest1 = null;
                RecordLocator systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    RecordLocator systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordLocator___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordLocator___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordLocator___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordLocator___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RecordLocator___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
