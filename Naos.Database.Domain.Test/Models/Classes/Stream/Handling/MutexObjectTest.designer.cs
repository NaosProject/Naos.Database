...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<MutexObject> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<MutexObject>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<MutexObject>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<MutexObject>();

                        var result = new SystemUnderTestExpectedStringRepresentation<MutexObject>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.MutexObject: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<MutexObject> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<MutexObject>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<MutexObject>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'id' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new MutexObject(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<MutexObject> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<MutexObject>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<MutexObject>
                {
                    Name = "Id should return same 'id' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<MutexObject>();

                        var result = new SystemUnderTestExpectedPropertyValue<MutexObject>
                        {
                            SystemUnderTest = new MutexObject(
                                                      referenceObject.Id),
        ...
        private static readonly DeepCloneWithTestScenarios<MutexObject> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<MutexObject>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<MutexObject>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<MutexObject>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<MutexObject>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly MutexObject ReferenceObjectForEquatableTestScenarios = A.Dummy<MutexObject>();

        private static readonly EquatableTestScenarios<MutexObject> EquatableTestScenarios = new EquatableTestScenarios<MutexObject>()
            .AddScenario(() =>
                new EquatableTestScenario<MutexObject>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new MutexObject[]
                    {
                        new MutexObject(
                                ReferenceObjectForEquatableTestScenarios.Id),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new MutexObject[]
                    {
                        new MutexObject(
                                A.Dummy<MutexObject>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id),
                    },
        ...
        private static readonly ValidModelTestScenarios<MutexObject> ValidModelTestScenarios = new ValidModelTestScenarios<MutexObject>()
            .AddScenario(() =>
                new ValidModelTestScenario<MutexObject>
                {
                    Name = "a dummy MutexObject should be valid",
                    SystemUnderTest = A.Dummy<MutexObject>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void MutexObject___Should_implement_IModel_of_MutexObject___When_reflecting()
            {
                // Arrange
                var type = typeof(MutexObject);

                var expectedModelMethods = typeof(IModel<MutexObject>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<MutexObject>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void MutexObject___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(MutexObject);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (MutexObject)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (MutexObject)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(MutexObject).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<MutexObject>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                MutexObject systemUnderTest1 = null;
                MutexObject systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    MutexObject systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MutexObject___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MutexObject___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MutexObject___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MutexObject___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_MutexObject___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
