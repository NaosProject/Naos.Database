...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class StreamRecordHandlingEntryTest
    {
        ...
        private static readonly ValidModelTestScenarios<StreamRecordHandlingEntry> ValidModelTestScenarios = new ValidModelTestScenarios<StreamRecordHandlingEntry>()
            .AddScenario(() =>
                new ValidModelTestScenario<StreamRecordHandlingEntry>
                {
                    Name = "a dummy StreamRecordHandlingEntry should be valid",
                    SystemUnderTest = A.Dummy<StreamRecordHandlingEntry>(),
                });
