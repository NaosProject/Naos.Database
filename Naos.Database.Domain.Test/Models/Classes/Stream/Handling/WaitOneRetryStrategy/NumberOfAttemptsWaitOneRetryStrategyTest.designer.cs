...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<NumberOfAttemptsWaitOneRetryStrategy> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<NumberOfAttemptsWaitOneRetryStrategy>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<NumberOfAttemptsWaitOneRetryStrategy>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<NumberOfAttemptsWaitOneRetryStrategy> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<NumberOfAttemptsWaitOneRetryStrategy>();

        private static readonly ConstructorPropertyAssignmentTestScenarios<NumberOfAttemptsWaitOneRetryStrategy> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<NumberOfAttemptsWaitOneRetryStrategy>()
            .AddScenario(() =>
        ...
        private static readonly NumberOfAttemptsWaitOneRetryStrategy ReferenceObjectForEquatableTestScenarios = A.Dummy<NumberOfAttemptsWaitOneRetryStrategy>();

        private static readonly EquatableTestScenarios<NumberOfAttemptsWaitOneRetryStrategy> EquatableTestScenarios = new EquatableTestScenarios<NumberOfAttemptsWaitOneRetryStrategy>()
            .AddScenario(() =>
                new EquatableTestScenario<NumberOfAttemptsWaitOneRetryStrategy>
                {
                    Name = "Default Code Generated Scenario",
                    ...
                    ObjectsThatAreNotOfTheSameTypeAsReferenceObject = new object[]
                    {
                        ...
                        A.Dummy<int?>(),
                        A.Dummy<Guid>(),
                        A.Dummy<InfiniteWaitOneRetryStrategy>(),
                    },
                });

        private static readonly ValidModelTestScenarios<NumberOfAttemptsWaitOneRetryStrategy> ValidModelTestScenarios = new ValidModelTestScenarios<NumberOfAttemptsWaitOneRetryStrategy>()
            .AddScenario(() =>
                new ValidModelTestScenario<NumberOfAttemptsWaitOneRetryStrategy>
                {
                    Name = "a dummy NumberOfAttemptsWaitOneRetryStrategy should be valid",
                    SystemUnderTest = A.Dummy<NumberOfAttemptsWaitOneRetryStrategy>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void NumberOfAttemptsWaitOneRetryStrategy___Should_implement_IModel_of_NumberOfAttemptsWaitOneRetryStrategy___When_reflecting()
            {
                // Arrange
                var type = typeof(NumberOfAttemptsWaitOneRetryStrategy);

                var expectedModelMethods = typeof(IModel<NumberOfAttemptsWaitOneRetryStrategy>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<NumberOfAttemptsWaitOneRetryStrategy>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void NumberOfAttemptsWaitOneRetryStrategy___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(NumberOfAttemptsWaitOneRetryStrategy);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (NumberOfAttemptsWaitOneRetryStrategy)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (NumberOfAttemptsWaitOneRetryStrategy)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(NumberOfAttemptsWaitOneRetryStrategy).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<NumberOfAttemptsWaitOneRetryStrategy>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                NumberOfAttemptsWaitOneRetryStrategy systemUnderTest1 = null;
                NumberOfAttemptsWaitOneRetryStrategy systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    NumberOfAttemptsWaitOneRetryStrategy systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_WaitOneRetryStrategyBase___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    WaitOneRetryStrategyBase systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((WaitOneRetryStrategyBase)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_WaitOneRetryStrategyBase___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((WaitOneRetryStrategyBase)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_WaitOneRetryStrategyBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((WaitOneRetryStrategyBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_WaitOneRetryStrategyBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((WaitOneRetryStrategyBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_WaitOneRetryStrategyBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((WaitOneRetryStrategyBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NumberOfAttemptsWaitOneRetryStrategy___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NumberOfAttemptsWaitOneRetryStrategy___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NumberOfAttemptsWaitOneRetryStrategy___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NumberOfAttemptsWaitOneRetryStrategy___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NumberOfAttemptsWaitOneRetryStrategy___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
