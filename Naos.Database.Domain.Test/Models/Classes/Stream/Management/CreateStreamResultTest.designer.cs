...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class CreateStreamResultTest
    {
        ...
        private static readonly ValidModelTestScenarios<CreateStreamResult> ValidModelTestScenarios = new ValidModelTestScenarios<CreateStreamResult>()
            .AddScenario(() =>
                new ValidModelTestScenario<CreateStreamResult>
                {
                    Name = "a dummy CreateStreamResult should be valid",
                    SystemUnderTest = A.Dummy<CreateStreamResult>(),
                });
