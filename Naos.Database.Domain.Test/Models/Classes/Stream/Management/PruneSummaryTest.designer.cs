...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<PruneSummary> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<PruneSummary>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<PruneSummary>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<PruneSummary>();

                        var result = new SystemUnderTestExpectedStringRepresentation<PruneSummary>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.PruneSummary: InternalRecordIdsRemoved = {systemUnderTest.InternalRecordIdsRemoved?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<PruneSummary> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<PruneSummary>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<PruneSummary>
                {
                    Name = "constructor should throw ArgumentException when parameter 'internalRecordIdsRemoved' is an empty enumerable scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new PruneSummary(
                                             new List<long>());
                    ...
                    ExpectedExceptionMessageContains = new[] { "internalRecordIdsRemoved", "is an empty enumerable", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<PruneSummary> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<PruneSummary>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<PruneSummary>
                {
                    Name = "InternalRecordIdsRemoved should return same 'internalRecordIdsRemoved' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<PruneSummary>();

                        var result = new SystemUnderTestExpectedPropertyValue<PruneSummary>
                        {
                            SystemUnderTest = new PruneSummary(
                                                      referenceObject.InternalRecordIdsRemoved),
                            ExpectedPropertyValue = referenceObject.InternalRecordIdsRemoved,
                        };

                        return result;
                    },
                    PropertyName = "InternalRecordIdsRemoved",
                });

        private static readonly DeepCloneWithTestScenarios<PruneSummary> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<PruneSummary>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PruneSummary>
                {
                    Name = "DeepCloneWithInternalRecordIdsRemoved should deep clone object and replace InternalRecordIdsRemoved with the provided internalRecordIdsRemoved",
                    WithPropertyName = "InternalRecordIdsRemoved",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<PruneSummary>();

                        var referenceObject = A.Dummy<PruneSummary>().ThatIs(_ => !systemUnderTest.InternalRecordIdsRemoved.IsEqualTo(_.InternalRecordIdsRemoved));

                        var result = new SystemUnderTestDeepCloneWithValue<PruneSummary>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.InternalRecordIdsRemoved,
                        };
        ...
        private static readonly PruneSummary ReferenceObjectForEquatableTestScenarios = A.Dummy<PruneSummary>();

        private static readonly EquatableTestScenarios<PruneSummary> EquatableTestScenarios = new EquatableTestScenarios<PruneSummary>()
            .AddScenario(() =>
                new EquatableTestScenario<PruneSummary>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new PruneSummary[]
                    {
                        new PruneSummary(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordIdsRemoved),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new PruneSummary[]
                    {
                        new PruneSummary(
                                A.Dummy<PruneSummary>().Whose(_ => !_.InternalRecordIdsRemoved.IsEqualTo(ReferenceObjectForEquatableTestScenarios.InternalRecordIdsRemoved)).InternalRecordIdsRemoved),
                    },
        ...
        private static readonly ValidModelTestScenarios<PruneSummary> ValidModelTestScenarios = new ValidModelTestScenarios<PruneSummary>()
            .AddScenario(() =>
                new ValidModelTestScenario<PruneSummary>
                {
                    Name = "a dummy PruneSummary should be valid",
                    SystemUnderTest = A.Dummy<PruneSummary>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void PruneSummary___Should_implement_IModel_of_PruneSummary___When_reflecting()
            {
                // Arrange
                var type = typeof(PruneSummary);

                var expectedModelMethods = typeof(IModel<PruneSummary>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<PruneSummary>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void PruneSummary___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(PruneSummary);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (PruneSummary)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.InternalRecordIdsRemoved == null)
                {
                    actual.InternalRecordIdsRemoved.AsTest().Must().BeNull();
                }
                else if (!actual.InternalRecordIdsRemoved.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.InternalRecordIdsRemoved.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.InternalRecordIdsRemoved);
                }
            }
            ...
            {
                var propertyNames = new string[] { "InternalRecordIdsRemoved" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (PruneSummary)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(PruneSummary).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<PruneSummary>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                PruneSummary systemUnderTest1 = null;
                PruneSummary systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    PruneSummary systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneSummary___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneSummary___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneSummary___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneSummary___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneSummary___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
