...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class StreamRecordMetadataTest
    {
        ...
        private static readonly ValidModelTestScenarios<StreamRecordMetadata> ValidModelTestScenarios = new ValidModelTestScenarios<StreamRecordMetadata>()
            .AddScenario(() =>
                new ValidModelTestScenario<StreamRecordMetadata>
                {
                    Name = "a dummy StreamRecordMetadata should be valid",
                    SystemUnderTest = A.Dummy<StreamRecordMetadata>(),
                });
