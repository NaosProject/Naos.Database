...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class BinaryStreamRecordPayloadTest
    {
        ...
        private static readonly ValidModelTestScenarios<BinaryStreamRecordPayload> ValidModelTestScenarios = new ValidModelTestScenarios<BinaryStreamRecordPayload>()
            .AddScenario(() =>
                new ValidModelTestScenario<BinaryStreamRecordPayload>
                {
                    Name = "a dummy BinaryStreamRecordPayload should be valid",
                    SystemUnderTest = A.Dummy<BinaryStreamRecordPayload>(),
                });
