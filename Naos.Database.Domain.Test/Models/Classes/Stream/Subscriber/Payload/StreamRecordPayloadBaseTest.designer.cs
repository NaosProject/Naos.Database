...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StreamRecordPayloadBase ReferenceObjectForEquatableTestScenarios = A.Dummy<StreamRecordPayloadBase>();

        private static readonly EquatableTestScenarios<StreamRecordPayloadBase> EquatableTestScenarios = new EquatableTestScenarios<StreamRecordPayloadBase>()
            .AddScenario(() =>
                new EquatableTestScenario<StreamRecordPayloadBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new StreamRecordPayloadBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new StreamRecordPayloadBase[]
                    {
                    ...
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new StreamRecordPayloadBase[]
                    {
                        A.Dummy<StreamRecordPayloadBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class StructuralTesting
        {
            ...
            public static void StreamRecordPayloadBase___Should_implement_IModel_of_StreamRecordPayloadBase___When_reflecting()
            {
                // Arrange
                var type = typeof(StreamRecordPayloadBase);

                var expectedModelMethods = typeof(IModel<StreamRecordPayloadBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<StreamRecordPayloadBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void StreamRecordPayloadBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(StreamRecordPayloadBase);
        ...
        public static class CloningTesting
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<StreamRecordPayloadBase>();

                // Act
                var actual = (StreamRecordPayloadBase)systemUnderTest.Clone();
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<StreamRecordPayloadBase>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                StreamRecordPayloadBase systemUnderTest1 = null;
                StreamRecordPayloadBase systemUnderTest2 = null;
