...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<StringStreamRecordPayload> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<StringStreamRecordPayload>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<StringStreamRecordPayload>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<StringStreamRecordPayload>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.StringStreamRecordPayload: SerializedPayload = {systemUnderTest.SerializedPayload?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<StringStreamRecordPayload> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<StringStreamRecordPayload>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<StringStreamRecordPayload>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'serializedPayload' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new StringStreamRecordPayload(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<StringStreamRecordPayload> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<StringStreamRecordPayload>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<StringStreamRecordPayload>
                {
                    Name = "SerializedPayload should return same 'serializedPayload' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<StringStreamRecordPayload>();

                        var result = new SystemUnderTestExpectedPropertyValue<StringStreamRecordPayload>
                        {
                            SystemUnderTest = new StringStreamRecordPayload(
        ...
        private static readonly DeepCloneWithTestScenarios<StringStreamRecordPayload> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<StringStreamRecordPayload>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StringStreamRecordPayload>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StringStreamRecordPayload>().ThatIs(_ => !systemUnderTest.SerializedPayload.IsEqualTo(_.SerializedPayload));

                        var result = new SystemUnderTestDeepCloneWithValue<StringStreamRecordPayload>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly StringStreamRecordPayload ReferenceObjectForEquatableTestScenarios = A.Dummy<StringStreamRecordPayload>();

        private static readonly EquatableTestScenarios<StringStreamRecordPayload> EquatableTestScenarios = new EquatableTestScenarios<StringStreamRecordPayload>()
            .AddScenario(() =>
                new EquatableTestScenario<StringStreamRecordPayload>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new StringStreamRecordPayload[]
                    {
                        new StringStreamRecordPayload(
                                ReferenceObjectForEquatableTestScenarios.SerializedPayload),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new StringStreamRecordPayload[]
                    {
                        new StringStreamRecordPayload(
                                A.Dummy<StringStreamRecordPayload>().Whose(_ => !_.SerializedPayload.IsEqualTo(ReferenceObjectForEquatableTestScenarios.SerializedPayload)).SerializedPayload),
                    },
                    ObjectsThatAreNotOfTheSameTypeAsReferenceObject = new object[]
                    {
                        ...
                        A.Dummy<int?>(),
                        A.Dummy<Guid>(),
                        A.Dummy<BinaryStreamRecordPayload>(),
                        A.Dummy<NullStreamRecordPayload>(),
                    },
                });

        private static readonly ValidModelTestScenarios<StringStreamRecordPayload> ValidModelTestScenarios = new ValidModelTestScenarios<StringStreamRecordPayload>()
            .AddScenario(() =>
                new ValidModelTestScenario<StringStreamRecordPayload>
                {
                    Name = "a dummy StringStreamRecordPayload should be valid",
                    SystemUnderTest = A.Dummy<StringStreamRecordPayload>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void StringStreamRecordPayload___Should_implement_IModel_of_StringStreamRecordPayload___When_reflecting()
            {
                // Arrange
                var type = typeof(StringStreamRecordPayload);

                var expectedModelMethods = typeof(IModel<StringStreamRecordPayload>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<StringStreamRecordPayload>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void StringStreamRecordPayload___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(StringStreamRecordPayload);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (StringStreamRecordPayload)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (StringStreamRecordPayload)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(StringStreamRecordPayload).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                StringStreamRecordPayload systemUnderTest1 = null;
                StringStreamRecordPayload systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    StringStreamRecordPayload systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StringStreamRecordPayload___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StringStreamRecordPayload___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StringStreamRecordPayload___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StringStreamRecordPayload___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StringStreamRecordPayload___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
