...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class StreamRecordTest
    {
        ...
        private static readonly ValidModelTestScenarios<StreamRecord> ValidModelTestScenarios = new ValidModelTestScenarios<StreamRecord>()
            .AddScenario(() =>
                new ValidModelTestScenario<StreamRecord>
                {
                    Name = "a dummy StreamRecord should be valid",
                    SystemUnderTest = A.Dummy<StreamRecord>(),
                });
