...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<StreamRecord<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<StreamRecord<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<StreamRecord<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<StreamRecord<Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<StreamRecord<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.StreamRecord<Version>: InternalRecordId = {systemUnderTest.InternalRecordId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Metadata = {systemUnderTest.Metadata?.ToString() ?? "<null>"}, Payload = {systemUnderTest.Payload?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<StreamRecord<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<StreamRecord<Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<StreamRecord<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'metadata' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<StreamRecord<Version>>();

                        var result = new StreamRecord<Version>(
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<StreamRecord<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<StreamRecord<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<StreamRecord<Version>>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<StreamRecord<Version>>
                        {
                            SystemUnderTest = new StreamRecord<Version>(
                                                      referenceObject.InternalRecordId,
                                                      referenceObject.Metadata,
                                                      referenceObject.Payload),
        ...
        private static readonly DeepCloneWithTestScenarios<StreamRecord<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<StreamRecord<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StreamRecord<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StreamRecord<Version>>().ThatIs(_ => !systemUnderTest.InternalRecordId.IsEqualTo(_.InternalRecordId));

                        var result = new SystemUnderTestDeepCloneWithValue<StreamRecord<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StreamRecord<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StreamRecord<Version>>().ThatIs(_ => !systemUnderTest.Metadata.IsEqualTo(_.Metadata));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StreamRecord<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StreamRecord<Version>>().ThatIs(_ => !systemUnderTest.Payload.IsEqualTo(_.Payload));
        ...
        private static readonly StreamRecord<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<StreamRecord<Version>>();

        private static readonly EquatableTestScenarios<StreamRecord<Version>> EquatableTestScenarios = new EquatableTestScenarios<StreamRecord<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<StreamRecord<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new StreamRecord<Version>[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new StreamRecord<Version>[]
                    {
                        new StreamRecord<Version>(
                                A.Dummy<StreamRecord<Version>>().Whose(_ => !_.InternalRecordId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.InternalRecordId)).InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Metadata,
                                ReferenceObjectForEquatableTestScenarios.Payload),
                        new StreamRecord<Version>(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                A.Dummy<StreamRecord<Version>>().Whose(_ => !_.Metadata.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Metadata)).Metadata,
                                ReferenceObjectForEquatableTestScenarios.Payload),
                        new StreamRecord<Version>(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Metadata,
                                A.Dummy<StreamRecord<Version>>().Whose(_ => !_.Payload.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Payload)).Payload),
                    },
        ...
        private static readonly ValidModelTestScenarios<StreamRecord<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<StreamRecord<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<StreamRecord<Version>>
                {
                    Name = "a dummy StreamRecord<Version> should be valid",
                    SystemUnderTest = A.Dummy<StreamRecord<Version>>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void StreamRecord_of_Version___Should_implement_IModel_of_StreamRecord_of_Version___When_reflecting()
            {
                // Arrange
                var type = typeof(StreamRecord<Version>);

                var expectedModelMethods = typeof(IModel<StreamRecord<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<StreamRecord<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void StreamRecord_of_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(StreamRecord<Version>);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (StreamRecord<Version>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (StreamRecord<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(StreamRecord<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<StreamRecord<Version>>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                StreamRecord<Version> systemUnderTest1 = null;
                StreamRecord<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    StreamRecord<Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StreamRecord_of_Version___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StreamRecord_of_Version___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StreamRecord_of_Version___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StreamRecord_of_Version___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StreamRecord_of_Version___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
