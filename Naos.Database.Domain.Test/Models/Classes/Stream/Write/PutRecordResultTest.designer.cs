    ...
    public static partial class PutRecordResultTest
    {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<PutRecordResult> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<PutRecordResult>()
            .AddScenario(() =>
                ...
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'existingRecordIds' is null scenario",
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new PutRecordResult(
                                             ...
                                             null,
                                             referenceObject.PrunedRecordIds);

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "existingRecordIds", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<PutRecordResult>
                {
                    Name = "constructor should throw ArgumentException when parameter 'existingRecordIds' is an empty enumerable scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<PutRecordResult>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "existingRecordIds", "is an empty enumerable", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<PutRecordResult>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'prunedRecordIds' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<PutRecordResult>();
                        ...
                        var result = new PutRecordResult(
                                             referenceObject.InternalRecordIdOfPutRecord,
                                             referenceObject.ExistingRecordIds,
                                             null);

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "prunedRecordIds", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<PutRecordResult>
                {
                    Name = "constructor should throw ArgumentException when parameter 'prunedRecordIds' is an empty enumerable scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<PutRecordResult>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "prunedRecordIds", "is an empty enumerable", },
                });
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<PutRecordResult> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<PutRecordResult>()
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<PutRecordResult>
                {
                    Name = "ExistingRecordIds should return same 'existingRecordIds' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<PutRecordResult>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<PutRecordResult>
                        {
                            SystemUnderTest = new PutRecordResult(
                                                      ...
                                                      referenceObject.ExistingRecordIds,
                                                      referenceObject.PrunedRecordIds),
                            ExpectedPropertyValue = referenceObject.ExistingRecordIds,
                        };

                        return result;
                    },
                    PropertyName = "ExistingRecordIds",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<PutRecordResult>
                {
                    Name = "PrunedRecordIds should return same 'prunedRecordIds' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<PutRecordResult>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<PutRecordResult>
                        {
                            SystemUnderTest = new PutRecordResult(
                                                      ...
                                                      referenceObject.ExistingRecordIds,
                                                      referenceObject.PrunedRecordIds),
                            ExpectedPropertyValue = referenceObject.PrunedRecordIds,
                        };

                        return result;
                    },
                    PropertyName = "PrunedRecordIds",
                });
        ...
        public static class Cloning
        {
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.ExistingRecordIds == null)
                {
                    actual.ExistingRecordIds.AsTest().Must().BeNull();
                }
                else if (!actual.ExistingRecordIds.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.ExistingRecordIds.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.ExistingRecordIds);
                }

                if (systemUnderTest.PrunedRecordIds == null)
                {
                    actual.PrunedRecordIds.AsTest().Must().BeNull();
                }
                else if (!actual.PrunedRecordIds.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.PrunedRecordIds.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.PrunedRecordIds);
                }
            }
        }
