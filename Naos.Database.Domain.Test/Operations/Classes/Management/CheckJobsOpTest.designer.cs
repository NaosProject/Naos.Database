...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CheckJobsOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CheckJobsOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CheckJobsOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CheckJobsOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CheckJobsOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.CheckJobsOp: Jobs = {systemUnderTest.Jobs?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CheckJobsOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CheckJobsOp>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CheckJobsOp>
                {
                    Name = "constructor should throw ArgumentException when parameter 'jobs' is an empty enumerable scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new CheckJobsOp(
                                             new List<ExpectedJobWithinThreshold>());

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "jobs", "is an empty enumerable", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CheckJobsOp>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CheckJobsOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CheckJobsOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CheckJobsOp>
                {
                    Name = "Jobs should return same 'jobs' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CheckJobsOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<CheckJobsOp>
                        {
                            SystemUnderTest = new CheckJobsOp(
                                                      referenceObject.Jobs),
                            ExpectedPropertyValue = referenceObject.Jobs,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<CheckJobsOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CheckJobsOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CheckJobsOp>
                {
                    Name = "DeepCloneWithJobs should deep clone object and replace Jobs with the provided jobs",
                    WithPropertyName = "Jobs",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CheckJobsOp>();

                        var referenceObject = A.Dummy<CheckJobsOp>().ThatIs(_ => !systemUnderTest.Jobs.IsEqualTo(_.Jobs));

                        var result = new SystemUnderTestDeepCloneWithValue<CheckJobsOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Jobs,
                        };
        ...
        private static readonly CheckJobsOp ReferenceObjectForEquatableTestScenarios = A.Dummy<CheckJobsOp>();

        private static readonly EquatableTestScenarios<CheckJobsOp> EquatableTestScenarios = new EquatableTestScenarios<CheckJobsOp>()
            .AddScenario(() =>
                new EquatableTestScenario<CheckJobsOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CheckJobsOp[]
                    {
                        new CheckJobsOp(
                                ReferenceObjectForEquatableTestScenarios.Jobs),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CheckJobsOp[]
                    {
                        new CheckJobsOp(
                                A.Dummy<CheckJobsOp>().Whose(_ => !_.Jobs.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Jobs)).Jobs),
                    },
        ...
        private static readonly ValidModelTestScenarios<CheckJobsOp> ValidModelTestScenarios = new ValidModelTestScenarios<CheckJobsOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<CheckJobsOp>
                {
                    Name = "a dummy CheckJobsOp should be valid",
                    SystemUnderTest = A.Dummy<CheckJobsOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void CheckJobsOp___Should_implement_IModel_of_CheckJobsOp___When_reflecting()
            {
                // Arrange
                var type = typeof(CheckJobsOp);

                var expectedModelMethods = typeof(IModel<CheckJobsOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CheckJobsOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CheckJobsOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CheckJobsOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CheckJobsOp)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.Jobs == null)
                {
                    actual.Jobs.AsTest().Must().BeNull();
                }
                else if (!actual.Jobs.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.Jobs.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.Jobs);
                }
            }
            ...
            {
                var propertyNames = new string[] { "Jobs" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CheckJobsOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CheckJobsOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CheckJobsOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                CheckJobsOp systemUnderTest1 = null;
                CheckJobsOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CheckJobsOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_CheckJobsReport___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    ReturningOperationBase<CheckJobsReport> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<CheckJobsReport>)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_CheckJobsReport___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<CheckJobsReport>)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_CheckJobsReport___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<CheckJobsReport>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_CheckJobsReport___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<CheckJobsReport>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_CheckJobsReport___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<CheckJobsReport>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckJobsOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckJobsOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckJobsOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckJobsOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckJobsOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
