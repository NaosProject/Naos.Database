...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CheckStreamsOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CheckStreamsOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CheckStreamsOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CheckStreamsOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CheckStreamsOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.CheckStreamsOp: StreamNameToCheckStreamInstructionsMap = {systemUnderTest.StreamNameToCheckStreamInstructionsMap?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CheckStreamsOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CheckStreamsOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CheckStreamsOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'streamNameToCheckStreamInstructionsMap' is null scenario",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "streamNameToCheckStreamInstructionsMap", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CheckStreamsOp>
                {
                    Name = "constructor should throw ArgumentException when parameter 'streamNameToCheckStreamInstructionsMap' is an empty dictionary scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new CheckStreamsOp(
                                             new Dictionary<string, CheckStreamInstruction>());

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "streamNameToCheckStreamInstructionsMap", "is an empty dictionary", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CheckStreamsOp>
                {
                    Name = "constructor should throw ArgumentException when parameter 'streamNameToCheckStreamInstructionsMap' contains a key-value pair with a null value scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CheckStreamsOp>();

                        var dictionaryWithNullValue = referenceObject.StreamNameToCheckStreamInstructionsMap.ToDictionary(_ => _.Key, _ => _.Value);
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "streamNameToCheckStreamInstructionsMap", "contains at least one key-value pair with a null value", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<CheckStreamsOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CheckStreamsOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CheckStreamsOp>
                {
                    Name = "StreamNameToCheckStreamInstructionsMap should return same 'streamNameToCheckStreamInstructionsMap' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CheckStreamsOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<CheckStreamsOp>
                        {
                            SystemUnderTest = new CheckStreamsOp(
                                                      referenceObject.StreamNameToCheckStreamInstructionsMap),
                            ExpectedPropertyValue = referenceObject.StreamNameToCheckStreamInstructionsMap,
                        };

                        return result;
                    },
                    PropertyName = "StreamNameToCheckStreamInstructionsMap",
                });

        private static readonly DeepCloneWithTestScenarios<CheckStreamsOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CheckStreamsOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CheckStreamsOp>
                {
                    Name = "DeepCloneWithStreamNameToCheckStreamInstructionsMap should deep clone object and replace StreamNameToCheckStreamInstructionsMap with the provided streamNameToCheckStreamInstructionsMap",
                    WithPropertyName = "StreamNameToCheckStreamInstructionsMap",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CheckStreamsOp>();

                        var referenceObject = A.Dummy<CheckStreamsOp>().ThatIs(_ => !systemUnderTest.StreamNameToCheckStreamInstructionsMap.IsEqualTo(_.StreamNameToCheckStreamInstructionsMap));

                        var result = new SystemUnderTestDeepCloneWithValue<CheckStreamsOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.StreamNameToCheckStreamInstructionsMap,
                        };
        ...
        private static readonly CheckStreamsOp ReferenceObjectForEquatableTestScenarios = A.Dummy<CheckStreamsOp>();

        private static readonly EquatableTestScenarios<CheckStreamsOp> EquatableTestScenarios = new EquatableTestScenarios<CheckStreamsOp>()
            .AddScenario(() =>
                new EquatableTestScenario<CheckStreamsOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CheckStreamsOp[]
                    {
                        new CheckStreamsOp(
                                ReferenceObjectForEquatableTestScenarios.StreamNameToCheckStreamInstructionsMap),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CheckStreamsOp[]
                    {
                        new CheckStreamsOp(
                                A.Dummy<CheckStreamsOp>().Whose(_ => !_.StreamNameToCheckStreamInstructionsMap.IsEqualTo(ReferenceObjectForEquatableTestScenarios.StreamNameToCheckStreamInstructionsMap)).StreamNameToCheckStreamInstructionsMap),
                    },
        ...
        private static readonly ValidModelTestScenarios<CheckStreamsOp> ValidModelTestScenarios = new ValidModelTestScenarios<CheckStreamsOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<CheckStreamsOp>
                {
                    Name = "a dummy CheckStreamsOp should be valid",
                    SystemUnderTest = A.Dummy<CheckStreamsOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void CheckStreamsOp___Should_implement_IModel_of_CheckStreamsOp___When_reflecting()
            {
                // Arrange
                var type = typeof(CheckStreamsOp);

                var expectedModelMethods = typeof(IModel<CheckStreamsOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CheckStreamsOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CheckStreamsOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CheckStreamsOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CheckStreamsOp)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.StreamNameToCheckStreamInstructionsMap == null)
                {
                    actual.StreamNameToCheckStreamInstructionsMap.AsTest().Must().BeNull();
                }
                else if (!actual.StreamNameToCheckStreamInstructionsMap.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.StreamNameToCheckStreamInstructionsMap.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.StreamNameToCheckStreamInstructionsMap);
                }
            }
            ...
            {
                var propertyNames = new string[] { "StreamNameToCheckStreamInstructionsMap" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CheckStreamsOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CheckStreamsOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CheckStreamsOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                CheckStreamsOp systemUnderTest1 = null;
                CheckStreamsOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CheckStreamsOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_CheckStreamsReport___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    ReturningOperationBase<CheckStreamsReport> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<CheckStreamsReport>)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_CheckStreamsReport___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<CheckStreamsReport>)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_CheckStreamsReport___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<CheckStreamsReport>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_CheckStreamsReport___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<CheckStreamsReport>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_CheckStreamsReport___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<CheckStreamsReport>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckStreamsOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckStreamsOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckStreamsOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckStreamsOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckStreamsOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
