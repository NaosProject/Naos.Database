    ...
    public static partial class CreateDatabaseOpTest
    {
                ...
                new StringRepresentationTestScenario<CreateDatabaseOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<CreateDatabaseOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.CreateDatabaseOp: Definition = {systemUnderTest.Definition?.ToString() ?? "<null>"}, ExistingDatabaseStrategy = {systemUnderTest.ExistingDatabaseStrategy.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CreateDatabaseOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CreateDatabaseOp>()
                ...
                new ConstructorArgumentValidationTestScenario<CreateDatabaseOp>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new CreateDatabaseOp(
                                             null,
                                             referenceObject.ExistingDatabaseStrategy);
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CreateDatabaseOp>
                {
                    Name = "constructor should throw ArgumentOutOfRangeException when parameter 'existingDatabaseStrategy' is ExistingDatabaseStrategy.Unknown",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CreateDatabaseOp>();
                        ...
                        var result = new CreateDatabaseOp(
                                             ...
                                             ExistingDatabaseStrategy.Unknown);

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentOutOfRangeException),
                    ExpectedExceptionMessageContains = new[] { "existingDatabaseStrategy", "Unknown", },
                });
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CreateDatabaseOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CreateDatabaseOp>()
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CreateDatabaseOp>
                {
                    Name = "ExistingDatabaseStrategy should return same 'existingDatabaseStrategy' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CreateDatabaseOp>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CreateDatabaseOp>
                        {
                            SystemUnderTest = new CreateDatabaseOp(
                                                      referenceObject.Definition,
                                                      referenceObject.ExistingDatabaseStrategy),
                            ExpectedPropertyValue = referenceObject.ExistingDatabaseStrategy,
                        };

                        return result;
                    },
                    PropertyName = "ExistingDatabaseStrategy",
                });
        ...
        private static readonly DeepCloneWithTestScenarios<CreateDatabaseOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CreateDatabaseOp>()
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CreateDatabaseOp>
                {
                    Name = "DeepCloneWithExistingDatabaseStrategy should deep clone object and replace ExistingDatabaseStrategy with the provided existingDatabaseStrategy",
                    WithPropertyName = "ExistingDatabaseStrategy",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CreateDatabaseOp>();

                        var referenceObject = A.Dummy<CreateDatabaseOp>().ThatIs(_ => !systemUnderTest.ExistingDatabaseStrategy.IsEqualTo(_.ExistingDatabaseStrategy));

                        var result = new SystemUnderTestDeepCloneWithValue<CreateDatabaseOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ExistingDatabaseStrategy,
                        };
                ...
                new EquatableTestScenario<CreateDatabaseOp>
                {
                    ...
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CreateDatabaseOp[]
                    {
                        new CreateDatabaseOp(
                                ...
                                ReferenceObjectForEquatableTestScenarios.ExistingDatabaseStrategy),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CreateDatabaseOp[]
                    {
                        ...
                        new CreateDatabaseOp(
                                ReferenceObjectForEquatableTestScenarios.Definition,
                                A.Dummy<CreateDatabaseOp>().Whose(_ => !_.ExistingDatabaseStrategy.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ExistingDatabaseStrategy)).ExistingDatabaseStrategy),
                    },
        ...
        private static readonly ValidModelTestScenarios<CreateDatabaseOp> ValidModelTestScenarios = new ValidModelTestScenarios<CreateDatabaseOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<CreateDatabaseOp>
                {
                    Name = "a dummy CreateDatabaseOp should be valid",
                    SystemUnderTest = A.Dummy<CreateDatabaseOp>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            {
                var propertyNames = new string[] { "Definition", "ExistingDatabaseStrategy" };
