...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<GetLatestJobInformationOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<GetLatestJobInformationOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<GetLatestJobInformationOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<GetLatestJobInformationOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<GetLatestJobInformationOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.GetLatestJobInformationOp: JobName = {systemUnderTest.JobName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetLatestJobInformationOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetLatestJobInformationOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetLatestJobInformationOp>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<GetLatestJobInformationOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<GetLatestJobInformationOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<GetLatestJobInformationOp>
                {
                    Name = "JobName should return same 'jobName' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<GetLatestJobInformationOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<GetLatestJobInformationOp>
                        {
                            SystemUnderTest = new GetLatestJobInformationOp(
        ...
        private static readonly DeepCloneWithTestScenarios<GetLatestJobInformationOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<GetLatestJobInformationOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetLatestJobInformationOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetLatestJobInformationOp>().ThatIs(_ => !systemUnderTest.JobName.IsEqualTo(_.JobName));

                        var result = new SystemUnderTestDeepCloneWithValue<GetLatestJobInformationOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly GetLatestJobInformationOp ReferenceObjectForEquatableTestScenarios = A.Dummy<GetLatestJobInformationOp>();

        private static readonly EquatableTestScenarios<GetLatestJobInformationOp> EquatableTestScenarios = new EquatableTestScenarios<GetLatestJobInformationOp>()
            .AddScenario(() =>
                new EquatableTestScenario<GetLatestJobInformationOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GetLatestJobInformationOp[]
                    {
                        new GetLatestJobInformationOp(
                                ReferenceObjectForEquatableTestScenarios.JobName),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new GetLatestJobInformationOp[]
                    {
                        new GetLatestJobInformationOp(
                                A.Dummy<GetLatestJobInformationOp>().Whose(_ => !_.JobName.IsEqualTo(ReferenceObjectForEquatableTestScenarios.JobName)).JobName),
                    },
        ...
        private static readonly ValidModelTestScenarios<GetLatestJobInformationOp> ValidModelTestScenarios = new ValidModelTestScenarios<GetLatestJobInformationOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<GetLatestJobInformationOp>
                {
                    Name = "a dummy GetLatestJobInformationOp should be valid",
                    SystemUnderTest = A.Dummy<GetLatestJobInformationOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void GetLatestJobInformationOp___Should_implement_IModel_of_GetLatestJobInformationOp___When_reflecting()
            {
                // Arrange
                var type = typeof(GetLatestJobInformationOp);

                var expectedModelMethods = typeof(IModel<GetLatestJobInformationOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GetLatestJobInformationOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void GetLatestJobInformationOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(GetLatestJobInformationOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (GetLatestJobInformationOp)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "JobName" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (GetLatestJobInformationOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(GetLatestJobInformationOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GetLatestJobInformationOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                GetLatestJobInformationOp systemUnderTest1 = null;
                GetLatestJobInformationOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    GetLatestJobInformationOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_IJobInformation___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    ReturningOperationBase<IJobInformation> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<IJobInformation>)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_IJobInformation___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<IJobInformation>)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_IJobInformation___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IJobInformation>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_IJobInformation___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IJobInformation>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_IJobInformation___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IJobInformation>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetLatestJobInformationOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetLatestJobInformationOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetLatestJobInformationOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetLatestJobInformationOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetLatestJobInformationOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
