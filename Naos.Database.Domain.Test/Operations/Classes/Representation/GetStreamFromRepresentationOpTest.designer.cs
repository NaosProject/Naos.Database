...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<GetStreamFromRepresentationOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<GetStreamFromRepresentationOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<GetStreamFromRepresentationOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<GetStreamFromRepresentationOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<GetStreamFromRepresentationOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.GetStreamFromRepresentationOp: StreamRepresentation = {systemUnderTest.StreamRepresentation?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetStreamFromRepresentationOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetStreamFromRepresentationOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetStreamFromRepresentationOp>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<GetStreamFromRepresentationOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<GetStreamFromRepresentationOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<GetStreamFromRepresentationOp>
                {
                    Name = "StreamRepresentation should return same 'streamRepresentation' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<GetStreamFromRepresentationOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<GetStreamFromRepresentationOp>
                        {
                            SystemUnderTest = new GetStreamFromRepresentationOp(
        ...
        private static readonly DeepCloneWithTestScenarios<GetStreamFromRepresentationOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<GetStreamFromRepresentationOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetStreamFromRepresentationOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetStreamFromRepresentationOp>().ThatIs(_ => !systemUnderTest.StreamRepresentation.IsEqualTo(_.StreamRepresentation));

                        var result = new SystemUnderTestDeepCloneWithValue<GetStreamFromRepresentationOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly GetStreamFromRepresentationOp ReferenceObjectForEquatableTestScenarios = A.Dummy<GetStreamFromRepresentationOp>();

        private static readonly EquatableTestScenarios<GetStreamFromRepresentationOp> EquatableTestScenarios = new EquatableTestScenarios<GetStreamFromRepresentationOp>()
            .AddScenario(() =>
                new EquatableTestScenario<GetStreamFromRepresentationOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GetStreamFromRepresentationOp[]
                    {
                        new GetStreamFromRepresentationOp(
                                ReferenceObjectForEquatableTestScenarios.StreamRepresentation),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new GetStreamFromRepresentationOp[]
                    {
                        new GetStreamFromRepresentationOp(
                                A.Dummy<GetStreamFromRepresentationOp>().Whose(_ => !_.StreamRepresentation.IsEqualTo(ReferenceObjectForEquatableTestScenarios.StreamRepresentation)).StreamRepresentation),
                    },
        ...
        private static readonly ValidModelTestScenarios<GetStreamFromRepresentationOp> ValidModelTestScenarios = new ValidModelTestScenarios<GetStreamFromRepresentationOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<GetStreamFromRepresentationOp>
                {
                    Name = "a dummy GetStreamFromRepresentationOp should be valid",
                    SystemUnderTest = A.Dummy<GetStreamFromRepresentationOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            {
                // Arrange
                var type = typeof(GetStreamFromRepresentationOp);

                var expectedModelMethods = typeof(IModel<GetStreamFromRepresentationOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GetStreamFromRepresentationOp>));
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (GetStreamFromRepresentationOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (GetStreamFromRepresentationOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(GetStreamFromRepresentationOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GetStreamFromRepresentationOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                GetStreamFromRepresentationOp systemUnderTest1 = null;
                GetStreamFromRepresentationOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    GetStreamFromRepresentationOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_IStreamRepresentation___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    ReturningOperationBase<IStreamRepresentation> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<IStreamRepresentation>)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_IStreamRepresentation___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<IStreamRepresentation>)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_IStreamRepresentation___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IStreamRepresentation>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_IStreamRepresentation___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IStreamRepresentation>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_IStreamRepresentation___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IStreamRepresentation>)_)).ToList();
