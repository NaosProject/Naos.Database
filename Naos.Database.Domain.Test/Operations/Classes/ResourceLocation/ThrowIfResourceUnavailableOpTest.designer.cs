...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class ThrowIfResourceUnavailableOpTest
    {
                ...
                new StringRepresentationTestScenario<ThrowIfResourceUnavailableOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<ThrowIfResourceUnavailableOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.ThrowIfResourceUnavailableOp: ResourceLocator = {systemUnderTest.ResourceLocator?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ValidModelTestScenarios<ThrowIfResourceUnavailableOp> ValidModelTestScenarios = new ValidModelTestScenarios<ThrowIfResourceUnavailableOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<ThrowIfResourceUnavailableOp>
                {
                    Name = "a dummy ThrowIfResourceUnavailableOp should be valid",
                    SystemUnderTest = A.Dummy<ThrowIfResourceUnavailableOp>(),
                });
