...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<DisableRecordHandlingForStreamOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<DisableRecordHandlingForStreamOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<DisableRecordHandlingForStreamOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<DisableRecordHandlingForStreamOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<DisableRecordHandlingForStreamOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.DisableRecordHandlingForStreamOp: Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Tags = {systemUnderTest.Tags?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<DisableRecordHandlingForStreamOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<DisableRecordHandlingForStreamOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<DisableRecordHandlingForStreamOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'details' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<DisableRecordHandlingForStreamOp>();

                        var result = new DisableRecordHandlingForStreamOp(
                                             null,
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<DisableRecordHandlingForStreamOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<DisableRecordHandlingForStreamOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<DisableRecordHandlingForStreamOp>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<DisableRecordHandlingForStreamOp>
                        {
                            SystemUnderTest = new DisableRecordHandlingForStreamOp(
                                                      referenceObject.Details,
                                                      referenceObject.Tags),
        ...
        private static readonly DeepCloneWithTestScenarios<DisableRecordHandlingForStreamOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<DisableRecordHandlingForStreamOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DisableRecordHandlingForStreamOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DisableRecordHandlingForStreamOp>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));

                        var result = new SystemUnderTestDeepCloneWithValue<DisableRecordHandlingForStreamOp>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DisableRecordHandlingForStreamOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DisableRecordHandlingForStreamOp>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
        ...
        private static readonly DisableRecordHandlingForStreamOp ReferenceObjectForEquatableTestScenarios = A.Dummy<DisableRecordHandlingForStreamOp>();

        private static readonly EquatableTestScenarios<DisableRecordHandlingForStreamOp> EquatableTestScenarios = new EquatableTestScenarios<DisableRecordHandlingForStreamOp>()
            .AddScenario(() =>
                new EquatableTestScenario<DisableRecordHandlingForStreamOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new DisableRecordHandlingForStreamOp[]
                    {
                        new DisableRecordHandlingForStreamOp(
                                ReferenceObjectForEquatableTestScenarios.Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new DisableRecordHandlingForStreamOp[]
                    {
                        new DisableRecordHandlingForStreamOp(
                                A.Dummy<DisableRecordHandlingForStreamOp>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new DisableRecordHandlingForStreamOp(
                                ReferenceObjectForEquatableTestScenarios.Details,
                                A.Dummy<DisableRecordHandlingForStreamOp>().Whose(_ => !_.Tags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Tags)).Tags),
                    },
        ...
        public static class Structural
        {
            ...
            public static void DisableRecordHandlingForStreamOp___Should_implement_IModel_of_DisableRecordHandlingForStreamOp___When_reflecting()
            {
                // Arrange
                var type = typeof(DisableRecordHandlingForStreamOp);

                var expectedModelMethods = typeof(IModel<DisableRecordHandlingForStreamOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<DisableRecordHandlingForStreamOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void DisableRecordHandlingForStreamOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(DisableRecordHandlingForStreamOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (DisableRecordHandlingForStreamOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (DisableRecordHandlingForStreamOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(DisableRecordHandlingForStreamOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<DisableRecordHandlingForStreamOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                DisableRecordHandlingForStreamOp systemUnderTest1 = null;
                DisableRecordHandlingForStreamOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    DisableRecordHandlingForStreamOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DisableRecordHandlingForStreamOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DisableRecordHandlingForStreamOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DisableRecordHandlingForStreamOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DisableRecordHandlingForStreamOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DisableRecordHandlingForStreamOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
