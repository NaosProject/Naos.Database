...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<EnableRecordHandlingForStreamOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<EnableRecordHandlingForStreamOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<EnableRecordHandlingForStreamOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<EnableRecordHandlingForStreamOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<EnableRecordHandlingForStreamOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.EnableRecordHandlingForStreamOp: Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Tags = {systemUnderTest.Tags?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<EnableRecordHandlingForStreamOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<EnableRecordHandlingForStreamOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<EnableRecordHandlingForStreamOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'details' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<EnableRecordHandlingForStreamOp>();

                        var result = new EnableRecordHandlingForStreamOp(
                                             null,
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<EnableRecordHandlingForStreamOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<EnableRecordHandlingForStreamOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<EnableRecordHandlingForStreamOp>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<EnableRecordHandlingForStreamOp>
                        {
                            SystemUnderTest = new EnableRecordHandlingForStreamOp(
                                                      referenceObject.Details,
                                                      referenceObject.Tags),
        ...
        private static readonly DeepCloneWithTestScenarios<EnableRecordHandlingForStreamOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<EnableRecordHandlingForStreamOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<EnableRecordHandlingForStreamOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<EnableRecordHandlingForStreamOp>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));

                        var result = new SystemUnderTestDeepCloneWithValue<EnableRecordHandlingForStreamOp>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<EnableRecordHandlingForStreamOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<EnableRecordHandlingForStreamOp>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
        ...
        private static readonly EnableRecordHandlingForStreamOp ReferenceObjectForEquatableTestScenarios = A.Dummy<EnableRecordHandlingForStreamOp>();

        private static readonly EquatableTestScenarios<EnableRecordHandlingForStreamOp> EquatableTestScenarios = new EquatableTestScenarios<EnableRecordHandlingForStreamOp>()
            .AddScenario(() =>
                new EquatableTestScenario<EnableRecordHandlingForStreamOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new EnableRecordHandlingForStreamOp[]
                    {
                        new EnableRecordHandlingForStreamOp(
                                ReferenceObjectForEquatableTestScenarios.Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new EnableRecordHandlingForStreamOp[]
                    {
                        new EnableRecordHandlingForStreamOp(
                                A.Dummy<EnableRecordHandlingForStreamOp>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new EnableRecordHandlingForStreamOp(
                                ReferenceObjectForEquatableTestScenarios.Details,
                                A.Dummy<EnableRecordHandlingForStreamOp>().Whose(_ => !_.Tags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Tags)).Tags),
                    },
        ...
        public static class Structural
        {
            ...
            public static void EnableRecordHandlingForStreamOp___Should_implement_IModel_of_EnableRecordHandlingForStreamOp___When_reflecting()
            {
                // Arrange
                var type = typeof(EnableRecordHandlingForStreamOp);

                var expectedModelMethods = typeof(IModel<EnableRecordHandlingForStreamOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<EnableRecordHandlingForStreamOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void EnableRecordHandlingForStreamOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(EnableRecordHandlingForStreamOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (EnableRecordHandlingForStreamOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (EnableRecordHandlingForStreamOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(EnableRecordHandlingForStreamOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<EnableRecordHandlingForStreamOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                EnableRecordHandlingForStreamOp systemUnderTest1 = null;
                EnableRecordHandlingForStreamOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    EnableRecordHandlingForStreamOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EnableRecordHandlingForStreamOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EnableRecordHandlingForStreamOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EnableRecordHandlingForStreamOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EnableRecordHandlingForStreamOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EnableRecordHandlingForStreamOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
