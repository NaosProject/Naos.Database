...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class GetCompositeHandlingStatusByIdsOpTIdTest
    {
                ...
                new StringRepresentationTestScenario<GetCompositeHandlingStatusByIdsOp<Version>>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<GetCompositeHandlingStatusByIdsOp<Version>>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.GetCompositeHandlingStatusByIdsOp<Version>: Concern = {systemUnderTest.Concern?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, IdsToMatch = {systemUnderTest.IdsToMatch?.ToString() ?? "<null>"}, VersionMatchStrategy = {systemUnderTest.VersionMatchStrategy.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ValidModelTestScenarios<GetCompositeHandlingStatusByIdsOp<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<GetCompositeHandlingStatusByIdsOp<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<GetCompositeHandlingStatusByIdsOp<Version>>
                {
                    Name = "a dummy GetCompositeHandlingStatusByIdsOp<Version> should be valid",
                    SystemUnderTest = A.Dummy<GetCompositeHandlingStatusByIdsOp<Version>>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            {
                var propertyNames = new string[] { "Concern", "IdsToMatch", "VersionMatchStrategy" };
