...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<GetHandlingHistoryOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<GetHandlingHistoryOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<GetHandlingHistoryOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<GetHandlingHistoryOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<GetHandlingHistoryOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.GetHandlingHistoryOp: InternalRecordId = {systemUnderTest.InternalRecordId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Concern = {systemUnderTest.Concern?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetHandlingHistoryOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetHandlingHistoryOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetHandlingHistoryOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'concern' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<GetHandlingHistoryOp>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<GetHandlingHistoryOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<GetHandlingHistoryOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<GetHandlingHistoryOp>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<GetHandlingHistoryOp>
                        {
                            SystemUnderTest = new GetHandlingHistoryOp(
                                                      referenceObject.InternalRecordId,
        ...
        private static readonly DeepCloneWithTestScenarios<GetHandlingHistoryOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<GetHandlingHistoryOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetHandlingHistoryOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetHandlingHistoryOp>().ThatIs(_ => !systemUnderTest.InternalRecordId.IsEqualTo(_.InternalRecordId));

                        var result = new SystemUnderTestDeepCloneWithValue<GetHandlingHistoryOp>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetHandlingHistoryOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetHandlingHistoryOp>().ThatIs(_ => !systemUnderTest.Concern.IsEqualTo(_.Concern));
        ...
        private static readonly GetHandlingHistoryOp ReferenceObjectForEquatableTestScenarios = A.Dummy<GetHandlingHistoryOp>();

        private static readonly EquatableTestScenarios<GetHandlingHistoryOp> EquatableTestScenarios = new EquatableTestScenarios<GetHandlingHistoryOp>()
            .AddScenario(() =>
                new EquatableTestScenario<GetHandlingHistoryOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GetHandlingHistoryOp[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new GetHandlingHistoryOp[]
                    {
                        new GetHandlingHistoryOp(
                                A.Dummy<GetHandlingHistoryOp>().Whose(_ => !_.InternalRecordId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.InternalRecordId)).InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Concern),
                        new GetHandlingHistoryOp(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                A.Dummy<GetHandlingHistoryOp>().Whose(_ => !_.Concern.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Concern)).Concern),
                    },
        ...
        private static readonly ValidModelTestScenarios<GetHandlingHistoryOp> ValidModelTestScenarios = new ValidModelTestScenarios<GetHandlingHistoryOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<GetHandlingHistoryOp>
                {
                    Name = "a dummy GetHandlingHistoryOp should be valid",
                    SystemUnderTest = A.Dummy<GetHandlingHistoryOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void GetHandlingHistoryOp___Should_implement_IModel_of_GetHandlingHistoryOp___When_reflecting()
            {
                // Arrange
                var type = typeof(GetHandlingHistoryOp);

                var expectedModelMethods = typeof(IModel<GetHandlingHistoryOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GetHandlingHistoryOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void GetHandlingHistoryOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(GetHandlingHistoryOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (GetHandlingHistoryOp)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "InternalRecordId", "Concern" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (GetHandlingHistoryOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(GetHandlingHistoryOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GetHandlingHistoryOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                GetHandlingHistoryOp systemUnderTest1 = null;
                GetHandlingHistoryOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    GetHandlingHistoryOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetHandlingHistoryOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetHandlingHistoryOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetHandlingHistoryOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetHandlingHistoryOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetHandlingHistoryOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
