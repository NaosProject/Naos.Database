...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<GetHandlingStatusOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<GetHandlingStatusOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<GetHandlingStatusOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<GetHandlingStatusOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<GetHandlingStatusOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.GetHandlingStatusOp: InternalRecordId = {systemUnderTest.InternalRecordId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Concern = {systemUnderTest.Concern?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetHandlingStatusOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetHandlingStatusOp>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<GetHandlingStatusOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<GetHandlingStatusOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<GetHandlingStatusOp>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<GetHandlingStatusOp>
                        {
                            SystemUnderTest = new GetHandlingStatusOp(
                                                      referenceObject.InternalRecordId,
        ...
        private static readonly DeepCloneWithTestScenarios<GetHandlingStatusOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<GetHandlingStatusOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetHandlingStatusOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetHandlingStatusOp>().ThatIs(_ => !systemUnderTest.InternalRecordId.IsEqualTo(_.InternalRecordId));

                        var result = new SystemUnderTestDeepCloneWithValue<GetHandlingStatusOp>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetHandlingStatusOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetHandlingStatusOp>().ThatIs(_ => !systemUnderTest.Concern.IsEqualTo(_.Concern));
        ...
        private static readonly GetHandlingStatusOp ReferenceObjectForEquatableTestScenarios = A.Dummy<GetHandlingStatusOp>();

        private static readonly EquatableTestScenarios<GetHandlingStatusOp> EquatableTestScenarios = new EquatableTestScenarios<GetHandlingStatusOp>()
            .AddScenario(() =>
                new EquatableTestScenario<GetHandlingStatusOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GetHandlingStatusOp[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new GetHandlingStatusOp[]
                    {
                        new GetHandlingStatusOp(
                                A.Dummy<GetHandlingStatusOp>().Whose(_ => !_.InternalRecordId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.InternalRecordId)).InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Concern),
                        new GetHandlingStatusOp(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                A.Dummy<GetHandlingStatusOp>().Whose(_ => !_.Concern.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Concern)).Concern),
                    },
        ...
        private static readonly ValidModelTestScenarios<GetHandlingStatusOp> ValidModelTestScenarios = new ValidModelTestScenarios<GetHandlingStatusOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<GetHandlingStatusOp>
                {
                    Name = "a dummy GetHandlingStatusOp should be valid",
                    SystemUnderTest = A.Dummy<GetHandlingStatusOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void GetHandlingStatusOp___Should_implement_IModel_of_GetHandlingStatusOp___When_reflecting()
            {
                // Arrange
                var type = typeof(GetHandlingStatusOp);

                var expectedModelMethods = typeof(IModel<GetHandlingStatusOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GetHandlingStatusOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void GetHandlingStatusOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(GetHandlingStatusOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (GetHandlingStatusOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (GetHandlingStatusOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(GetHandlingStatusOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GetHandlingStatusOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                GetHandlingStatusOp systemUnderTest1 = null;
                GetHandlingStatusOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    GetHandlingStatusOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetHandlingStatusOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetHandlingStatusOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetHandlingStatusOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetHandlingStatusOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetHandlingStatusOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
