...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CompleteRunningHandleRecordOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CompleteRunningHandleRecordOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CompleteRunningHandleRecordOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CompleteRunningHandleRecordOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CompleteRunningHandleRecordOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.CompleteRunningHandleRecordOp: InternalRecordId = {systemUnderTest.InternalRecordId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Concern = {systemUnderTest.Concern?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Tags = {systemUnderTest.Tags?.ToString() ?? "<null>"}, InheritRecordTags = {systemUnderTest.InheritRecordTags.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CompleteRunningHandleRecordOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CompleteRunningHandleRecordOp>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CompleteRunningHandleRecordOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CompleteRunningHandleRecordOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CompleteRunningHandleRecordOp>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CompleteRunningHandleRecordOp>
                        {
                            SystemUnderTest = new CompleteRunningHandleRecordOp(
                                                      referenceObject.InternalRecordId,
                                                      referenceObject.Concern,
                                                      referenceObject.Details,
                                                      referenceObject.Tags,
        ...
        private static readonly DeepCloneWithTestScenarios<CompleteRunningHandleRecordOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CompleteRunningHandleRecordOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompleteRunningHandleRecordOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompleteRunningHandleRecordOp>().ThatIs(_ => !systemUnderTest.InternalRecordId.IsEqualTo(_.InternalRecordId));

                        var result = new SystemUnderTestDeepCloneWithValue<CompleteRunningHandleRecordOp>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompleteRunningHandleRecordOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompleteRunningHandleRecordOp>().ThatIs(_ => !systemUnderTest.Concern.IsEqualTo(_.Concern));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompleteRunningHandleRecordOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompleteRunningHandleRecordOp>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompleteRunningHandleRecordOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompleteRunningHandleRecordOp>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompleteRunningHandleRecordOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompleteRunningHandleRecordOp>().ThatIs(_ => !systemUnderTest.InheritRecordTags.IsEqualTo(_.InheritRecordTags));
        ...
        private static readonly CompleteRunningHandleRecordOp ReferenceObjectForEquatableTestScenarios = A.Dummy<CompleteRunningHandleRecordOp>();

        private static readonly EquatableTestScenarios<CompleteRunningHandleRecordOp> EquatableTestScenarios = new EquatableTestScenarios<CompleteRunningHandleRecordOp>()
            .AddScenario(() =>
                new EquatableTestScenario<CompleteRunningHandleRecordOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CompleteRunningHandleRecordOp[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new CompleteRunningHandleRecordOp[]
                    {
                        new CompleteRunningHandleRecordOp(
                                A.Dummy<CompleteRunningHandleRecordOp>().Whose(_ => !_.InternalRecordId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.InternalRecordId)).InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Concern,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                ReferenceObjectForEquatableTestScenarios.Tags,
                                ReferenceObjectForEquatableTestScenarios.InheritRecordTags),
                        new CompleteRunningHandleRecordOp(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                A.Dummy<CompleteRunningHandleRecordOp>().Whose(_ => !_.Concern.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Concern)).Concern,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                ReferenceObjectForEquatableTestScenarios.Tags,
                                ReferenceObjectForEquatableTestScenarios.InheritRecordTags),
                        new CompleteRunningHandleRecordOp(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Concern,
                                A.Dummy<CompleteRunningHandleRecordOp>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details,
                                ReferenceObjectForEquatableTestScenarios.Tags,
                                ReferenceObjectForEquatableTestScenarios.InheritRecordTags),
                        new CompleteRunningHandleRecordOp(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Concern,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                A.Dummy<CompleteRunningHandleRecordOp>().Whose(_ => !_.Tags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Tags)).Tags,
                                ReferenceObjectForEquatableTestScenarios.InheritRecordTags),
                        new CompleteRunningHandleRecordOp(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Concern,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                ReferenceObjectForEquatableTestScenarios.Tags,
                                A.Dummy<CompleteRunningHandleRecordOp>().Whose(_ => !_.InheritRecordTags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.InheritRecordTags)).InheritRecordTags),
                    },
        ...
        private static readonly ValidModelTestScenarios<CompleteRunningHandleRecordOp> ValidModelTestScenarios = new ValidModelTestScenarios<CompleteRunningHandleRecordOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<CompleteRunningHandleRecordOp>
                {
                    Name = "a dummy CompleteRunningHandleRecordOp should be valid",
                    SystemUnderTest = A.Dummy<CompleteRunningHandleRecordOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void CompleteRunningHandleRecordOp___Should_implement_IModel_of_CompleteRunningHandleRecordOp___When_reflecting()
            {
                // Arrange
                var type = typeof(CompleteRunningHandleRecordOp);

                var expectedModelMethods = typeof(IModel<CompleteRunningHandleRecordOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CompleteRunningHandleRecordOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CompleteRunningHandleRecordOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CompleteRunningHandleRecordOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CompleteRunningHandleRecordOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CompleteRunningHandleRecordOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CompleteRunningHandleRecordOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CompleteRunningHandleRecordOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                CompleteRunningHandleRecordOp systemUnderTest1 = null;
                CompleteRunningHandleRecordOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CompleteRunningHandleRecordOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompleteRunningHandleRecordOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompleteRunningHandleRecordOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompleteRunningHandleRecordOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompleteRunningHandleRecordOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompleteRunningHandleRecordOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
