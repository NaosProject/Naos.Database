...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<DisableHandlingForStreamOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<DisableHandlingForStreamOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<DisableHandlingForStreamOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<DisableHandlingForStreamOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<DisableHandlingForStreamOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.DisableHandlingForStreamOp: Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Tags = {systemUnderTest.Tags?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<DisableHandlingForStreamOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<DisableHandlingForStreamOp>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<DisableHandlingForStreamOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<DisableHandlingForStreamOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<DisableHandlingForStreamOp>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<DisableHandlingForStreamOp>
                        {
                            SystemUnderTest = new DisableHandlingForStreamOp(
                                                      referenceObject.Details,
                                                      referenceObject.Tags),
        ...
        private static readonly DeepCloneWithTestScenarios<DisableHandlingForStreamOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<DisableHandlingForStreamOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DisableHandlingForStreamOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DisableHandlingForStreamOp>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));

                        var result = new SystemUnderTestDeepCloneWithValue<DisableHandlingForStreamOp>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DisableHandlingForStreamOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DisableHandlingForStreamOp>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
        ...
        private static readonly DisableHandlingForStreamOp ReferenceObjectForEquatableTestScenarios = A.Dummy<DisableHandlingForStreamOp>();

        private static readonly EquatableTestScenarios<DisableHandlingForStreamOp> EquatableTestScenarios = new EquatableTestScenarios<DisableHandlingForStreamOp>()
            .AddScenario(() =>
                new EquatableTestScenario<DisableHandlingForStreamOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new DisableHandlingForStreamOp[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new DisableHandlingForStreamOp[]
                    {
                        new DisableHandlingForStreamOp(
                                A.Dummy<DisableHandlingForStreamOp>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new DisableHandlingForStreamOp(
                                ReferenceObjectForEquatableTestScenarios.Details,
                                A.Dummy<DisableHandlingForStreamOp>().Whose(_ => !_.Tags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Tags)).Tags),
                    },
        ...
        private static readonly ValidModelTestScenarios<DisableHandlingForStreamOp> ValidModelTestScenarios = new ValidModelTestScenarios<DisableHandlingForStreamOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<DisableHandlingForStreamOp>
                {
                    Name = "a dummy DisableHandlingForStreamOp should be valid",
                    SystemUnderTest = A.Dummy<DisableHandlingForStreamOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void DisableHandlingForStreamOp___Should_implement_IModel_of_DisableHandlingForStreamOp___When_reflecting()
            {
                // Arrange
                var type = typeof(DisableHandlingForStreamOp);

                var expectedModelMethods = typeof(IModel<DisableHandlingForStreamOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<DisableHandlingForStreamOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void DisableHandlingForStreamOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(DisableHandlingForStreamOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (DisableHandlingForStreamOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (DisableHandlingForStreamOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(DisableHandlingForStreamOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<DisableHandlingForStreamOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                DisableHandlingForStreamOp systemUnderTest1 = null;
                DisableHandlingForStreamOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    DisableHandlingForStreamOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DisableHandlingForStreamOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DisableHandlingForStreamOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DisableHandlingForStreamOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DisableHandlingForStreamOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DisableHandlingForStreamOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
