...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<EnableHandlingForStreamOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<EnableHandlingForStreamOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<EnableHandlingForStreamOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<EnableHandlingForStreamOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<EnableHandlingForStreamOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.EnableHandlingForStreamOp: Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Tags = {systemUnderTest.Tags?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<EnableHandlingForStreamOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<EnableHandlingForStreamOp>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<EnableHandlingForStreamOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<EnableHandlingForStreamOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<EnableHandlingForStreamOp>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<EnableHandlingForStreamOp>
                        {
                            SystemUnderTest = new EnableHandlingForStreamOp(
                                                      referenceObject.Details,
                                                      referenceObject.Tags),
        ...
        private static readonly DeepCloneWithTestScenarios<EnableHandlingForStreamOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<EnableHandlingForStreamOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<EnableHandlingForStreamOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<EnableHandlingForStreamOp>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));

                        var result = new SystemUnderTestDeepCloneWithValue<EnableHandlingForStreamOp>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<EnableHandlingForStreamOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<EnableHandlingForStreamOp>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
        ...
        private static readonly EnableHandlingForStreamOp ReferenceObjectForEquatableTestScenarios = A.Dummy<EnableHandlingForStreamOp>();

        private static readonly EquatableTestScenarios<EnableHandlingForStreamOp> EquatableTestScenarios = new EquatableTestScenarios<EnableHandlingForStreamOp>()
            .AddScenario(() =>
                new EquatableTestScenario<EnableHandlingForStreamOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new EnableHandlingForStreamOp[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new EnableHandlingForStreamOp[]
                    {
                        new EnableHandlingForStreamOp(
                                A.Dummy<EnableHandlingForStreamOp>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new EnableHandlingForStreamOp(
                                ReferenceObjectForEquatableTestScenarios.Details,
                                A.Dummy<EnableHandlingForStreamOp>().Whose(_ => !_.Tags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Tags)).Tags),
                    },
        ...
        private static readonly ValidModelTestScenarios<EnableHandlingForStreamOp> ValidModelTestScenarios = new ValidModelTestScenarios<EnableHandlingForStreamOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<EnableHandlingForStreamOp>
                {
                    Name = "a dummy EnableHandlingForStreamOp should be valid",
                    SystemUnderTest = A.Dummy<EnableHandlingForStreamOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void EnableHandlingForStreamOp___Should_implement_IModel_of_EnableHandlingForStreamOp___When_reflecting()
            {
                // Arrange
                var type = typeof(EnableHandlingForStreamOp);

                var expectedModelMethods = typeof(IModel<EnableHandlingForStreamOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<EnableHandlingForStreamOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void EnableHandlingForStreamOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(EnableHandlingForStreamOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (EnableHandlingForStreamOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (EnableHandlingForStreamOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(EnableHandlingForStreamOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<EnableHandlingForStreamOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                EnableHandlingForStreamOp systemUnderTest1 = null;
                EnableHandlingForStreamOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    EnableHandlingForStreamOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EnableHandlingForStreamOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EnableHandlingForStreamOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EnableHandlingForStreamOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EnableHandlingForStreamOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_EnableHandlingForStreamOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
