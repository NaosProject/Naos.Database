...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class ResetCompletedHandleRecordOpTest
    {
        ...
        private static readonly ValidModelTestScenarios<ResetCompletedHandleRecordOp> ValidModelTestScenarios = new ValidModelTestScenarios<ResetCompletedHandleRecordOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<ResetCompletedHandleRecordOp>
                {
                    Name = "a dummy ResetCompletedHandleRecordOp should be valid",
                    SystemUnderTest = A.Dummy<ResetCompletedHandleRecordOp>(),
                });
