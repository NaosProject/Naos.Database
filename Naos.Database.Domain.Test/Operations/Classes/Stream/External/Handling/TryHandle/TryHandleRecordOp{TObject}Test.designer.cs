...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class TryHandleRecordOpTObjectTest
    {
        ...
        private static readonly ValidModelTestScenarios<TryHandleRecordOp<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<TryHandleRecordOp<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<TryHandleRecordOp<Version>>
                {
                    Name = "a dummy TryHandleRecordOp<Version> should be valid",
                    SystemUnderTest = A.Dummy<TryHandleRecordOp<Version>>(),
                });
