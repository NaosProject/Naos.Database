...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<PruneBeforeInternalRecordIdOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<PruneBeforeInternalRecordIdOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<PruneBeforeInternalRecordIdOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<PruneBeforeInternalRecordIdOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.PruneBeforeInternalRecordIdOp: InternalRecordId = {systemUnderTest.InternalRecordId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<PruneBeforeInternalRecordIdOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<PruneBeforeInternalRecordIdOp>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PruneBeforeInternalRecordIdOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PruneBeforeInternalRecordIdOp>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
        ...
        private static readonly EquatableTestScenarios<PruneBeforeInternalRecordIdOp> EquatableTestScenarios = new EquatableTestScenarios<PruneBeforeInternalRecordIdOp>()
            .AddScenario(() =>
                new EquatableTestScenario<PruneBeforeInternalRecordIdOp>
                {
                    Name = "Default Code Generated Scenario",
        ...
        private static readonly ValidModelTestScenarios<PruneBeforeInternalRecordIdOp> ValidModelTestScenarios = new ValidModelTestScenarios<PruneBeforeInternalRecordIdOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<PruneBeforeInternalRecordIdOp>
                {
                    Name = "a dummy PruneBeforeInternalRecordIdOp should be valid",
                    SystemUnderTest = A.Dummy<PruneBeforeInternalRecordIdOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void PruneBeforeInternalRecordIdOp___Should_implement_IModel_of_PruneBeforeInternalRecordIdOp___When_reflecting()
            {
                // Arrange
                var type = typeof(PruneBeforeInternalRecordIdOp);

                var expectedModelMethods = typeof(IModel<PruneBeforeInternalRecordIdOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<PruneBeforeInternalRecordIdOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void PruneBeforeInternalRecordIdOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(PruneBeforeInternalRecordIdOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (PruneBeforeInternalRecordIdOp)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "InternalRecordId", "Details" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (PruneBeforeInternalRecordIdOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(PruneBeforeInternalRecordIdOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<PruneBeforeInternalRecordIdOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                PruneBeforeInternalRecordIdOp systemUnderTest1 = null;
                PruneBeforeInternalRecordIdOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    PruneBeforeInternalRecordIdOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneBeforeInternalRecordIdOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneBeforeInternalRecordIdOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneBeforeInternalRecordIdOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneBeforeInternalRecordIdOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneBeforeInternalRecordIdOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
