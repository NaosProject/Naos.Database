...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ReleaseMutexOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ReleaseMutexOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ReleaseMutexOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ReleaseMutexOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<ReleaseMutexOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.ReleaseMutexOp: WaitOneOp = {systemUnderTest.WaitOneOp?.ToString() ?? "<null>"}, InternalRecordId = {systemUnderTest.InternalRecordId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ReleaseMutexOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ReleaseMutexOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ReleaseMutexOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'waitOneOp' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ReleaseMutexOp>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "waitOneOp", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<ReleaseMutexOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ReleaseMutexOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ReleaseMutexOp>
                {
                    Name = "WaitOneOp should return same 'waitOneOp' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ReleaseMutexOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<ReleaseMutexOp>
                        {
                            SystemUnderTest = new ReleaseMutexOp(
                                                      referenceObject.WaitOneOp,
                                                      referenceObject.InternalRecordId),
                            ExpectedPropertyValue = referenceObject.WaitOneOp,
                        };

                        return result;
                    },
                    PropertyName = "WaitOneOp",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ReleaseMutexOp>
                {
        ...
        private static readonly DeepCloneWithTestScenarios<ReleaseMutexOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ReleaseMutexOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ReleaseMutexOp>
                {
                    Name = "DeepCloneWithWaitOneOp should deep clone object and replace WaitOneOp with the provided waitOneOp",
                    WithPropertyName = "WaitOneOp",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ReleaseMutexOp>();

                        var referenceObject = A.Dummy<ReleaseMutexOp>().ThatIs(_ => !systemUnderTest.WaitOneOp.IsEqualTo(_.WaitOneOp));

                        var result = new SystemUnderTestDeepCloneWithValue<ReleaseMutexOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.WaitOneOp,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ReleaseMutexOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ReleaseMutexOp>().ThatIs(_ => !systemUnderTest.InternalRecordId.IsEqualTo(_.InternalRecordId));
        ...
        private static readonly ReleaseMutexOp ReferenceObjectForEquatableTestScenarios = A.Dummy<ReleaseMutexOp>();

        private static readonly EquatableTestScenarios<ReleaseMutexOp> EquatableTestScenarios = new EquatableTestScenarios<ReleaseMutexOp>()
            .AddScenario(() =>
                new EquatableTestScenario<ReleaseMutexOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ReleaseMutexOp[]
                    {
                        new ReleaseMutexOp(
                                ReferenceObjectForEquatableTestScenarios.WaitOneOp,
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ReleaseMutexOp[]
                    {
                        new ReleaseMutexOp(
                                A.Dummy<ReleaseMutexOp>().Whose(_ => !_.WaitOneOp.IsEqualTo(ReferenceObjectForEquatableTestScenarios.WaitOneOp)).WaitOneOp,
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId),
                        new ReleaseMutexOp(
                                ReferenceObjectForEquatableTestScenarios.WaitOneOp,
                                A.Dummy<ReleaseMutexOp>().Whose(_ => !_.InternalRecordId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.InternalRecordId)).InternalRecordId),
                    },
        ...
        private static readonly ValidModelTestScenarios<ReleaseMutexOp> ValidModelTestScenarios = new ValidModelTestScenarios<ReleaseMutexOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<ReleaseMutexOp>
                {
                    Name = "a dummy ReleaseMutexOp should be valid",
                    SystemUnderTest = A.Dummy<ReleaseMutexOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void ReleaseMutexOp___Should_implement_IModel_of_ReleaseMutexOp___When_reflecting()
            {
                // Arrange
                var type = typeof(ReleaseMutexOp);

                var expectedModelMethods = typeof(IModel<ReleaseMutexOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ReleaseMutexOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ReleaseMutexOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ReleaseMutexOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ReleaseMutexOp)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.WaitOneOp == null)
                {
                    actual.WaitOneOp.AsTest().Must().BeNull();
                }
                else if (!actual.WaitOneOp.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.WaitOneOp.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.WaitOneOp);
                }
            }
            ...
            {
                var propertyNames = new string[] { "WaitOneOp", "InternalRecordId" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ReleaseMutexOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ReleaseMutexOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ReleaseMutexOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ReleaseMutexOp systemUnderTest1 = null;
                ReleaseMutexOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ReleaseMutexOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReleaseMutexOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReleaseMutexOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReleaseMutexOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReleaseMutexOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReleaseMutexOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
