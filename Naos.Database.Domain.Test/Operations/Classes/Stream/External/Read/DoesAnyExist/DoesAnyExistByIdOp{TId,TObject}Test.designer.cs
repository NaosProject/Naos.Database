...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class DoesAnyExistByIdOpTIdTObjectTest
    {
                ...
                new StringRepresentationTestScenario<DoesAnyExistByIdOp<Version, Version>>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<DoesAnyExistByIdOp<Version, Version>>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.DoesAnyExistByIdOp<Version, Version>: Id = {systemUnderTest.Id?.ToString() ?? "<null>"}, VersionMatchStrategy = {systemUnderTest.VersionMatchStrategy.ToString() ?? "<null>"}, TagsToMatch = {systemUnderTest.TagsToMatch?.ToString() ?? "<null>"}, TagMatchStrategy = {systemUnderTest.TagMatchStrategy.ToString() ?? "<null>"}, DeprecatedIdTypes = {systemUnderTest.DeprecatedIdTypes?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ValidModelTestScenarios<DoesAnyExistByIdOp<Version, Version>> ValidModelTestScenarios = new ValidModelTestScenarios<DoesAnyExistByIdOp<Version, Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<DoesAnyExistByIdOp<Version, Version>>
                {
                    Name = "a dummy DoesAnyExistByIdOp<Version, Version> should be valid",
                    SystemUnderTest = A.Dummy<DoesAnyExistByIdOp<Version, Version>>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            {
                var propertyNames = new string[] { "Id", "VersionMatchStrategy", "TagsToMatch", "TagMatchStrategy", "DeprecatedIdTypes" };
