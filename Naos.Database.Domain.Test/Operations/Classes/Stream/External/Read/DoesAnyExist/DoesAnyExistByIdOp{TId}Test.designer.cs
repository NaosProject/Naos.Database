...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class DoesAnyExistByIdOpTIdTest
    {
        ...
        private static readonly ValidModelTestScenarios<DoesAnyExistByIdOp<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<DoesAnyExistByIdOp<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<DoesAnyExistByIdOp<Version>>
                {
                    Name = "a dummy DoesAnyExistByIdOp<Version> should be valid",
                    SystemUnderTest = A.Dummy<DoesAnyExistByIdOp<Version>>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            {
                var propertyNames = new string[] { "Id", "ObjectType", "VersionMatchStrategy", "TagsToMatch", "TagMatchStrategy", "DeprecatedIdTypes" };
