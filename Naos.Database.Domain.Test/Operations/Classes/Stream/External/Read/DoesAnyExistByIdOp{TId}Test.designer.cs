...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class DoesAnyExistByIdOpTIdTest
    {
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Id", "ObjectType", "VersionMatchStrategy", "DeprecatedIdTypes" };
