...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class GetAllObjectsByIdOpTIdTObjectTest
    {
        ...
        private static readonly ValidModelTestScenarios<GetAllObjectsByIdOp<Version, Version>> ValidModelTestScenarios = new ValidModelTestScenarios<GetAllObjectsByIdOp<Version, Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<GetAllObjectsByIdOp<Version, Version>>
                {
                    Name = "a dummy GetAllObjectsByIdOp<Version, Version> should be valid",
                    SystemUnderTest = A.Dummy<GetAllObjectsByIdOp<Version, Version>>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            {
                var propertyNames = new string[] { "Id", "VersionMatchStrategy", "TagsToMatch", "TagMatchStrategy", "RecordNotFoundStrategy", "OrderRecordsBy", "DeprecatedIdTypes" };
