...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<GetAllObjectsOp<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<GetAllObjectsOp<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<GetAllObjectsOp<Version>>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetAllObjectsOp<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetAllObjectsOp<Version>>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<GetAllObjectsOp<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<GetAllObjectsOp<Version>>()
            .AddScenario(() =>
        ...
        private static readonly DeepCloneWithTestScenarios<GetAllObjectsOp<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<GetAllObjectsOp<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetAllObjectsOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetAllObjectsOp<Version>>().ThatIs(_ => !systemUnderTest.IdentifierType.IsEqualTo(_.IdentifierType));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetAllObjectsOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetAllObjectsOp<Version>>().ThatIs(_ => !systemUnderTest.VersionMatchStrategy.IsEqualTo(_.VersionMatchStrategy));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetAllObjectsOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetAllObjectsOp<Version>>().ThatIs(_ => !systemUnderTest.RecordNotFoundStrategy.IsEqualTo(_.RecordNotFoundStrategy));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetAllObjectsOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetAllObjectsOp<Version>>().ThatIs(_ => !systemUnderTest.OrderRecordsBy.IsEqualTo(_.OrderRecordsBy));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetAllObjectsOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetAllObjectsOp<Version>>().ThatIs(_ => !systemUnderTest.DeprecatedIdTypes.IsEqualTo(_.DeprecatedIdTypes));
        ...
        private static readonly GetAllObjectsOp<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<GetAllObjectsOp<Version>>();

        private static readonly EquatableTestScenarios<GetAllObjectsOp<Version>> EquatableTestScenarios = new EquatableTestScenarios<GetAllObjectsOp<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<GetAllObjectsOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GetAllObjectsOp<Version>[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new GetAllObjectsOp<Version>[]
                    {
                        new GetAllObjectsOp<Version>(
        ...
        private static readonly ValidModelTestScenarios<GetAllObjectsOp<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<GetAllObjectsOp<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<GetAllObjectsOp<Version>>
                {
                    Name = "a dummy GetAllObjectsOp<Version> should be valid",
                    SystemUnderTest = A.Dummy<GetAllObjectsOp<Version>>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void GetAllObjectsOp_of_Version___Should_implement_IModel_of_GetAllObjectsOp_of_Version___When_reflecting()
            {
                // Arrange
                var type = typeof(GetAllObjectsOp<Version>);

                var expectedModelMethods = typeof(IModel<GetAllObjectsOp<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GetAllObjectsOp<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void GetAllObjectsOp_of_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(GetAllObjectsOp<Version>);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (GetAllObjectsOp<Version>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (GetAllObjectsOp<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(GetAllObjectsOp<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GetAllObjectsOp<Version>>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                GetAllObjectsOp<Version> systemUnderTest1 = null;
                GetAllObjectsOp<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    GetAllObjectsOp<Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAllObjectsOp_of_Version___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAllObjectsOp_of_Version___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAllObjectsOp_of_Version___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAllObjectsOp_of_Version___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAllObjectsOp_of_Version___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
