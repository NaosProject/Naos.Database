...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class GetAllRecordsByIdOpTIdTest
    {
        ...
        private static readonly ValidModelTestScenarios<GetAllRecordsByIdOp<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<GetAllRecordsByIdOp<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<GetAllRecordsByIdOp<Version>>
                {
                    Name = "a dummy GetAllRecordsByIdOp<Version> should be valid",
                    SystemUnderTest = A.Dummy<GetAllRecordsByIdOp<Version>>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            {
                var propertyNames = new string[] { "Id", "ObjectType", "VersionMatchStrategy", "TagsToMatch", "TagMatchStrategy", "RecordNotFoundStrategy", "OrderRecordsBy", "DeprecatedIdTypes" };
