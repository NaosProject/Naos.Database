...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class GetLatestObjectsByIdOpTIdTObjectTest
    {
        ...
        private static readonly ValidModelTestScenarios<GetLatestObjectsByIdOp<Version, Version>> ValidModelTestScenarios = new ValidModelTestScenarios<GetLatestObjectsByIdOp<Version, Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<GetLatestObjectsByIdOp<Version, Version>>
                {
                    Name = "a dummy GetLatestObjectsByIdOp<Version, Version> should be valid",
                    SystemUnderTest = A.Dummy<GetLatestObjectsByIdOp<Version, Version>>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            {
                var propertyNames = new string[] { "Ids", "VersionMatchStrategy", "TagsToMatch", "TagMatchStrategy", "RecordNotFoundStrategy", "OrderRecordsBy", "DeprecatedIdTypes" };
