...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class GetLatestRecordByIdOpTIdTObjectTest
    {
        ...
        private static readonly ValidModelTestScenarios<GetLatestRecordByIdOp<Version, Version>> ValidModelTestScenarios = new ValidModelTestScenarios<GetLatestRecordByIdOp<Version, Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<GetLatestRecordByIdOp<Version, Version>>
                {
                    Name = "a dummy GetLatestRecordByIdOp<Version, Version> should be valid",
                    SystemUnderTest = A.Dummy<GetLatestRecordByIdOp<Version, Version>>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            {
                var propertyNames = new string[] { "Id", "VersionMatchStrategy", "TagsToMatch", "TagMatchStrategy", "RecordNotFoundStrategy", "DeprecatedIdTypes" };
