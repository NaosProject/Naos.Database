...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class GetLatestRecordMetadataByIdOpTIdTest
    {
                ...
                new StringRepresentationTestScenario<GetLatestRecordMetadataByIdOp<Version>>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<GetLatestRecordMetadataByIdOp<Version>>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.GetLatestRecordMetadataByIdOp<Version>: Id = {systemUnderTest.Id?.ToString() ?? "<null>"}, ObjectType = {systemUnderTest.ObjectType?.ToString() ?? "<null>"}, VersionMatchStrategy = {systemUnderTest.VersionMatchStrategy.ToString() ?? "<null>"}, TagsToMatch = {systemUnderTest.TagsToMatch?.ToString() ?? "<null>"}, TagMatchStrategy = {systemUnderTest.TagMatchStrategy.ToString() ?? "<null>"}, RecordNotFoundStrategy = {systemUnderTest.RecordNotFoundStrategy.ToString() ?? "<null>"}, DeprecatedIdTypes = {systemUnderTest.DeprecatedIdTypes?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ValidModelTestScenarios<GetLatestRecordMetadataByIdOp<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<GetLatestRecordMetadataByIdOp<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<GetLatestRecordMetadataByIdOp<Version>>
                {
                    Name = "a dummy GetLatestRecordMetadataByIdOp<Version> should be valid",
                    SystemUnderTest = A.Dummy<GetLatestRecordMetadataByIdOp<Version>>(),
                });
        ...
        public static class CloningTesting
        {
            ...
            {
                var propertyNames = new string[] { "Id", "ObjectType", "VersionMatchStrategy", "TagsToMatch", "TagMatchStrategy", "RecordNotFoundStrategy", "DeprecatedIdTypes" };
