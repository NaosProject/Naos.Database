...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class GetNextUniqueLongOpTest
    {
        ...
        private static readonly ValidModelTestScenarios<GetNextUniqueLongOp> ValidModelTestScenarios = new ValidModelTestScenarios<GetNextUniqueLongOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<GetNextUniqueLongOp>
                {
                    Name = "a dummy GetNextUniqueLongOp should be valid",
                    SystemUnderTest = A.Dummy<GetNextUniqueLongOp>(),
                });
