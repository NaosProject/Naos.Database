...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class PutAndReturnInternalRecordIdOpTObjectTest
    {
                ...
                new EquatableTestScenario<PutAndReturnInternalRecordIdOp<Version>>
                {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new PutAndReturnInternalRecordIdOp<Version>[]
                    {
                        ...
                        new PutAndReturnInternalRecordIdOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.ObjectToPut,
                                ReferenceObjectForEquatableTestScenarios.Tags,
                                A.Dummy<PutAndReturnInternalRecordIdOp<Version>>().Whose(_ => !_.ExistingRecordStrategy.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ExistingRecordStrategy)).ExistingRecordStrategy,
                                ReferenceObjectForEquatableTestScenarios.RecordRetentionCount,
                                ReferenceObjectForEquatableTestScenarios.VersionMatchStrategy,
                                ReferenceObjectForEquatableTestScenarios.TypeSelectionStrategy),
                        new PutAndReturnInternalRecordIdOp<Version>(
                        ...
                        new PutAndReturnInternalRecordIdOp<Version>(
                                ...
                                ReferenceObjectForEquatableTestScenarios.RecordRetentionCount,
                                ReferenceObjectForEquatableTestScenarios.VersionMatchStrategy,
                                A.Dummy<PutAndReturnInternalRecordIdOp<Version>>().Whose(_ => !_.TypeSelectionStrategy.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TypeSelectionStrategy)).TypeSelectionStrategy),
                    },
        ...
        private static readonly ValidModelTestScenarios<PutAndReturnInternalRecordIdOp<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<PutAndReturnInternalRecordIdOp<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<PutAndReturnInternalRecordIdOp<Version>>
                {
                    Name = "a dummy PutAndReturnInternalRecordIdOp<Version> should be valid",
                    SystemUnderTest = A.Dummy<PutAndReturnInternalRecordIdOp<Version>>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void PutAndReturnInternalRecordIdOp_of_Version___Should_implement_IModel_of_PutAndReturnInternalRecordIdOp_of_Version___When_reflecting()
            {
                // Arrange
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void PutAndReturnInternalRecordIdOp_of_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(PutAndReturnInternalRecordIdOp<Version>);
        ...
        public static class EqualityTesting
        {
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PutAndReturnInternalRecordIdOp_of_Version___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PutAndReturnInternalRecordIdOp_of_Version___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PutAndReturnInternalRecordIdOp_of_Version___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PutAndReturnInternalRecordIdOp_of_Version___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PutAndReturnInternalRecordIdOp_of_Version___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
