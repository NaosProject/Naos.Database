    ...
    public static partial class PutWithIdOpTIdTObjectTest
    {
        ...
        static PutWithIdOpTIdTObjectTest()
        {
            ...
            EquatableTestScenarios
                .RemoveAllScenarios()
                .AddScenario(() =>
                    new EquatableTestScenario<PutWithIdOp<Version, Version>>
                    {
                        ...
                        {
                            new PutWithIdOp<Version, Version>(
                                    A.Dummy<PutWithIdOp<Version, Version>>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                    ReferenceObjectForEquatableTestScenarios.ObjectToPut,
                                    ReferenceObjectForEquatableTestScenarios.Tags,
                                    ReferenceObjectForEquatableTestScenarios.ExistingRecordStrategy,
                                    ReferenceObjectForEquatableTestScenarios.RecordRetentionCount,
                            ...
                            new PutWithIdOp<Version, Version>(
                                    ReferenceObjectForEquatableTestScenarios.Id,
                                    A.Dummy<PutWithIdOp<Version, Version>>().Whose(_ => !_.ObjectToPut.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ObjectToPut)).ObjectToPut,
                                    ReferenceObjectForEquatableTestScenarios.Tags,
                                    ReferenceObjectForEquatableTestScenarios.ExistingRecordStrategy,
                                    ReferenceObjectForEquatableTestScenarios.RecordRetentionCount,
                                    ReferenceObjectForEquatableTestScenarios.VersionMatchStrategy),
                            new PutWithIdOp<Version, Version>(
                                    ReferenceObjectForEquatableTestScenarios.Id,
                                    ReferenceObjectForEquatableTestScenarios.ObjectToPut,
                                    A.Dummy<PutWithIdOp<Version, Version>>().Whose(_ => !_.Tags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Tags)).Tags,
                                    ReferenceObjectForEquatableTestScenarios.ExistingRecordStrategy,
                                    ReferenceObjectForEquatableTestScenarios.RecordRetentionCount,
                                    ReferenceObjectForEquatableTestScenarios.VersionMatchStrategy),
                            new PutWithIdOp<Version, Version>(
                            ...
                            ////        ReferenceObjectForEquatableTestScenarios.Tags,
                            ////        ReferenceObjectForEquatableTestScenarios.ExistingRecordStrategy,
                            ////        A.Dummy<PutWithIdOp<Version, Version>>().Whose(_ => !_.RecordRetentionCount.IsEqualTo(ReferenceObjectForEquatableTestScenarios.RecordRetentionCount)).RecordRetentionCount,
                            ////        ReferenceObjectForEquatableTestScenarios.VersionMatchStrategy),
                            new PutWithIdOp<Version, Version>(
                                    ReferenceObjectForEquatableTestScenarios.Id,
                                    ReferenceObjectForEquatableTestScenarios.ObjectToPut,
                                    ...
                                    ReferenceObjectForEquatableTestScenarios.ExistingRecordStrategy,
                                    ReferenceObjectForEquatableTestScenarios.RecordRetentionCount,
                                    A.Dummy<PutWithIdOp<Version, Version>>().Whose(_ => !_.VersionMatchStrategy.IsEqualTo(ReferenceObjectForEquatableTestScenarios.VersionMatchStrategy)).VersionMatchStrategy),
                        },
            ...
            DeepCloneWithTestScenarios
                .RemoveAllScenarios()
                .AddScenario(DeepCloneWithTestScenario<PutWithIdOp<Version, Version>>.ForceGeneratedTestsToPassAndWriteMyOwnScenario);
        }
    }
}