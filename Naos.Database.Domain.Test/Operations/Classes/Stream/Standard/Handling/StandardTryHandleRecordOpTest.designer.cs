...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<StandardTryHandleRecordOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<StandardTryHandleRecordOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<StandardTryHandleRecordOp>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<StandardTryHandleRecordOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<StandardTryHandleRecordOp>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<StandardTryHandleRecordOp>
                {
                    Name = "constructor should throw ArgumentOutOfRangeException when parameter 'streamRecordItemsToInclude' is StreamRecordItemsToInclude.Unknown",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<StandardTryHandleRecordOp>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<StandardTryHandleRecordOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<StandardTryHandleRecordOp>()
            .AddScenario(() =>
        ...
        private static readonly DeepCloneWithTestScenarios<StandardTryHandleRecordOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<StandardTryHandleRecordOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardTryHandleRecordOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardTryHandleRecordOp>().ThatIs(_ => !systemUnderTest.Concern.IsEqualTo(_.Concern));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardTryHandleRecordOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardTryHandleRecordOp>().ThatIs(_ => !systemUnderTest.RecordFilter.IsEqualTo(_.RecordFilter));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardTryHandleRecordOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardTryHandleRecordOp>().ThatIs(_ => !systemUnderTest.OrderRecordsBy.IsEqualTo(_.OrderRecordsBy));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardTryHandleRecordOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardTryHandleRecordOp>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardTryHandleRecordOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardTryHandleRecordOp>().ThatIs(_ => !systemUnderTest.MinimumInternalRecordId.IsEqualTo(_.MinimumInternalRecordId));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardTryHandleRecordOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardTryHandleRecordOp>().ThatIs(_ => !systemUnderTest.InheritRecordTags.IsEqualTo(_.InheritRecordTags));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardTryHandleRecordOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardTryHandleRecordOp>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
        ...
        private static readonly EquatableTestScenarios<StandardTryHandleRecordOp> EquatableTestScenarios = new EquatableTestScenarios<StandardTryHandleRecordOp>()
            .AddScenario(() =>
                new EquatableTestScenario<StandardTryHandleRecordOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new StandardTryHandleRecordOp[]
                    {
                    ...
                    {
                        new StandardTryHandleRecordOp(
                                A.Dummy<StandardTryHandleRecordOp>().Whose(_ => !_.Concern.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Concern)).Concern,
                                ReferenceObjectForEquatableTestScenarios.RecordFilter,
                                ReferenceObjectForEquatableTestScenarios.OrderRecordsBy,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                ReferenceObjectForEquatableTestScenarios.MinimumInternalRecordId,
                        ...
                        new StandardTryHandleRecordOp(
                                ReferenceObjectForEquatableTestScenarios.Concern,
                                A.Dummy<StandardTryHandleRecordOp>().Whose(_ => !_.RecordFilter.IsEqualTo(ReferenceObjectForEquatableTestScenarios.RecordFilter)).RecordFilter,
                                ReferenceObjectForEquatableTestScenarios.OrderRecordsBy,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                ReferenceObjectForEquatableTestScenarios.MinimumInternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.InheritRecordTags,
        ...
        private static readonly ValidModelTestScenarios<StandardTryHandleRecordOp> ValidModelTestScenarios = new ValidModelTestScenarios<StandardTryHandleRecordOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<StandardTryHandleRecordOp>
                {
                    Name = "a dummy StandardTryHandleRecordOp should be valid",
                    SystemUnderTest = A.Dummy<StandardTryHandleRecordOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void StandardTryHandleRecordOp___Should_implement_IModel_of_StandardTryHandleRecordOp___When_reflecting()
            {
                // Arrange
                var type = typeof(StandardTryHandleRecordOp);

                var expectedModelMethods = typeof(IModel<StandardTryHandleRecordOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<StandardTryHandleRecordOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void StandardTryHandleRecordOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(StandardTryHandleRecordOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (StandardTryHandleRecordOp)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Concern", "RecordFilter", "OrderRecordsBy", "Details", "MinimumInternalRecordId", "InheritRecordTags", "Tags", "StreamRecordItemsToInclude", "SpecifiedResourceLocator" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (StandardTryHandleRecordOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(StandardTryHandleRecordOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<StandardTryHandleRecordOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                StandardTryHandleRecordOp systemUnderTest1 = null;
                StandardTryHandleRecordOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    StandardTryHandleRecordOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_TryHandleRecordResult___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    ReturningOperationBase<TryHandleRecordResult> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<TryHandleRecordResult>)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_TryHandleRecordResult___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<TryHandleRecordResult>)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_TryHandleRecordResult___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<TryHandleRecordResult>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_TryHandleRecordResult___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<TryHandleRecordResult>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_TryHandleRecordResult___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<TryHandleRecordResult>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardTryHandleRecordOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardTryHandleRecordOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardTryHandleRecordOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardTryHandleRecordOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardTryHandleRecordOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
