...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class StandardUpdateHandlingStatusForRecordOpTest
    {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<StandardUpdateHandlingStatusForRecordOp>
                        {
                            SystemUnderTest = new StandardUpdateHandlingStatusForRecordOp(
                                                      ...
                                                      referenceObject.InheritRecordTags,
                                                      referenceObject.SpecifiedResourceLocator),
                            ExpectedPropertyValue = referenceObject.AcceptableCurrentStatuses,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardUpdateHandlingStatusForRecordOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardUpdateHandlingStatusForRecordOp>().ThatIs(_ => !systemUnderTest.InheritRecordTags.IsEqualTo(_.InheritRecordTags));
                ...
                new EquatableTestScenario<StandardUpdateHandlingStatusForRecordOp>
                {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new StandardUpdateHandlingStatusForRecordOp[]
                    {
                        ...
                        new StandardUpdateHandlingStatusForRecordOp(
                                ...
                                ReferenceObjectForEquatableTestScenarios.Details,
                                ReferenceObjectForEquatableTestScenarios.Tags,
                                A.Dummy<StandardUpdateHandlingStatusForRecordOp>().Whose(_ => !_.InheritRecordTags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.InheritRecordTags)).InheritRecordTags,
                                ReferenceObjectForEquatableTestScenarios.SpecifiedResourceLocator),
                        new StandardUpdateHandlingStatusForRecordOp(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordId,
                                ReferenceObjectForEquatableTestScenarios.Concern,
        ...
        private static readonly ValidModelTestScenarios<StandardUpdateHandlingStatusForRecordOp> ValidModelTestScenarios = new ValidModelTestScenarios<StandardUpdateHandlingStatusForRecordOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<StandardUpdateHandlingStatusForRecordOp>
                {
                    Name = "a dummy StandardUpdateHandlingStatusForRecordOp should be valid",
                    SystemUnderTest = A.Dummy<StandardUpdateHandlingStatusForRecordOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void StandardUpdateHandlingStatusForRecordOp___Should_implement_IModel_of_StandardUpdateHandlingStatusForRecordOp___When_reflecting()
            {
                // Arrange
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void StandardUpdateHandlingStatusForRecordOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(StandardUpdateHandlingStatusForRecordOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.AcceptableCurrentStatuses == null)
                {
                    actual.AcceptableCurrentStatuses.AsTest().Must().BeNull();
                }
                else if (!actual.AcceptableCurrentStatuses.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.AcceptableCurrentStatuses.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.AcceptableCurrentStatuses);
                }
            ...
            {
                var propertyNames = new string[] { "InternalRecordId", "Concern", "NewStatus", "AcceptableCurrentStatuses", "Details", "Tags", "InheritRecordTags", "SpecifiedResourceLocator" };
        ...
        public static class EqualityTesting
        {
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardUpdateHandlingStatusForRecordOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardUpdateHandlingStatusForRecordOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardUpdateHandlingStatusForRecordOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardUpdateHandlingStatusForRecordOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardUpdateHandlingStatusForRecordOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
