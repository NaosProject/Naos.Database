...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class StandardUpdateHandlingStatusForStreamOpTest
    {
        ...
        private static readonly ValidModelTestScenarios<StandardUpdateHandlingStatusForStreamOp> ValidModelTestScenarios = new ValidModelTestScenarios<StandardUpdateHandlingStatusForStreamOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<StandardUpdateHandlingStatusForStreamOp>
                {
                    Name = "a dummy StandardUpdateHandlingStatusForStreamOp should be valid",
                    SystemUnderTest = A.Dummy<StandardUpdateHandlingStatusForStreamOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void StandardUpdateHandlingStatusForStreamOp___Should_implement_IModel_of_StandardUpdateHandlingStatusForStreamOp___When_reflecting()
            {
                // Arrange
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void StandardUpdateHandlingStatusForStreamOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(StandardUpdateHandlingStatusForStreamOp);
        ...
        public static class EqualityTesting
        {
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardUpdateHandlingStatusForStreamOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardUpdateHandlingStatusForStreamOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardUpdateHandlingStatusForStreamOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardUpdateHandlingStatusForStreamOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardUpdateHandlingStatusForStreamOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
