    ...
    public static partial class StandardDeleteStreamOpTest
    {
                ...
                new StringRepresentationTestScenario<StandardDeleteStreamOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<StandardDeleteStreamOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.StandardDeleteStreamOp: StreamRepresentation = {systemUnderTest.StreamRepresentation?.ToString() ?? "<null>"}, StreamNotFoundStrategy = {systemUnderTest.StreamNotFoundStrategy.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<StandardDeleteStreamOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<StandardDeleteStreamOp>()
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<StandardDeleteStreamOp>
                {
                    Name = "constructor should throw ArgumentOutOfRangeException when parameter 'streamNotFoundStrategy' is StreamNotFoundStrategy.Unknown",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<StandardDeleteStreamOp>();
        ...
        private static readonly ValidModelTestScenarios<StandardDeleteStreamOp> ValidModelTestScenarios = new ValidModelTestScenarios<StandardDeleteStreamOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<StandardDeleteStreamOp>
                {
                    Name = "a dummy StandardDeleteStreamOp should be valid",
                    SystemUnderTest = A.Dummy<StandardDeleteStreamOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void StandardDeleteStreamOp___Should_implement_IModel_of_StandardDeleteStreamOp___When_reflecting()
            {
                // Arrange
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void StandardDeleteStreamOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(StandardDeleteStreamOp);
        ...
        public static class CloningTesting
        {
            ...
            {
                var propertyNames = new string[] { "StreamRepresentation", "StreamNotFoundStrategy" };
        ...
        public static class EqualityTesting
        {
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardDeleteStreamOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardDeleteStreamOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardDeleteStreamOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardDeleteStreamOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardDeleteStreamOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
