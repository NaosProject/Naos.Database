...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<StandardPruneStreamOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<StandardPruneStreamOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<StandardPruneStreamOp>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<StandardPruneStreamOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<StandardPruneStreamOp>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<StandardPruneStreamOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<StandardPruneStreamOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<StandardPruneStreamOp>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<StandardPruneStreamOp>
                        {
        ...
        private static readonly DeepCloneWithTestScenarios<StandardPruneStreamOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<StandardPruneStreamOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardPruneStreamOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardPruneStreamOp>().ThatIs(_ => !systemUnderTest.InternalRecordId.IsEqualTo(_.InternalRecordId));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardPruneStreamOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardPruneStreamOp>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardPruneStreamOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardPruneStreamOp>().ThatIs(_ => !systemUnderTest.SpecifiedResourceLocator.IsEqualTo(_.SpecifiedResourceLocator));
        ...
        private static readonly StandardPruneStreamOp ReferenceObjectForEquatableTestScenarios = A.Dummy<StandardPruneStreamOp>();

        private static readonly EquatableTestScenarios<StandardPruneStreamOp> EquatableTestScenarios = new EquatableTestScenarios<StandardPruneStreamOp>()
            .AddScenario(() =>
                new EquatableTestScenario<StandardPruneStreamOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new StandardPruneStreamOp[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new StandardPruneStreamOp[]
                    {
                        new StandardPruneStreamOp(
        ...
        private static readonly ValidModelTestScenarios<StandardPruneStreamOp> ValidModelTestScenarios = new ValidModelTestScenarios<StandardPruneStreamOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<StandardPruneStreamOp>
                {
                    Name = "a dummy StandardPruneStreamOp should be valid",
                    SystemUnderTest = A.Dummy<StandardPruneStreamOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void StandardPruneStreamOp___Should_implement_IModel_of_StandardPruneStreamOp___When_reflecting()
            {
                // Arrange
                var type = typeof(StandardPruneStreamOp);

                var expectedModelMethods = typeof(IModel<StandardPruneStreamOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<StandardPruneStreamOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void StandardPruneStreamOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(StandardPruneStreamOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (StandardPruneStreamOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (StandardPruneStreamOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(StandardPruneStreamOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<StandardPruneStreamOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                StandardPruneStreamOp systemUnderTest1 = null;
                StandardPruneStreamOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    StandardPruneStreamOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardPruneStreamOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardPruneStreamOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardPruneStreamOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardPruneStreamOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardPruneStreamOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
