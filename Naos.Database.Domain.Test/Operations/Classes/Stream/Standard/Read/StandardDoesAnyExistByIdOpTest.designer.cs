...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<StandardDoesAnyExistByIdOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<StandardDoesAnyExistByIdOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<StandardDoesAnyExistByIdOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<StandardDoesAnyExistByIdOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<StandardDoesAnyExistByIdOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.StandardDoesAnyExistByIdOp: StringSerializedId = {systemUnderTest.StringSerializedId?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, IdentifierType = {systemUnderTest.IdentifierType?.ToString() ?? "<null>"}, ObjectType = {systemUnderTest.ObjectType?.ToString() ?? "<null>"}, VersionMatchStrategy = {systemUnderTest.VersionMatchStrategy.ToString() ?? "<null>"}, SpecifiedResourceLocator = {systemUnderTest.SpecifiedResourceLocator?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<StandardDoesAnyExistByIdOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<StandardDoesAnyExistByIdOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<StandardDoesAnyExistByIdOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'stringSerializedId' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<StandardDoesAnyExistByIdOp>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<StandardDoesAnyExistByIdOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<StandardDoesAnyExistByIdOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<StandardDoesAnyExistByIdOp>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<StandardDoesAnyExistByIdOp>
                        {
                            SystemUnderTest = new StandardDoesAnyExistByIdOp(
                                                      referenceObject.StringSerializedId,
                                                      referenceObject.IdentifierType,
                                                      referenceObject.ObjectType,
                                                      referenceObject.VersionMatchStrategy,
        ...
        private static readonly DeepCloneWithTestScenarios<StandardDoesAnyExistByIdOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<StandardDoesAnyExistByIdOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardDoesAnyExistByIdOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardDoesAnyExistByIdOp>().ThatIs(_ => !systemUnderTest.StringSerializedId.IsEqualTo(_.StringSerializedId));

                        var result = new SystemUnderTestDeepCloneWithValue<StandardDoesAnyExistByIdOp>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardDoesAnyExistByIdOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardDoesAnyExistByIdOp>().ThatIs(_ => !systemUnderTest.IdentifierType.IsEqualTo(_.IdentifierType));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardDoesAnyExistByIdOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardDoesAnyExistByIdOp>().ThatIs(_ => !systemUnderTest.ObjectType.IsEqualTo(_.ObjectType));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardDoesAnyExistByIdOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardDoesAnyExistByIdOp>().ThatIs(_ => !systemUnderTest.VersionMatchStrategy.IsEqualTo(_.VersionMatchStrategy));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardDoesAnyExistByIdOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardDoesAnyExistByIdOp>().ThatIs(_ => !systemUnderTest.SpecifiedResourceLocator.IsEqualTo(_.SpecifiedResourceLocator));
        ...
        private static readonly StandardDoesAnyExistByIdOp ReferenceObjectForEquatableTestScenarios = A.Dummy<StandardDoesAnyExistByIdOp>();

        private static readonly EquatableTestScenarios<StandardDoesAnyExistByIdOp> EquatableTestScenarios = new EquatableTestScenarios<StandardDoesAnyExistByIdOp>()
            .AddScenario(() =>
                new EquatableTestScenario<StandardDoesAnyExistByIdOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new StandardDoesAnyExistByIdOp[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new StandardDoesAnyExistByIdOp[]
                    {
                        new StandardDoesAnyExistByIdOp(
                                A.Dummy<StandardDoesAnyExistByIdOp>().Whose(_ => !_.StringSerializedId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.StringSerializedId)).StringSerializedId,
                                ReferenceObjectForEquatableTestScenarios.IdentifierType,
                                ReferenceObjectForEquatableTestScenarios.ObjectType,
                                ReferenceObjectForEquatableTestScenarios.VersionMatchStrategy,
                                ReferenceObjectForEquatableTestScenarios.SpecifiedResourceLocator),
                        new StandardDoesAnyExistByIdOp(
                                ReferenceObjectForEquatableTestScenarios.StringSerializedId,
                                A.Dummy<StandardDoesAnyExistByIdOp>().Whose(_ => !_.IdentifierType.IsEqualTo(ReferenceObjectForEquatableTestScenarios.IdentifierType)).IdentifierType,
                                ReferenceObjectForEquatableTestScenarios.ObjectType,
                                ReferenceObjectForEquatableTestScenarios.VersionMatchStrategy,
                                ReferenceObjectForEquatableTestScenarios.SpecifiedResourceLocator),
                        new StandardDoesAnyExistByIdOp(
                                ReferenceObjectForEquatableTestScenarios.StringSerializedId,
                                ReferenceObjectForEquatableTestScenarios.IdentifierType,
                                A.Dummy<StandardDoesAnyExistByIdOp>().Whose(_ => !_.ObjectType.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ObjectType)).ObjectType,
                                ReferenceObjectForEquatableTestScenarios.VersionMatchStrategy,
                                ReferenceObjectForEquatableTestScenarios.SpecifiedResourceLocator),
                        new StandardDoesAnyExistByIdOp(
                                ReferenceObjectForEquatableTestScenarios.StringSerializedId,
                                ReferenceObjectForEquatableTestScenarios.IdentifierType,
                                ReferenceObjectForEquatableTestScenarios.ObjectType,
                                A.Dummy<StandardDoesAnyExistByIdOp>().Whose(_ => !_.VersionMatchStrategy.IsEqualTo(ReferenceObjectForEquatableTestScenarios.VersionMatchStrategy)).VersionMatchStrategy,
                                ReferenceObjectForEquatableTestScenarios.SpecifiedResourceLocator),
                        new StandardDoesAnyExistByIdOp(
                                ReferenceObjectForEquatableTestScenarios.StringSerializedId,
                                ReferenceObjectForEquatableTestScenarios.IdentifierType,
                                ReferenceObjectForEquatableTestScenarios.ObjectType,
                                ReferenceObjectForEquatableTestScenarios.VersionMatchStrategy,
                                A.Dummy<StandardDoesAnyExistByIdOp>().Whose(_ => !_.SpecifiedResourceLocator.IsEqualTo(ReferenceObjectForEquatableTestScenarios.SpecifiedResourceLocator)).SpecifiedResourceLocator),
                    },
        ...
        public static class Structural
        {
            ...
            public static void StandardDoesAnyExistByIdOp___Should_implement_IModel_of_StandardDoesAnyExistByIdOp___When_reflecting()
            {
                // Arrange
                var type = typeof(StandardDoesAnyExistByIdOp);

                var expectedModelMethods = typeof(IModel<StandardDoesAnyExistByIdOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<StandardDoesAnyExistByIdOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void StandardDoesAnyExistByIdOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(StandardDoesAnyExistByIdOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (StandardDoesAnyExistByIdOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (StandardDoesAnyExistByIdOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(StandardDoesAnyExistByIdOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<StandardDoesAnyExistByIdOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                StandardDoesAnyExistByIdOp systemUnderTest1 = null;
                StandardDoesAnyExistByIdOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    StandardDoesAnyExistByIdOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardDoesAnyExistByIdOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardDoesAnyExistByIdOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardDoesAnyExistByIdOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardDoesAnyExistByIdOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardDoesAnyExistByIdOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
