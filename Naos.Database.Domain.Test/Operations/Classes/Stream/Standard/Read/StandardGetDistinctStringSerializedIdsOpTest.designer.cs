...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<StandardGetDistinctStringSerializedIdsOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<StandardGetDistinctStringSerializedIdsOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<StandardGetDistinctStringSerializedIdsOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<StandardGetDistinctStringSerializedIdsOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.StandardGetDistinctStringSerializedIdsOp: RecordFilter = {systemUnderTest.RecordFilter?.ToString() ?? "<null>"}, RecordsToFilterCriteria = {systemUnderTest.RecordsToFilterCriteria?.ToString() ?? "<null>"}, SpecifiedResourceLocator = {systemUnderTest.SpecifiedResourceLocator?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<StandardGetDistinctStringSerializedIdsOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<StandardGetDistinctStringSerializedIdsOp>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardGetDistinctStringSerializedIdsOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardGetDistinctStringSerializedIdsOp>().ThatIs(_ => !systemUnderTest.RecordsToFilterCriteria.IsEqualTo(_.RecordsToFilterCriteria));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardGetDistinctStringSerializedIdsOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardGetDistinctStringSerializedIdsOp>().ThatIs(_ => !systemUnderTest.SpecifiedResourceLocator.IsEqualTo(_.SpecifiedResourceLocator));
        ...
        private static readonly StandardGetDistinctStringSerializedIdsOp ReferenceObjectForEquatableTestScenarios = A.Dummy<StandardGetDistinctStringSerializedIdsOp>();

        private static readonly EquatableTestScenarios<StandardGetDistinctStringSerializedIdsOp> EquatableTestScenarios = new EquatableTestScenarios<StandardGetDistinctStringSerializedIdsOp>()
            .AddScenario(() =>
                new EquatableTestScenario<StandardGetDistinctStringSerializedIdsOp>
                {
                    Name = "Default Code Generated Scenario",
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new StandardGetDistinctStringSerializedIdsOp[]
                    {
                        ...
                        new StandardGetDistinctStringSerializedIdsOp(
                                ReferenceObjectForEquatableTestScenarios.RecordFilter,
                                A.Dummy<StandardGetDistinctStringSerializedIdsOp>().Whose(_ => !_.RecordsToFilterCriteria.IsEqualTo(ReferenceObjectForEquatableTestScenarios.RecordsToFilterCriteria)).RecordsToFilterCriteria,
                                ReferenceObjectForEquatableTestScenarios.SpecifiedResourceLocator),
                        new StandardGetDistinctStringSerializedIdsOp(
                                ReferenceObjectForEquatableTestScenarios.RecordFilter,
                                ReferenceObjectForEquatableTestScenarios.RecordsToFilterCriteria,
        ...
        private static readonly ValidModelTestScenarios<StandardGetDistinctStringSerializedIdsOp> ValidModelTestScenarios = new ValidModelTestScenarios<StandardGetDistinctStringSerializedIdsOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<StandardGetDistinctStringSerializedIdsOp>
                {
                    Name = "a dummy StandardGetDistinctStringSerializedIdsOp should be valid",
                    SystemUnderTest = A.Dummy<StandardGetDistinctStringSerializedIdsOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void StandardGetDistinctStringSerializedIdsOp___Should_implement_IModel_of_StandardGetDistinctStringSerializedIdsOp___When_reflecting()
            {
                // Arrange
                var type = typeof(StandardGetDistinctStringSerializedIdsOp);

                var expectedModelMethods = typeof(IModel<StandardGetDistinctStringSerializedIdsOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<StandardGetDistinctStringSerializedIdsOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void StandardGetDistinctStringSerializedIdsOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(StandardGetDistinctStringSerializedIdsOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (StandardGetDistinctStringSerializedIdsOp)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "RecordFilter", "RecordsToFilterCriteria", "SpecifiedResourceLocator" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (StandardGetDistinctStringSerializedIdsOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(StandardGetDistinctStringSerializedIdsOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<StandardGetDistinctStringSerializedIdsOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                StandardGetDistinctStringSerializedIdsOp systemUnderTest1 = null;
                StandardGetDistinctStringSerializedIdsOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    StandardGetDistinctStringSerializedIdsOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardGetDistinctStringSerializedIdsOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardGetDistinctStringSerializedIdsOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardGetDistinctStringSerializedIdsOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardGetDistinctStringSerializedIdsOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardGetDistinctStringSerializedIdsOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
