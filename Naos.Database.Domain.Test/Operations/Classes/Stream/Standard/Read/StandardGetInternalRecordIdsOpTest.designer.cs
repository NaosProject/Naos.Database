...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class StandardGetInternalRecordIdsOpTest
    {
                ...
                new StringRepresentationTestScenario<StandardGetInternalRecordIdsOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<StandardGetInternalRecordIdsOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.StandardGetInternalRecordIdsOp: RecordFilter = {systemUnderTest.RecordFilter?.ToString() ?? "<null>"}, RecordNotFoundStrategy = {systemUnderTest.RecordNotFoundStrategy.ToString() ?? "<null>"}, RecordsToFilterSelectionStrategy = {systemUnderTest.RecordsToFilterSelectionStrategy.ToString() ?? "<null>"}, SpecifiedResourceLocator = {systemUnderTest.SpecifiedResourceLocator?.ToString() ?? "<null>"}."),
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardGetInternalRecordIdsOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardGetInternalRecordIdsOp>().ThatIs(_ => !systemUnderTest.RecordsToFilterSelectionStrategy.IsEqualTo(_.RecordsToFilterSelectionStrategy));
                ...
                new EquatableTestScenario<StandardGetInternalRecordIdsOp>
                {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new StandardGetInternalRecordIdsOp[]
                    {
                        ...
                        new StandardGetInternalRecordIdsOp(
                                ReferenceObjectForEquatableTestScenarios.RecordFilter,
                                ReferenceObjectForEquatableTestScenarios.RecordNotFoundStrategy,
                                A.Dummy<StandardGetInternalRecordIdsOp>().Whose(_ => !_.RecordsToFilterSelectionStrategy.IsEqualTo(ReferenceObjectForEquatableTestScenarios.RecordsToFilterSelectionStrategy)).RecordsToFilterSelectionStrategy,
                                ReferenceObjectForEquatableTestScenarios.SpecifiedResourceLocator),
                        new StandardGetInternalRecordIdsOp(
                                ReferenceObjectForEquatableTestScenarios.RecordFilter,
                                ReferenceObjectForEquatableTestScenarios.RecordNotFoundStrategy,
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "RecordFilter", "RecordNotFoundStrategy", "RecordsToFilterSelectionStrategy", "SpecifiedResourceLocator" };
