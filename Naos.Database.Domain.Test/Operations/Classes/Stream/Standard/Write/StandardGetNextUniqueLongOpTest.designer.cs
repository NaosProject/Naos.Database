...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<StandardGetNextUniqueLongOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<StandardGetNextUniqueLongOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<StandardGetNextUniqueLongOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<StandardGetNextUniqueLongOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<StandardGetNextUniqueLongOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.StandardGetNextUniqueLongOp: SpecifiedResourceLocator = {systemUnderTest.SpecifiedResourceLocator?.ToString() ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<StandardGetNextUniqueLongOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<StandardGetNextUniqueLongOp>();

        private static readonly ConstructorPropertyAssignmentTestScenarios<StandardGetNextUniqueLongOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<StandardGetNextUniqueLongOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<StandardGetNextUniqueLongOp>
                {
                    Name = "Details should return same 'details' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<StandardGetNextUniqueLongOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<StandardGetNextUniqueLongOp>
                        {
                            SystemUnderTest = new StandardGetNextUniqueLongOp(
        ...
        private static readonly DeepCloneWithTestScenarios<StandardGetNextUniqueLongOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<StandardGetNextUniqueLongOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardGetNextUniqueLongOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardGetNextUniqueLongOp>().ThatIs(_ => !systemUnderTest.SpecifiedResourceLocator.IsEqualTo(_.SpecifiedResourceLocator));

                        var result = new SystemUnderTestDeepCloneWithValue<StandardGetNextUniqueLongOp>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StandardGetNextUniqueLongOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StandardGetNextUniqueLongOp>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
        ...
        private static readonly StandardGetNextUniqueLongOp ReferenceObjectForEquatableTestScenarios = A.Dummy<StandardGetNextUniqueLongOp>();

        private static readonly EquatableTestScenarios<StandardGetNextUniqueLongOp> EquatableTestScenarios = new EquatableTestScenarios<StandardGetNextUniqueLongOp>()
            .AddScenario(() =>
                new EquatableTestScenario<StandardGetNextUniqueLongOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new StandardGetNextUniqueLongOp[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new StandardGetNextUniqueLongOp[]
                    {
                        new StandardGetNextUniqueLongOp(
                                ReferenceObjectForEquatableTestScenarios.Details,
                                A.Dummy<StandardGetNextUniqueLongOp>().Whose(_ => !_.SpecifiedResourceLocator.IsEqualTo(ReferenceObjectForEquatableTestScenarios.SpecifiedResourceLocator)).SpecifiedResourceLocator),
                        new StandardGetNextUniqueLongOp(
                                A.Dummy<StandardGetNextUniqueLongOp>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details,
                                ReferenceObjectForEquatableTestScenarios.SpecifiedResourceLocator),
                    },
        ...
        private static readonly ValidModelTestScenarios<StandardGetNextUniqueLongOp> ValidModelTestScenarios = new ValidModelTestScenarios<StandardGetNextUniqueLongOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<StandardGetNextUniqueLongOp>
                {
                    Name = "a dummy StandardGetNextUniqueLongOp should be valid",
                    SystemUnderTest = A.Dummy<StandardGetNextUniqueLongOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void StandardGetNextUniqueLongOp___Should_implement_IModel_of_StandardGetNextUniqueLongOp___When_reflecting()
            {
                // Arrange
                var type = typeof(StandardGetNextUniqueLongOp);

                var expectedModelMethods = typeof(IModel<StandardGetNextUniqueLongOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<StandardGetNextUniqueLongOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void StandardGetNextUniqueLongOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(StandardGetNextUniqueLongOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (StandardGetNextUniqueLongOp)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "SpecifiedResourceLocator", "Details" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (StandardGetNextUniqueLongOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(StandardGetNextUniqueLongOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<StandardGetNextUniqueLongOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                StandardGetNextUniqueLongOp systemUnderTest1 = null;
                StandardGetNextUniqueLongOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    StandardGetNextUniqueLongOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_long___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_long___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_long___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_long___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_long___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardGetNextUniqueLongOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardGetNextUniqueLongOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardGetNextUniqueLongOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardGetNextUniqueLongOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StandardGetNextUniqueLongOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
