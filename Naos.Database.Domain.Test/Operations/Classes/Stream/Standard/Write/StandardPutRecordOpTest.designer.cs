...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class StandardPutRecordOpTest
    {
        ...
        private static readonly ValidModelTestScenarios<StandardPutRecordOp> ValidModelTestScenarios = new ValidModelTestScenarios<StandardPutRecordOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<StandardPutRecordOp>
                {
                    Name = "a dummy StandardPutRecordOp should be valid",
                    SystemUnderTest = A.Dummy<StandardPutRecordOp>(),
                });
