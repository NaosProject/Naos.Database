...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<HandleRecordOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<HandleRecordOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<HandleRecordOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<HandleRecordOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<HandleRecordOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.HandleRecordOp: RecordToHandle = {systemUnderTest.RecordToHandle?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<HandleRecordOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<HandleRecordOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<HandleRecordOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'recordToHandle' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new HandleRecordOp(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<HandleRecordOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<HandleRecordOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<HandleRecordOp>
                {
                    Name = "RecordToHandle should return same 'recordToHandle' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<HandleRecordOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<HandleRecordOp>
                        {
                            SystemUnderTest = new HandleRecordOp(
        ...
        private static readonly DeepCloneWithTestScenarios<HandleRecordOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<HandleRecordOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<HandleRecordOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<HandleRecordOp>().ThatIs(_ => !systemUnderTest.RecordToHandle.IsEqualTo(_.RecordToHandle));

                        var result = new SystemUnderTestDeepCloneWithValue<HandleRecordOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly HandleRecordOp ReferenceObjectForEquatableTestScenarios = A.Dummy<HandleRecordOp>();

        private static readonly EquatableTestScenarios<HandleRecordOp> EquatableTestScenarios = new EquatableTestScenarios<HandleRecordOp>()
            .AddScenario(() =>
                new EquatableTestScenario<HandleRecordOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new HandleRecordOp[]
                    {
                        new HandleRecordOp(
                                ReferenceObjectForEquatableTestScenarios.RecordToHandle),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new HandleRecordOp[]
                    {
                        new HandleRecordOp(
                                A.Dummy<HandleRecordOp>().Whose(_ => !_.RecordToHandle.IsEqualTo(ReferenceObjectForEquatableTestScenarios.RecordToHandle)).RecordToHandle),
                    },
        ...
        private static readonly ValidModelTestScenarios<HandleRecordOp> ValidModelTestScenarios = new ValidModelTestScenarios<HandleRecordOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<HandleRecordOp>
                {
                    Name = "a dummy HandleRecordOp should be valid",
                    SystemUnderTest = A.Dummy<HandleRecordOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            {
                // Arrange
                var type = typeof(HandleRecordOp);

                var expectedModelMethods = typeof(IModel<HandleRecordOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<HandleRecordOp>));
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (HandleRecordOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (HandleRecordOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(HandleRecordOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<HandleRecordOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                HandleRecordOp systemUnderTest1 = null;
                HandleRecordOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    HandleRecordOp systemUnderTest = null;
