...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<HandleRecordOp<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<HandleRecordOp<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<HandleRecordOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<HandleRecordOp<Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<HandleRecordOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.HandleRecordOp<Version>: RecordToHandle = {systemUnderTest.RecordToHandle?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<HandleRecordOp<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<HandleRecordOp<Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<HandleRecordOp<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'recordToHandle' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new HandleRecordOp<Version>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<HandleRecordOp<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<HandleRecordOp<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<HandleRecordOp<Version>>
                {
                    Name = "RecordToHandle should return same 'recordToHandle' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<HandleRecordOp<Version>>();

                        var result = new SystemUnderTestExpectedPropertyValue<HandleRecordOp<Version>>
                        {
                            SystemUnderTest = new HandleRecordOp<Version>(
        ...
        private static readonly DeepCloneWithTestScenarios<HandleRecordOp<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<HandleRecordOp<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<HandleRecordOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<HandleRecordOp<Version>>().ThatIs(_ => !systemUnderTest.RecordToHandle.IsEqualTo(_.RecordToHandle));

                        var result = new SystemUnderTestDeepCloneWithValue<HandleRecordOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly HandleRecordOp<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<HandleRecordOp<Version>>();

        private static readonly EquatableTestScenarios<HandleRecordOp<Version>> EquatableTestScenarios = new EquatableTestScenarios<HandleRecordOp<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<HandleRecordOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new HandleRecordOp<Version>[]
                    {
                        new HandleRecordOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.RecordToHandle),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new HandleRecordOp<Version>[]
                    {
                        new HandleRecordOp<Version>(
                                A.Dummy<HandleRecordOp<Version>>().Whose(_ => !_.RecordToHandle.IsEqualTo(ReferenceObjectForEquatableTestScenarios.RecordToHandle)).RecordToHandle),
                    },
        ...
        private static readonly ValidModelTestScenarios<HandleRecordOp<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<HandleRecordOp<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<HandleRecordOp<Version>>
                {
                    Name = "a dummy HandleRecordOp<Version> should be valid",
                    SystemUnderTest = A.Dummy<HandleRecordOp<Version>>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void HandleRecordOp_of_Version___Should_implement_IModel_of_HandleRecordOp_of_Version___When_reflecting()
            {
                // Arrange
                var type = typeof(HandleRecordOp<Version>);

                var expectedModelMethods = typeof(IModel<HandleRecordOp<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<HandleRecordOp<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void HandleRecordOp_of_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(HandleRecordOp<Version>);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (HandleRecordOp<Version>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (HandleRecordOp<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(HandleRecordOp<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<HandleRecordOp<Version>>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                HandleRecordOp<Version> systemUnderTest1 = null;
                HandleRecordOp<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    HandleRecordOp<Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleRecordOp_of_Version___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleRecordOp_of_Version___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleRecordOp_of_Version___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleRecordOp_of_Version___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleRecordOp_of_Version___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
