...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<HandleRecordWithIdOp<Version, Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<HandleRecordWithIdOp<Version, Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<HandleRecordWithIdOp<Version, Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<HandleRecordWithIdOp<Version, Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<HandleRecordWithIdOp<Version, Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.HandleRecordWithIdOp<Version, Version>: RecordToHandle = {systemUnderTest.RecordToHandle?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<HandleRecordWithIdOp<Version, Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<HandleRecordWithIdOp<Version, Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<HandleRecordWithIdOp<Version, Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'recordToHandle' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new HandleRecordWithIdOp<Version, Version>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<HandleRecordWithIdOp<Version, Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<HandleRecordWithIdOp<Version, Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<HandleRecordWithIdOp<Version, Version>>
                {
                    Name = "RecordToHandle should return same 'recordToHandle' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<HandleRecordWithIdOp<Version, Version>>();

                        var result = new SystemUnderTestExpectedPropertyValue<HandleRecordWithIdOp<Version, Version>>
                        {
                            SystemUnderTest = new HandleRecordWithIdOp<Version, Version>(
        ...
        private static readonly DeepCloneWithTestScenarios<HandleRecordWithIdOp<Version, Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<HandleRecordWithIdOp<Version, Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<HandleRecordWithIdOp<Version, Version>>
                {
                    Name = "DeepCloneWithRecordToHandle should deep clone object and replace RecordToHandle with the provided recordToHandle",
                    WithPropertyName = "RecordToHandle",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<HandleRecordWithIdOp<Version, Version>>();

                        var referenceObject = A.Dummy<HandleRecordWithIdOp<Version, Version>>().ThatIs(_ => !systemUnderTest.RecordToHandle.IsEqualTo(_.RecordToHandle));

                        var result = new SystemUnderTestDeepCloneWithValue<HandleRecordWithIdOp<Version, Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.RecordToHandle,
                        };
        ...
        private static readonly HandleRecordWithIdOp<Version, Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<HandleRecordWithIdOp<Version, Version>>();

        private static readonly EquatableTestScenarios<HandleRecordWithIdOp<Version, Version>> EquatableTestScenarios = new EquatableTestScenarios<HandleRecordWithIdOp<Version, Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<HandleRecordWithIdOp<Version, Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new HandleRecordWithIdOp<Version, Version>[]
                    {
                        new HandleRecordWithIdOp<Version, Version>(
                                ReferenceObjectForEquatableTestScenarios.RecordToHandle),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new HandleRecordWithIdOp<Version, Version>[]
                    {
                        new HandleRecordWithIdOp<Version, Version>(
                                A.Dummy<HandleRecordWithIdOp<Version, Version>>().Whose(_ => !_.RecordToHandle.IsEqualTo(ReferenceObjectForEquatableTestScenarios.RecordToHandle)).RecordToHandle),
                    },
        ...
        private static readonly ValidModelTestScenarios<HandleRecordWithIdOp<Version, Version>> ValidModelTestScenarios = new ValidModelTestScenarios<HandleRecordWithIdOp<Version, Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<HandleRecordWithIdOp<Version, Version>>
                {
                    Name = "a dummy HandleRecordWithIdOp<Version, Version> should be valid",
                    SystemUnderTest = A.Dummy<HandleRecordWithIdOp<Version, Version>>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void HandleRecordWithIdOp_of_Version_Version___Should_implement_IModel_of_HandleRecordWithIdOp_of_Version_Version___When_reflecting()
            {
                // Arrange
                var type = typeof(HandleRecordWithIdOp<Version, Version>);

                var expectedModelMethods = typeof(IModel<HandleRecordWithIdOp<Version, Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<HandleRecordWithIdOp<Version, Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void HandleRecordWithIdOp_of_Version_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(HandleRecordWithIdOp<Version, Version>);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (HandleRecordWithIdOp<Version, Version>)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "RecordToHandle" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (HandleRecordWithIdOp<Version, Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(HandleRecordWithIdOp<Version, Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<HandleRecordWithIdOp<Version, Version>>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                HandleRecordWithIdOp<Version, Version> systemUnderTest1 = null;
                HandleRecordWithIdOp<Version, Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    HandleRecordWithIdOp<Version, Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleRecordWithIdOp_of_Version_Version___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleRecordWithIdOp_of_Version_Version___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleRecordWithIdOp_of_Version_Version___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleRecordWithIdOp_of_Version_Version___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleRecordWithIdOp_of_Version_Version___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
