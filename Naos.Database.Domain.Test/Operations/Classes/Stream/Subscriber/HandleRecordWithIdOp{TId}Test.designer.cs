...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<HandleRecordWithIdOp<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<HandleRecordWithIdOp<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<HandleRecordWithIdOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<HandleRecordWithIdOp<Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<HandleRecordWithIdOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.HandleRecordWithIdOp<Version>: RecordToHandle = {systemUnderTest.RecordToHandle?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<HandleRecordWithIdOp<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<HandleRecordWithIdOp<Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<HandleRecordWithIdOp<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'recordToHandle' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new HandleRecordWithIdOp<Version>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<HandleRecordWithIdOp<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<HandleRecordWithIdOp<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<HandleRecordWithIdOp<Version>>
                {
                    Name = "RecordToHandle should return same 'recordToHandle' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<HandleRecordWithIdOp<Version>>();

                        var result = new SystemUnderTestExpectedPropertyValue<HandleRecordWithIdOp<Version>>
                        {
                            SystemUnderTest = new HandleRecordWithIdOp<Version>(
        ...
        private static readonly DeepCloneWithTestScenarios<HandleRecordWithIdOp<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<HandleRecordWithIdOp<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<HandleRecordWithIdOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<HandleRecordWithIdOp<Version>>().ThatIs(_ => !systemUnderTest.RecordToHandle.IsEqualTo(_.RecordToHandle));

                        var result = new SystemUnderTestDeepCloneWithValue<HandleRecordWithIdOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly HandleRecordWithIdOp<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<HandleRecordWithIdOp<Version>>();

        private static readonly EquatableTestScenarios<HandleRecordWithIdOp<Version>> EquatableTestScenarios = new EquatableTestScenarios<HandleRecordWithIdOp<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<HandleRecordWithIdOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new HandleRecordWithIdOp<Version>[]
                    {
                        new HandleRecordWithIdOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.RecordToHandle),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new HandleRecordWithIdOp<Version>[]
                    {
                        new HandleRecordWithIdOp<Version>(
                                A.Dummy<HandleRecordWithIdOp<Version>>().Whose(_ => !_.RecordToHandle.IsEqualTo(ReferenceObjectForEquatableTestScenarios.RecordToHandle)).RecordToHandle),
                    },
        ...
        private static readonly ValidModelTestScenarios<HandleRecordWithIdOp<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<HandleRecordWithIdOp<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<HandleRecordWithIdOp<Version>>
                {
                    Name = "a dummy HandleRecordWithIdOp<Version> should be valid",
                    SystemUnderTest = A.Dummy<HandleRecordWithIdOp<Version>>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void HandleRecordWithIdOp_of_Version___Should_implement_IModel_of_HandleRecordWithIdOp_of_Version___When_reflecting()
            {
                // Arrange
                var type = typeof(HandleRecordWithIdOp<Version>);

                var expectedModelMethods = typeof(IModel<HandleRecordWithIdOp<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<HandleRecordWithIdOp<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void HandleRecordWithIdOp_of_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(HandleRecordWithIdOp<Version>);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (HandleRecordWithIdOp<Version>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (HandleRecordWithIdOp<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(HandleRecordWithIdOp<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<HandleRecordWithIdOp<Version>>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                HandleRecordWithIdOp<Version> systemUnderTest1 = null;
                HandleRecordWithIdOp<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    HandleRecordWithIdOp<Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleRecordWithIdOp_of_Version___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleRecordWithIdOp_of_Version___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleRecordWithIdOp_of_Version___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleRecordWithIdOp_of_Version___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_HandleRecordWithIdOp_of_Version___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
