...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class GetLatestObjectOpTObjectTest
    {
                ...
                new StringRepresentationTestScenario<GetLatestObjectOp<Version>>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<GetLatestObjectOp<Version>>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.GetLatestObjectOp<Version>: IdentifierType = {systemUnderTest.IdentifierType?.ToString() ?? "<null>"}, VersionMatchStrategy = {systemUnderTest.VersionMatchStrategy.ToString() ?? "<null>"}, RecordNotFoundStrategy = {systemUnderTest.RecordNotFoundStrategy.ToString() ?? "<null>"}."),
                        };
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "IdentifierType", "VersionMatchStrategy", "RecordNotFoundStrategy" };
