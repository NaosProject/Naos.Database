...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<PruneBeforeInternalRecordDateOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<PruneBeforeInternalRecordDateOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<PruneBeforeInternalRecordDateOp>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<PruneBeforeInternalRecordDateOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<PruneBeforeInternalRecordDateOp>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PruneBeforeInternalRecordDateOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PruneBeforeInternalRecordDateOp>().ThatIs(_ => !systemUnderTest.MaxInternalRecordDate.IsEqualTo(_.MaxInternalRecordDate));

                        var result = new SystemUnderTestDeepCloneWithValue<PruneBeforeInternalRecordDateOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.MaxInternalRecordDate,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PruneBeforeInternalRecordDateOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PruneBeforeInternalRecordDateOp>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PruneBeforeInternalRecordDateOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PruneBeforeInternalRecordDateOp>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
        ...
        private static readonly EquatableTestScenarios<PruneBeforeInternalRecordDateOp> EquatableTestScenarios = new EquatableTestScenarios<PruneBeforeInternalRecordDateOp>()
            .AddScenario(() =>
                new EquatableTestScenario<PruneBeforeInternalRecordDateOp>
                {
                    Name = "Default Code Generated Scenario",
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new PruneBeforeInternalRecordDateOp[]
                    {
                        ...
                        new PruneBeforeInternalRecordDateOp(
                                ReferenceObjectForEquatableTestScenarios.MaxInternalRecordDate,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                A.Dummy<PruneBeforeInternalRecordDateOp>().Whose(_ => !_.Tags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Tags)).Tags),
                    },
        ...
        public static class Structural
        {
            ...
            public static void PruneBeforeInternalRecordDateOp___Should_implement_IModel_of_PruneBeforeInternalRecordDateOp___When_reflecting()
            {
                // Arrange
                var type = typeof(PruneBeforeInternalRecordDateOp);

                var expectedModelMethods = typeof(IModel<PruneBeforeInternalRecordDateOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<PruneBeforeInternalRecordDateOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void PruneBeforeInternalRecordDateOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(PruneBeforeInternalRecordDateOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (PruneBeforeInternalRecordDateOp)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "MaxInternalRecordDate", "Details", "Tags" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (PruneBeforeInternalRecordDateOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(PruneBeforeInternalRecordDateOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<PruneBeforeInternalRecordDateOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                PruneBeforeInternalRecordDateOp systemUnderTest1 = null;
                PruneBeforeInternalRecordDateOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    PruneBeforeInternalRecordDateOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneBeforeInternalRecordDateOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneBeforeInternalRecordDateOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneBeforeInternalRecordDateOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneBeforeInternalRecordDateOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruneBeforeInternalRecordDateOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
