// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PruneRequested{TId}Test.cs" company="Naos Project">
    ...
    public static partial class PruneRequestedTest
    {
        static PruneRequestedTest()
        {
            ...
            ConstructorArgumentValidationTestScenarios
               .AddScenario(
                    () =>
                        new ConstructorArgumentValidationTestScenario<PruneRequested<Version>>
                        {
                            Name = "constructor should throw ArgumentNullException when parameter 'details' is null scenario",
                            ConstructionFunc = () =>
                                               {
                                                   var referenceObject = A.Dummy<PruneRequested<Version>>();

                                                   var result = new PruneRequested<Version>(
                                                       referenceObject.Id,
