...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<PruneRequested<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<PruneRequested<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<PruneRequested<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<PruneRequested<Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<PruneRequested<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.PruneRequested<Version>: Id = {systemUnderTest.Id?.ToString() ?? "<null>"}, Tags = {systemUnderTest.Tags?.ToString() ?? "<null>"}, TimestampUtc = {systemUnderTest.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<PruneRequested<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<PruneRequested<Version>>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<PruneRequested<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<PruneRequested<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<PruneRequested<Version>>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<PruneRequested<Version>>
                        {
                            SystemUnderTest = new PruneRequested<Version>(
                                                      referenceObject.Id,
                                                      referenceObject.TimestampUtc,
                                                      referenceObject.Details,
                                                      referenceObject.Tags),
        ...
        private static readonly DeepCloneWithTestScenarios<PruneRequested<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<PruneRequested<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PruneRequested<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PruneRequested<Version>>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<PruneRequested<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PruneRequested<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PruneRequested<Version>>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PruneRequested<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PruneRequested<Version>>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PruneRequested<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PruneRequested<Version>>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
        ...
        private static readonly PruneRequested<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<PruneRequested<Version>>();

        private static readonly EquatableTestScenarios<PruneRequested<Version>> EquatableTestScenarios = new EquatableTestScenarios<PruneRequested<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<PruneRequested<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new PruneRequested<Version>[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new PruneRequested<Version>[]
                    {
                        new PruneRequested<Version>(
                                A.Dummy<PruneRequested<Version>>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new PruneRequested<Version>(
                                ...
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                A.Dummy<PruneRequested<Version>>().Whose(_ => !_.Tags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Tags)).Tags),
                        new PruneRequested<Version>(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<PruneRequested<Version>>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new PruneRequested<Version>(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                A.Dummy<PruneRequested<Version>>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                    },
                    ObjectsThatAreNotOfTheSameTypeAsReferenceObject = new object[]
                    {
                        ...
                        A.Dummy<int?>(),
                        A.Dummy<Guid>(),
                        A.Dummy<Block<Version>>(),
                        A.Dummy<CancelBlock<Version>>(),
                        A.Dummy<Pruned<Version>>(),
                        A.Dummy<Pruning<Version>>(),
                    },
                });
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(PruneRequested<Version>);

                var expectedModelMethods = typeof(IModel<PruneRequested<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<PruneRequested<Version>>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (PruneRequested<Version>)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Id", "Tags", "TimestampUtc", "Details" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (PruneRequested<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(PruneRequested<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<PruneRequested<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                PruneRequested<Version> systemUnderTest1 = null;
                PruneRequested<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    PruneRequested<Version> systemUnderTest = null;
