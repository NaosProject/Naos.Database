...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Pruned<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Pruned<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Pruned<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Pruned<Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Pruned<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.Pruned<Version>: Id = {systemUnderTest.Id?.ToString() ?? "<null>"}, Tags = {systemUnderTest.Tags?.ToString() ?? "<null>"}, TimestampUtc = {systemUnderTest.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Pruned<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Pruned<Version>>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Pruned<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Pruned<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Pruned<Version>>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<Pruned<Version>>
                        {
                            SystemUnderTest = new Pruned<Version>(
                                                      referenceObject.Id,
                                                      referenceObject.TimestampUtc,
                                                      referenceObject.Details,
                                                      referenceObject.Tags),
        ...
        private static readonly DeepCloneWithTestScenarios<Pruned<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Pruned<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Pruned<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Pruned<Version>>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<Pruned<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Pruned<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Pruned<Version>>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Pruned<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Pruned<Version>>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Pruned<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Pruned<Version>>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
        ...
        private static readonly Pruned<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<Pruned<Version>>();

        private static readonly EquatableTestScenarios<Pruned<Version>> EquatableTestScenarios = new EquatableTestScenarios<Pruned<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<Pruned<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Pruned<Version>[]
                    {
                        new Pruned<Version>(
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new Pruned<Version>[]
                    {
                        new Pruned<Version>(
                                A.Dummy<Pruned<Version>>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new Pruned<Version>(
                                ...
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                A.Dummy<Pruned<Version>>().Whose(_ => !_.Tags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Tags)).Tags),
                        new Pruned<Version>(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<Pruned<Version>>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new Pruned<Version>(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                A.Dummy<Pruned<Version>>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                    },
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(Pruned<Version>);

                var expectedModelMethods = typeof(IModel<Pruned<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Pruned<Version>>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Pruned<Version>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Pruned<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(Pruned<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<Pruned<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Pruned<Version> systemUnderTest1 = null;
                Pruned<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    Pruned<Version> systemUnderTest = null;
