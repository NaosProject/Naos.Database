...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class PruningEventVersionTest
    {
        private static readonly StringRepresentationTestScenarios<PruningEvent<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<PruningEvent<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<PruningEvent<Version>>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<PruningEvent<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<PruningEvent<Version>>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<PruningEvent<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<PruningEvent<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<PruningEvent<Version>>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<PruningEvent<Version>>
                        {
        ...
        private static readonly DeepCloneWithTestScenarios<PruningEvent<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<PruningEvent<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PruningEvent<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PruningEvent<Version>>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PruningEvent<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PruningEvent<Version>>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PruningEvent<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PruningEvent<Version>>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
        ...
        private static readonly PruningEvent<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<PruningEvent<Version>>();

        private static readonly EquatableTestScenarios<PruningEvent<Version>> EquatableTestScenarios = new EquatableTestScenarios<PruningEvent<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<PruningEvent<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new PruningEvent<Version>[]
                    {
        ...
        public static class Structural
        {
            ...
            public static void PruningEvent___Should_implement_IModel_of_PruningEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(PruningEvent<Version>);

                var expectedModelMethods = typeof(IModel<PruningEvent<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<PruningEvent<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void PruningEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(PruningEvent<Version>);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (PruningEvent<Version>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (PruningEvent<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(PruningEvent<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<PruningEvent<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                PruningEvent<Version> systemUnderTest1 = null;
                PruningEvent<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    PruningEvent<Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruningEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruningEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruningEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruningEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PruningEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
