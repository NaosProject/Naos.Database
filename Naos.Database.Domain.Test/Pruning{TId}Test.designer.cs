...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Pruning<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Pruning<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Pruning<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Pruning<Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Pruning<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.Pruning<Version>: Id = {systemUnderTest.Id?.ToString() ?? "<null>"}, Tags = {systemUnderTest.Tags?.ToString() ?? "<null>"}, TimestampUtc = {systemUnderTest.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Pruner = {systemUnderTest.Pruner?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Pruning<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Pruning<Version>>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Pruning<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Pruning<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Pruning<Version>>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<Pruning<Version>>
                        {
                            SystemUnderTest = new Pruning<Version>(
                                                      referenceObject.Id,
                                                      referenceObject.TimestampUtc,
                                                      referenceObject.Pruner,
                                                      referenceObject.Tags),
        ...
        private static readonly DeepCloneWithTestScenarios<Pruning<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Pruning<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Pruning<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Pruning<Version>>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<Pruning<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Pruning<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Pruning<Version>>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Pruning<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Pruning<Version>>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Pruning<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Pruning<Version>>().ThatIs(_ => !systemUnderTest.Pruner.IsEqualTo(_.Pruner));
        ...
        private static readonly Pruning<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<Pruning<Version>>();

        private static readonly EquatableTestScenarios<Pruning<Version>> EquatableTestScenarios = new EquatableTestScenarios<Pruning<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<Pruning<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Pruning<Version>[]
                    {
                        new Pruning<Version>(
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new Pruning<Version>[]
                    {
                        new Pruning<Version>(
                                A.Dummy<Pruning<Version>>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Pruner,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new Pruning<Version>(
                                ...
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Pruner,
                                A.Dummy<Pruning<Version>>().Whose(_ => !_.Tags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Tags)).Tags),
                        new Pruning<Version>(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<Pruning<Version>>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Pruner,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new Pruning<Version>(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                A.Dummy<Pruning<Version>>().Whose(_ => !_.Pruner.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Pruner)).Pruner,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                    },
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(Pruning<Version>);

                var expectedModelMethods = typeof(IModel<Pruning<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Pruning<Version>>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Pruning<Version>)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Id", "Tags", "TimestampUtc", "Pruner" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Pruning<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(Pruning<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<Pruning<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Pruning<Version> systemUnderTest1 = null;
                Pruning<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    Pruning<Version> systemUnderTest = null;
