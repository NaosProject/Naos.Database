...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<PutIdentifiableOp<Version, Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<PutIdentifiableOp<Version, Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<PutIdentifiableOp<Version, Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<PutIdentifiableOp<Version, Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<PutIdentifiableOp<Version, Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.PutIdentifiableOp<Version, Version>: ObjectToPut = {systemUnderTest.ObjectToPut?.ToString() ?? "<null>"}, Tags = {systemUnderTest.Tags?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<PutIdentifiableOp<Version, Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<PutIdentifiableOp<Version, Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<PutIdentifiableOp<Version, Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'objectToPut' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<PutIdentifiableOp<Version, Version>>();

                        var result = new PutIdentifiableOp<Version, Version>(
                                             null,
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<PutIdentifiableOp<Version, Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<PutIdentifiableOp<Version, Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<PutIdentifiableOp<Version, Version>>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<PutIdentifiableOp<Version, Version>>
                        {
                            SystemUnderTest = new PutIdentifiableOp<Version, Version>(
                                                      referenceObject.ObjectToPut,
                                                      referenceObject.Tags),
        ...
        private static readonly DeepCloneWithTestScenarios<PutIdentifiableOp<Version, Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<PutIdentifiableOp<Version, Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PutIdentifiableOp<Version, Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PutIdentifiableOp<Version, Version>>().ThatIs(_ => !systemUnderTest.ObjectToPut.IsEqualTo(_.ObjectToPut));

                        var result = new SystemUnderTestDeepCloneWithValue<PutIdentifiableOp<Version, Version>>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PutIdentifiableOp<Version, Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PutIdentifiableOp<Version, Version>>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
        ...
        private static readonly PutIdentifiableOp<Version, Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<PutIdentifiableOp<Version, Version>>();

        private static readonly EquatableTestScenarios<PutIdentifiableOp<Version, Version>> EquatableTestScenarios = new EquatableTestScenarios<PutIdentifiableOp<Version, Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<PutIdentifiableOp<Version, Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new PutIdentifiableOp<Version, Version>[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new PutIdentifiableOp<Version, Version>[]
                    {
                        new PutIdentifiableOp<Version, Version>(
                                A.Dummy<PutIdentifiableOp<Version, Version>>().Whose(_ => !_.ObjectToPut.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ObjectToPut)).ObjectToPut,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new PutIdentifiableOp<Version, Version>(
                                ReferenceObjectForEquatableTestScenarios.ObjectToPut,
                                A.Dummy<PutIdentifiableOp<Version, Version>>().Whose(_ => !_.Tags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Tags)).Tags),
                    },
        ...
        public static class Structural
        {
            ...
            public static void PutIdentifiableOp___Should_implement_IModel_of_PutIdentifiableOp___When_reflecting()
            {
                // Arrange
                var type = typeof(PutIdentifiableOp<Version, Version>);

                var expectedModelMethods = typeof(IModel<PutIdentifiableOp<Version, Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<PutIdentifiableOp<Version, Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void PutIdentifiableOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(PutIdentifiableOp<Version, Version>);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (PutIdentifiableOp<Version, Version>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (PutIdentifiableOp<Version, Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(PutIdentifiableOp<Version, Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<PutIdentifiableOp<Version, Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                PutIdentifiableOp<Version, Version> systemUnderTest1 = null;
                PutIdentifiableOp<Version, Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    PutIdentifiableOp<Version, Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PutIdentifiableOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PutIdentifiableOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PutIdentifiableOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PutIdentifiableOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PutIdentifiableOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
