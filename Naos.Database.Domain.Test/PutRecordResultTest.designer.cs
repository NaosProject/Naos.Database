...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<PutRecordResult> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<PutRecordResult>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<PutRecordResult>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<PutRecordResult>();

                        var result = new SystemUnderTestExpectedStringRepresentation<PutRecordResult>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.PutRecordResult: InternalRecordIdOfPutRecord = {systemUnderTest.InternalRecordIdOfPutRecord?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, InternalRecordIdOfExistingRecord = {systemUnderTest.InternalRecordIdOfExistingRecord?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<PutRecordResult> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<PutRecordResult>();

        private static readonly ConstructorPropertyAssignmentTestScenarios<PutRecordResult> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<PutRecordResult>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<PutRecordResult>
                {
                    Name = "InternalRecordIdOfPutRecord should return same 'internalRecordIdOfPutRecord' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<PutRecordResult>();

                        var result = new SystemUnderTestExpectedPropertyValue<PutRecordResult>
                        {
                            SystemUnderTest = new PutRecordResult(
                                                      referenceObject.InternalRecordIdOfPutRecord,
                                                      referenceObject.InternalRecordIdOfExistingRecord),
                            ExpectedPropertyValue = referenceObject.InternalRecordIdOfPutRecord,
                        };

                        return result;
                    },
                    PropertyName = "InternalRecordIdOfPutRecord",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<PutRecordResult>
                {
                    Name = "InternalRecordIdOfExistingRecord should return same 'internalRecordIdOfExistingRecord' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<PutRecordResult>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<PutRecordResult>
                        {
                            SystemUnderTest = new PutRecordResult(
                                                      referenceObject.InternalRecordIdOfPutRecord,
                                                      referenceObject.InternalRecordIdOfExistingRecord),
                            ExpectedPropertyValue = referenceObject.InternalRecordIdOfExistingRecord,
                        };

                        return result;
                    },
                    PropertyName = "InternalRecordIdOfExistingRecord",
                });

        private static readonly DeepCloneWithTestScenarios<PutRecordResult> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<PutRecordResult>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PutRecordResult>
                {
                    Name = "DeepCloneWithInternalRecordIdOfPutRecord should deep clone object and replace InternalRecordIdOfPutRecord with the provided internalRecordIdOfPutRecord",
                    WithPropertyName = "InternalRecordIdOfPutRecord",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<PutRecordResult>();

                        var referenceObject = A.Dummy<PutRecordResult>().ThatIs(_ => !systemUnderTest.InternalRecordIdOfPutRecord.IsEqualTo(_.InternalRecordIdOfPutRecord));

                        var result = new SystemUnderTestDeepCloneWithValue<PutRecordResult>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.InternalRecordIdOfPutRecord,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PutRecordResult>
                {
                    Name = "DeepCloneWithInternalRecordIdOfExistingRecord should deep clone object and replace InternalRecordIdOfExistingRecord with the provided internalRecordIdOfExistingRecord",
                    WithPropertyName = "InternalRecordIdOfExistingRecord",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<PutRecordResult>();

                        var referenceObject = A.Dummy<PutRecordResult>().ThatIs(_ => !systemUnderTest.InternalRecordIdOfExistingRecord.IsEqualTo(_.InternalRecordIdOfExistingRecord));

                        var result = new SystemUnderTestDeepCloneWithValue<PutRecordResult>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.InternalRecordIdOfExistingRecord,
                        };
        ...
        private static readonly PutRecordResult ReferenceObjectForEquatableTestScenarios = A.Dummy<PutRecordResult>();

        private static readonly EquatableTestScenarios<PutRecordResult> EquatableTestScenarios = new EquatableTestScenarios<PutRecordResult>()
            .AddScenario(() =>
                new EquatableTestScenario<PutRecordResult>
                {
                    ...
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new PutRecordResult[]
                    {
                        new PutRecordResult(
                                ...
                                ReferenceObjectForEquatableTestScenarios.InternalRecordIdOfExistingRecord),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new PutRecordResult[]
                    {
                        ...
                        new PutRecordResult(
                                ReferenceObjectForEquatableTestScenarios.InternalRecordIdOfPutRecord,
                                A.Dummy<PutRecordResult>().Whose(_ => !_.InternalRecordIdOfExistingRecord.IsEqualTo(ReferenceObjectForEquatableTestScenarios.InternalRecordIdOfExistingRecord)).InternalRecordIdOfExistingRecord),
                    },
        ...
        public static class Structural
        {
            ...
            public static void PutRecordResult___Should_implement_IModel_of_PutRecordResult___When_reflecting()
            {
                // Arrange
                var type = typeof(PutRecordResult);

                var expectedModelMethods = typeof(IModel<PutRecordResult>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<PutRecordResult>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void PutRecordResult___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(PutRecordResult);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (PutRecordResult)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "InternalRecordIdOfPutRecord", "InternalRecordIdOfExistingRecord" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (PutRecordResult)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(PutRecordResult).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<PutRecordResult>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                PutRecordResult systemUnderTest1 = null;
                PutRecordResult systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    PutRecordResult systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PutRecordResult___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PutRecordResult___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PutRecordResult___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PutRecordResult___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PutRecordResult___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
