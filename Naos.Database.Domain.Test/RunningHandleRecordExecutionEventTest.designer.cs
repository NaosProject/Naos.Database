...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<RunningHandleRecordExecutionEvent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<RunningHandleRecordExecutionEvent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<RunningHandleRecordExecutionEvent>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<RunningHandleRecordExecutionEvent>();

                        var result = new SystemUnderTestExpectedStringRepresentation<RunningHandleRecordExecutionEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.RunningHandleRecordExecutionEvent: TimestampUtc = {systemUnderTest.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Id = {systemUnderTest.Id.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<RunningHandleRecordExecutionEvent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<RunningHandleRecordExecutionEvent>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<RunningHandleRecordExecutionEvent>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'details' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<RunningHandleRecordExecutionEvent>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<RunningHandleRecordExecutionEvent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<RunningHandleRecordExecutionEvent>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<RunningHandleRecordExecutionEvent>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<RunningHandleRecordExecutionEvent>
                        {
                            SystemUnderTest = new RunningHandleRecordExecutionEvent(
                                                      referenceObject.Id,
                                                      referenceObject.TimestampUtc,
        ...
        private static readonly DeepCloneWithTestScenarios<RunningHandleRecordExecutionEvent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<RunningHandleRecordExecutionEvent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RunningHandleRecordExecutionEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RunningHandleRecordExecutionEvent>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));

                        var result = new SystemUnderTestDeepCloneWithValue<RunningHandleRecordExecutionEvent>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RunningHandleRecordExecutionEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RunningHandleRecordExecutionEvent>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RunningHandleRecordExecutionEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RunningHandleRecordExecutionEvent>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
        ...
        private static readonly RunningHandleRecordExecutionEvent ReferenceObjectForEquatableTestScenarios = A.Dummy<RunningHandleRecordExecutionEvent>();

        private static readonly EquatableTestScenarios<RunningHandleRecordExecutionEvent> EquatableTestScenarios = new EquatableTestScenarios<RunningHandleRecordExecutionEvent>()
            .AddScenario(() =>
                new EquatableTestScenario<RunningHandleRecordExecutionEvent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new RunningHandleRecordExecutionEvent[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new RunningHandleRecordExecutionEvent[]
                    {
                        new RunningHandleRecordExecutionEvent(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<RunningHandleRecordExecutionEvent>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details),
                        new RunningHandleRecordExecutionEvent(
                                A.Dummy<RunningHandleRecordExecutionEvent>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Details),
                        new RunningHandleRecordExecutionEvent(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                A.Dummy<RunningHandleRecordExecutionEvent>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details),
                    },
        ...
        public static class Structural
        {
            ...
            public static void RunningHandleRecordExecutionEvent___Should_implement_IModel_of_RunningHandleRecordExecutionEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(RunningHandleRecordExecutionEvent);

                var expectedModelMethods = typeof(IModel<RunningHandleRecordExecutionEvent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<RunningHandleRecordExecutionEvent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void RunningHandleRecordExecutionEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(RunningHandleRecordExecutionEvent);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (RunningHandleRecordExecutionEvent)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (RunningHandleRecordExecutionEvent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(RunningHandleRecordExecutionEvent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<RunningHandleRecordExecutionEvent>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                RunningHandleRecordExecutionEvent systemUnderTest1 = null;
                RunningHandleRecordExecutionEvent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    RunningHandleRecordExecutionEvent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RunningHandleRecordExecutionEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RunningHandleRecordExecutionEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RunningHandleRecordExecutionEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RunningHandleRecordExecutionEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RunningHandleRecordExecutionEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
