    ...
    public static partial class StreamRecordMetadataTest
    {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<StreamRecordMetadata> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<StreamRecordMetadata>()
            .AddScenario(() =>
                ...
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'stringSerializedObjectId' is null scenario",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "stringSerializedObjectId", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<StreamRecordMetadata>
                {
                    Name = "constructor should throw ArgumentException when parameter 'stringSerializedObjectId' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<StreamRecordMetadata>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "stringSerializedObjectId", "white space", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<StreamRecordMetadata>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new StreamRecordMetadata(
                                             referenceObject.StringSerializedObjectId,
                                             null,
                                             referenceObject.TypeRepresentationOfObject,
                                             referenceObject.Tags,
                                             referenceObject.TimestampUtc);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<StreamRecordMetadata> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<StreamRecordMetadata>()
            .AddScenario(() =>
                ...
                {
                    Name = "StringSerializedObjectId should return same 'stringSerializedObjectId' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<StreamRecordMetadata>
                        {
                            SystemUnderTest = new StreamRecordMetadata(
                                                      ...
                                                      referenceObject.Tags,
                                                      referenceObject.TimestampUtc),
                            ExpectedPropertyValue = referenceObject.StringSerializedObjectId,
                        };

                        return result;
                    },
                    PropertyName = "StringSerializedObjectId",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<StreamRecordMetadata>
                {
        ...
        private static readonly DeepCloneWithTestScenarios<StreamRecordMetadata> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<StreamRecordMetadata>()
            .AddScenario(() =>
                ...
                {
                    Name = "DeepCloneWithStringSerializedObjectId should deep clone object and replace StringSerializedObjectId with the provided stringSerializedObjectId",
                    WithPropertyName = "StringSerializedObjectId",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<StreamRecordMetadata>();

                        var referenceObject = A.Dummy<StreamRecordMetadata>().ThatIs(_ => !systemUnderTest.StringSerializedObjectId.IsEqualTo(_.StringSerializedObjectId));

                        var result = new SystemUnderTestDeepCloneWithValue<StreamRecordMetadata>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.StringSerializedObjectId,
                        };
                ...
                new EquatableTestScenario<StreamRecordMetadata>
                {
                    ...
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new StreamRecordMetadata[]
                    {
                        new StreamRecordMetadata(
                                ReferenceObjectForEquatableTestScenarios.StringSerializedObjectId,
                    ...
                    {
                        new StreamRecordMetadata(
                                A.Dummy<StreamRecordMetadata>().Whose(_ => !_.StringSerializedObjectId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.StringSerializedObjectId)).StringSerializedObjectId,
                                ReferenceObjectForEquatableTestScenarios.TypeRepresentationOfId,
                                ReferenceObjectForEquatableTestScenarios.TypeRepresentationOfObject,
                                ReferenceObjectForEquatableTestScenarios.Tags,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc),
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "StringSerializedObjectId", "Tags", "TypeRepresentationOfId", "TypeRepresentationOfObject", "TimestampUtc" };
