    ...
    public static partial class StreamRecordMetadataTest
    {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<StreamRecordMetadata<Version>>
                        {
                            SystemUnderTest = new StreamRecordMetadata<Version>(
                                                      ...
                                                      referenceObject.TypeRepresentationWithoutVersion,
                                                      referenceObject.TimestampUtc),
                            ExpectedPropertyValue = referenceObject.TypeRepresentationWithVersion,
                        };
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<StreamRecordMetadata<Version>>
                        {
                            SystemUnderTest = new StreamRecordMetadata<Version>(
                                                      ...
                                                      referenceObject.TypeRepresentationWithoutVersion,
                                                      referenceObject.TimestampUtc),
                            ExpectedPropertyValue = referenceObject.TypeRepresentationWithoutVersion,
                        };
        ...
        public static class Cloning
        {
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.TypeRepresentationWithVersion == null)
                {
                    actual.TypeRepresentationWithVersion.AsTest().Must().BeNull();
                }
                else
                {
                    actual.TypeRepresentationWithVersion.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.TypeRepresentationWithVersion);
                }

                if (systemUnderTest.TypeRepresentationWithoutVersion == null)
                {
                    actual.TypeRepresentationWithoutVersion.AsTest().Must().BeNull();
                }
                else
                {
                    actual.TypeRepresentationWithoutVersion.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.TypeRepresentationWithoutVersion);
                }
            }
            ...
            {
                var propertyNames = new string[] { "Id", "Tags", "TypeRepresentationWithVersion", "TypeRepresentationWithoutVersion", "TimestampUtc" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(StreamRecordMetadata<Version>).GetPropertyInfo(propertyName, BindingFlagsFor.PublicDeclaredAndInheritedInstanceMembers);
