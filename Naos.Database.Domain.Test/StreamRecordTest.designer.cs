                ...
                new StringRepresentationTestScenario<StreamRecord>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<StreamRecord>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Protocol.Memory.StreamRecord: Id = {systemUnderTest.Id.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Metadata = {systemUnderTest.Metadata?.ToString() ?? "<null>"}, Payload = {systemUnderTest.Payload?.ToString() ?? "<null>"}."),
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StreamRecord>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StreamRecord>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));
        ...
        private static readonly EquatableTestScenarios<StreamRecord> EquatableTestScenarios = new EquatableTestScenarios<StreamRecord>()
            .AddScenario(() =>
                new EquatableTestScenario<StreamRecord>
                {
                    ...
                    {
                        new StreamRecord(
                                A.Dummy<StreamRecord>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.Metadata,
                                ReferenceObjectForEquatableTestScenarios.Payload),
                        new StreamRecord(
                                ReferenceObjectForEquatableTestScenarios.Id,
