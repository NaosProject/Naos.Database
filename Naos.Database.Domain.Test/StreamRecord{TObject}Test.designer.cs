...
namespace Naos.Database.Protocol.Memory.Test
{
    ...
    public static partial class StreamRecordVersionTest
    {
                ...
                new StringRepresentationTestScenario<StreamRecord<Version>>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<StreamRecord<Version>>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Protocol.Memory.StreamRecord<Version>: InternalRecordId = {systemUnderTest.InternalRecordId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Metadata = {systemUnderTest.Metadata?.ToString() ?? "<null>"}, Payload = {systemUnderTest.Payload?.ToString() ?? "<null>"}."),
                        };
