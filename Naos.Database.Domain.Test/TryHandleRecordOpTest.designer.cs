                ...
                new StringRepresentationTestScenario<TryHandleRecordOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<TryHandleRecordOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.TryHandleRecordOp: RecordToHandle = {systemUnderTest.RecordToHandle?.ToString() ?? "<null>"}."),
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TryHandleRecordOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TryHandleRecordOp>().ThatIs(_ => !systemUnderTest.RecordToHandle.IsEqualTo(_.RecordToHandle));
        ...
        private static readonly EquatableTestScenarios<TryHandleRecordOp> EquatableTestScenarios = new EquatableTestScenarios<TryHandleRecordOp>()
            .AddScenario(() =>
                new EquatableTestScenario<TryHandleRecordOp>
                {
                    ...
                    {
                        new TryHandleRecordOp(
                                A.Dummy<TryHandleRecordOp>().Whose(_ => !_.RecordToHandle.IsEqualTo(ReferenceObjectForEquatableTestScenarios.RecordToHandle)).RecordToHandle),
                    },
