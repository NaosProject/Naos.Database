...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class TryHandleRecordOpTObjectTest
    {
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Concern", "IdentifierType", "VersionMatchStrategy", "OrderRecordsBy", "SpecifiedResourceLocator", "Tags", "Details", "MinimumInternalRecordId", "InheritRecordTags" };
