...
namespace Naos.Database.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<TryHandleRecordResult> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<TryHandleRecordResult>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<TryHandleRecordResult>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<TryHandleRecordResult>();

                        var result = new SystemUnderTestExpectedStringRepresentation<TryHandleRecordResult>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.TryHandleRecordResult: RecordToHandle = {systemUnderTest.RecordToHandle?.ToString() ?? "<null>"}, IsBlocked = {systemUnderTest.IsBlocked.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<TryHandleRecordResult> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<TryHandleRecordResult>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<TryHandleRecordResult>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<TryHandleRecordResult>();

                        var result = new TryHandleRecordResult(
                                             null,
                                             referenceObject.IsBlocked);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<TryHandleRecordResult> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<TryHandleRecordResult>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TryHandleRecordResult>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<TryHandleRecordResult>
                        {
                            SystemUnderTest = new TryHandleRecordResult(
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<TryHandleRecordResult>
                {
                    Name = "IsBlocked should return same 'isBlocked' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<TryHandleRecordResult>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<TryHandleRecordResult>
                        {
                            SystemUnderTest = new TryHandleRecordResult(
                                                      referenceObject.RecordToHandle,
                                                      referenceObject.IsBlocked),
                            ExpectedPropertyValue = referenceObject.IsBlocked,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<TryHandleRecordResult> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<TryHandleRecordResult>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TryHandleRecordResult>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TryHandleRecordResult>().ThatIs(_ => !systemUnderTest.RecordToHandle.IsEqualTo(_.RecordToHandle));

                        var result = new SystemUnderTestDeepCloneWithValue<TryHandleRecordResult>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TryHandleRecordResult>
                {
                    Name = "DeepCloneWithIsBlocked should deep clone object and replace IsBlocked with the provided isBlocked",
                    WithPropertyName = "IsBlocked",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<TryHandleRecordResult>();

                        var referenceObject = A.Dummy<TryHandleRecordResult>().ThatIs(_ => !systemUnderTest.IsBlocked.IsEqualTo(_.IsBlocked));

                        var result = new SystemUnderTestDeepCloneWithValue<TryHandleRecordResult>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.IsBlocked,
                        };
        ...
        private static readonly TryHandleRecordResult ReferenceObjectForEquatableTestScenarios = A.Dummy<TryHandleRecordResult>();

        private static readonly EquatableTestScenarios<TryHandleRecordResult> EquatableTestScenarios = new EquatableTestScenarios<TryHandleRecordResult>()
            .AddScenario(() =>
        ...
        public static class Structural
        {
            ...
            public static void TryHandleRecordResult___Should_implement_IModel_of_TryHandleRecordResult___When_reflecting()
            {
                // Arrange
                var type = typeof(TryHandleRecordResult);

                var expectedModelMethods = typeof(IModel<TryHandleRecordResult>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<TryHandleRecordResult>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void TryHandleRecordResult___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(TryHandleRecordResult);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (TryHandleRecordResult)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "RecordToHandle", "IsBlocked" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (TryHandleRecordResult)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(TryHandleRecordResult).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<TryHandleRecordResult>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                TryHandleRecordResult systemUnderTest1 = null;
                TryHandleRecordResult systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    TryHandleRecordResult systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TryHandleRecordResult___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TryHandleRecordResult___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TryHandleRecordResult___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TryHandleRecordResult___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_TryHandleRecordResult___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
