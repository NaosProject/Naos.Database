                ...
                new StringRepresentationTestScenario<TryHandleRecordWithIdOp<Version, Version>>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<TryHandleRecordWithIdOp<Version, Version>>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.TryHandleRecordWithIdOp<Version, Version>: RecordToHandle = {systemUnderTest.RecordToHandle?.ToString() ?? "<null>"}."),
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TryHandleRecordWithIdOp<Version, Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TryHandleRecordWithIdOp<Version, Version>>().ThatIs(_ => !systemUnderTest.RecordToHandle.IsEqualTo(_.RecordToHandle));
        ...
        private static readonly EquatableTestScenarios<TryHandleRecordWithIdOp<Version, Version>> EquatableTestScenarios = new EquatableTestScenarios<TryHandleRecordWithIdOp<Version, Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<TryHandleRecordWithIdOp<Version, Version>>
                {
                    ...
                    {
                        new TryHandleRecordWithIdOp<Version, Version>(
                                A.Dummy<TryHandleRecordWithIdOp<Version, Version>>().Whose(_ => !_.RecordToHandle.IsEqualTo(ReferenceObjectForEquatableTestScenarios.RecordToHandle)).RecordToHandle),
                    },
