...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class TryHandleRecordWithIdOpTIdTObjectTest
    {
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TryHandleRecordWithIdOp<Version, Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TryHandleRecordWithIdOp<Version, Version>>().ThatIs(_ => !systemUnderTest.TypeVersionMatchStrategy.IsEqualTo(_.TypeVersionMatchStrategy));
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Concern", "TypeVersionMatchStrategy", "OrderRecordsStrategy", "SpecifiedResourceLocator", "Tags", "Details", "MinimumInternalRecordId", "InheritRecordTags" };
