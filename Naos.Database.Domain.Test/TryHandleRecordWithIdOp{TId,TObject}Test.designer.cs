...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class TryHandleRecordWithIdOpTIdTObjectTest
    {
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<TryHandleRecordWithIdOp<Version, Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<TryHandleRecordWithIdOp<Version, Version>>().ThatIs(_ => !systemUnderTest.SpecifiedResourceLocator.IsEqualTo(_.SpecifiedResourceLocator));
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Concern", "VersionMatchStrategy", "OrderRecordsBy", "SpecifiedResourceLocator", "Tags", "Details", "MinimumInternalRecordId", "InheritRecordTags" };
