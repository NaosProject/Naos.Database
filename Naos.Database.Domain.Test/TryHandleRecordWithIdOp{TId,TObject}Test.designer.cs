...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class TryHandleRecordWithIdOpTIdTObjectTest
    {
                ...
                new StringRepresentationTestScenario<TryHandleRecordWithIdOp<Version, Version>>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<TryHandleRecordWithIdOp<Version, Version>>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Database.Domain.TryHandleRecordWithIdOp<Version, Version>: Concern = {systemUnderTest.Concern?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, TypeVersionMatchStrategy = {systemUnderTest.TypeVersionMatchStrategy.ToString() ?? "<null>"}."),
                        };
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Concern", "TypeVersionMatchStrategy" };
