...
namespace Naos.Database.Domain.Test
{
    ...
    public static partial class TryHandleRecordWithIdOpTIdTObjectTest
    {
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Concern", "VersionMatchStrategy", "OrderRecordsStrategy", "SpecifiedResourceLocator", "Tags", "Details", "MinimumInternalRecordId", "InheritRecordTags" };
