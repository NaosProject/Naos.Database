...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class BlockEvent<TId> : IModel<BlockEvent<TId>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="BlockEvent{TId}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(BlockEvent<TId> left, BlockEvent<TId> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="BlockEvent{TId}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(BlockEvent<TId> left, BlockEvent<TId> right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(BlockEvent<TId> other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as BlockEvent<TId>);
        ...
        /// <inheritdoc />
        public new BlockEvent<TId> DeepClone() => (BlockEvent<TId>)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="BlockEvent{TId}" /> using the specified <paramref name="details" /> for <see cref="Details" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public BlockEvent<TId> DeepCloneWithDetails(string details)
        {
            var result = new BlockEvent<TId>(
                                 DeepCloneGeneric(this.Id),
                                 this.TimestampUtc,
        ...
        /// <returns>New <see cref="BlockEvent{TId}" /> using the specified <paramref name="tags" /> for <see cref="Tags" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public BlockEvent<TId> DeepCloneWithTags(IReadOnlyDictionary<string, string> tags)
        {
            var result = new BlockEvent<TId>(
                                 DeepCloneGeneric(this.Id),
                                 this.TimestampUtc,
