...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class CancelBlockEvent<TId> : IModel<CancelBlockEvent<TId>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="CancelBlockEvent{TId}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(CancelBlockEvent<TId> left, CancelBlockEvent<TId> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="CancelBlockEvent{TId}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(CancelBlockEvent<TId> left, CancelBlockEvent<TId> right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(CancelBlockEvent<TId> other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as CancelBlockEvent<TId>);
        ...
        /// <inheritdoc />
        public new CancelBlockEvent<TId> DeepClone() => (CancelBlockEvent<TId>)this.DeepCloneInternal();
        ...
        {
            var result = new CancelBlockEvent<TId>(
                                 id,
                                 this.TimestampUtc,
        ...
        /// <returns>New <see cref="CancelBlockEvent{TId}" /> using the specified <paramref name="details" /> for <see cref="Details" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public CancelBlockEvent<TId> DeepCloneWithDetails(string details)
        {
            var result = new CancelBlockEvent<TId>(
                                 DeepCloneGeneric(this.Id),
                                 this.TimestampUtc,
        ...
        /// <returns>New <see cref="CancelBlockEvent{TId}" /> using the specified <paramref name="tags" /> for <see cref="Tags" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public CancelBlockEvent<TId> DeepCloneWithTags(IReadOnlyDictionary<string, string> tags)
        {
            var result = new CancelBlockEvent<TId>(
                                 DeepCloneGeneric(this.Id),
                                 this.TimestampUtc,
