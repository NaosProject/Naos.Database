...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class IdDeprecatedEvent<TId, TObject> : IModel<IdDeprecatedEvent<TId, TObject>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="IdDeprecatedEvent{TId, TObject}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(IdDeprecatedEvent<TId, TObject> left, IdDeprecatedEvent<TId, TObject> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="IdDeprecatedEvent{TId, TObject}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(IdDeprecatedEvent<TId, TObject> left, IdDeprecatedEvent<TId, TObject> right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(IdDeprecatedEvent<TId, TObject> other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as IdDeprecatedEvent<TId, TObject>);
        ...
        /// <inheritdoc />
        public new IdDeprecatedEvent<TId, TObject> DeepClone() => (IdDeprecatedEvent<TId, TObject>)this.DeepCloneInternal();
        ...
        {
            var result = new IdDeprecatedEvent<TId, TObject>(
        ...
        /// <returns>New <see cref="IdDeprecatedEvent{TId, TObject}" /> using the specified <paramref name="details" /> for <see cref="Details" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public IdDeprecatedEvent<TId, TObject> DeepCloneWithDetails(string details)
        {
            var result = new IdDeprecatedEvent<TId, TObject>(
                                 this.Id == null ? default : this.Id.DeepClone(),
                                 this.TimestampUtc.DeepClone(),
        ...
        {
            var result = Invariant($"Naos.Database.Domain.{this.GetType().ToStringReadable()}: TimestampUtc = {this.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Id = {this.Id?.ToString() ?? "<null>"}, Details = {this.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
