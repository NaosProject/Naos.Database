...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class IdDeprecatedEvent<TObject> : IModel<IdDeprecatedEvent<TObject>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="IdDeprecatedEvent{TObject}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(IdDeprecatedEvent<TObject> left, IdDeprecatedEvent<TObject> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="IdDeprecatedEvent{TObject}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(IdDeprecatedEvent<TObject> left, IdDeprecatedEvent<TObject> right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(IdDeprecatedEvent<TObject> other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as IdDeprecatedEvent<TObject>);
        ...
        /// <inheritdoc />
        public new IdDeprecatedEvent<TObject> DeepClone() => (IdDeprecatedEvent<TObject>)this.DeepCloneInternal();
        ...
        {
            var result = new IdDeprecatedEvent<TObject>(
                                 timestampUtc,
        ...
        /// <returns>New <see cref="IdDeprecatedEvent{TObject}" /> using the specified <paramref name="details" /> for <see cref="Details" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public IdDeprecatedEvent<TObject> DeepCloneWithDetails(string details)
        {
            var result = new IdDeprecatedEvent<TObject>(
        ...
        {
            var result = Invariant($"Naos.Database.Domain.{this.GetType().ToStringReadable()}: TimestampUtc = {this.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {this.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
