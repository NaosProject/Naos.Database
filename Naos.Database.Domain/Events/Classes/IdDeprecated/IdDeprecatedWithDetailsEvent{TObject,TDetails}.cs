// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IdDeprecatedWithDetailsEvent{TObject,TDetails}.cs" company="Naos Project">
...
namespace Naos.Database.Domain
{
    ...
    /// <see cref="IdDeprecatedWithDetailsEvent{TDetails}"/> or <see cref="IdDeprecatedWithDetailsEvent{TId, TObject, TDetails}"/>, how it is
    ...
    /// </remarks>
    public partial class IdDeprecatedWithDetailsEvent<TObject, TDetails> : EventBase
        where TDetails : class
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdDeprecatedWithDetailsEvent{TObject, TDetails}"/> class.
        /// </summary>
