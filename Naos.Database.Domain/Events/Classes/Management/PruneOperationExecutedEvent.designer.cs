    ...
    public partial class PruneOperationExecutedEvent : IModel<PruneOperationExecutedEvent>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.PruneOperation, options, propertyPathTracker, nameof(this.PruneOperation));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.PruneSummary, options, propertyPathTracker, nameof(this.PruneSummary));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
