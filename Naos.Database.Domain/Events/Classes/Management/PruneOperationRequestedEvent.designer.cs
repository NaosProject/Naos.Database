...
namespace Naos.Database.Domain
{
    ...
    public partial class PruneOperationRequestedEvent : IModel<PruneOperationRequestedEvent>
    {
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public PruneOperationRequestedEvent DeepCloneWithPruneOperation(IPruneOp pruneOperation)
        {
            var result = new PruneOperationRequestedEvent(
                                 pruneOperation,
        ...
        {
            var result = Invariant($"Naos.Database.Domain.PruneOperationRequestedEvent: TimestampUtc = {this.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, PruneOperation = {this.PruneOperation?.ToString() ?? "<null>"}.");
