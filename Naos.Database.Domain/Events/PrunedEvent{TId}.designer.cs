...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class PrunedEvent<TId> : IModel<PrunedEvent<TId>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="PrunedEvent{TId}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(PrunedEvent<TId> left, PrunedEvent<TId> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="PrunedEvent{TId}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(PrunedEvent<TId> left, PrunedEvent<TId> right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(PrunedEvent<TId> other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as PrunedEvent<TId>);
        ...
        /// <inheritdoc />
        public new PrunedEvent<TId> DeepClone() => (PrunedEvent<TId>)this.DeepCloneInternal();
        ...
        {
            var result = new PrunedEvent<TId>(
                                 id,
                                 this.TimestampUtc,
        ...
        /// <returns>New <see cref="PrunedEvent{TId}" /> using the specified <paramref name="details" /> for <see cref="Details" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public PrunedEvent<TId> DeepCloneWithDetails(string details)
        {
            var result = new PrunedEvent<TId>(
                                 DeepCloneGeneric(this.Id),
                                 this.TimestampUtc,
        ...
        /// <returns>New <see cref="PrunedEvent{TId}" /> using the specified <paramref name="tags" /> for <see cref="Tags" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public PrunedEvent<TId> DeepCloneWithTags(IReadOnlyDictionary<string, string> tags)
        {
            var result = new PrunedEvent<TId>(
                                 DeepCloneGeneric(this.Id),
                                 this.TimestampUtc,
