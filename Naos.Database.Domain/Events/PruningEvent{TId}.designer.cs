...
namespace Naos.Database.Domain
{
    ...
    public partial class PruningEvent<TId> : IModel<PruningEvent<TId>>
    {
        ...
        /// <returns>New <see cref="PruningEvent{TId}" /> using the specified <paramref name="pruner" /> for <see cref="Pruner" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public PruningEvent<TId> DeepCloneWithPruner(string pruner)
        {
            var result = new PruningEvent<TId>(
                                 DeepCloneGeneric(this.Id),
                                 this.TimestampUtc,
        ...
        {
            var result = Invariant($"Naos.Database.Domain.{this.GetType().ToStringReadable()}: Id = {this.Id?.ToString() ?? "<null>"}, TimestampUtc = {this.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Pruner = {this.Pruner?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Tags = {this.Tags?.ToString() ?? "<null>"}.");
