...
namespace Naos.Database.Domain
{
    ...
    public static partial class ReadOnlyStreamExtensions
    {
            ...
            IReadOnlyCollection<TypeRepresentation> deprecatedIdTypes = null)
        {
            ...
            var operation = new GetAllObjectsByIdOp<TId, TObject>(id, versionMatchStrategy, tagsToMatch, tagMatchStrategy, recordNotFoundStrategy, orderRecordsBy, deprecatedIdTypes);
