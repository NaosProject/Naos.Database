...
namespace Naos.Database.Domain
{
    ...
    public static partial class ReadOnlyStreamExtensions
    {
            ...
            IReadOnlyCollection<TypeRepresentation> deprecatedIdTypes = null)
        {
            ...
            var operation = new GetAllRecordsByIdOp<TId>(id, objectType, versionMatchStrategy, tagsToMatch, tagMatchStrategy, recordNotFoundStrategy, orderRecordsBy, deprecatedIdTypes);
