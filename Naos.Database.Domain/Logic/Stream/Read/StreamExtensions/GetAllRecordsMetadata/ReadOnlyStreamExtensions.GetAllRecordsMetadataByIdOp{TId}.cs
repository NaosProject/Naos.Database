...
namespace Naos.Database.Domain
{
    ...
    public static partial class ReadOnlyStreamExtensions
    {
            ...
            IReadOnlyCollection<TypeRepresentation> deprecatedIdTypes = null)
        {
            ...
            var operation = new GetAllRecordsMetadataByIdOp<TId>(id, objectType, versionMatchStrategy, tagsToMatch, tagMatchStrategy, recordNotFoundStrategy, orderRecordsBy, deprecatedIdTypes);
