...
namespace Naos.Database.Domain
{
    ...
    public static partial class ReadOnlyStreamExtensions
    {
            ...
            IReadOnlyCollection<TypeRepresentation> deprecatedIdTypes = null)
        {
            ...
            var operation = new GetLatestRecordMetadataByIdOp<TId>(id, objectType, versionMatchStrategy, tagsToMatch, tagMatchStrategy, recordNotFoundStrategy, deprecatedIdTypes);
