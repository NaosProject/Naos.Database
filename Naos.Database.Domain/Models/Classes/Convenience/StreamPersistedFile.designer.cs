...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class StreamPersistedFile : IModel<StreamPersistedFile>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="StreamPersistedFile"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(StreamPersistedFile left, StreamPersistedFile right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="StreamPersistedFile"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(StreamPersistedFile left, StreamPersistedFile right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(StreamPersistedFile other)
        {
            ...
            var result = this.Id.IsEqualTo(other.Id, StringComparer.Ordinal)
                      ...
                      && this.ByteCount.IsEqualTo(other.ByteCount);

            return result;
        }

        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as StreamPersistedFile);
        ...
        /// <returns>New <see cref="StreamPersistedFile" /> using the specified <paramref name="id" /> for <see cref="Id" /> and a deep clone of every other property.</returns>
        ...
        public StreamPersistedFile DeepCloneWithId(string id)
        {
            var result = new StreamPersistedFile(
                                 id,
                                 this.StreamRepresentation?.DeepClone(),
        ...
        /// <returns>New <see cref="StreamPersistedFile" /> using the specified <paramref name="streamRepresentation" /> for <see cref="StreamRepresentation" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public StreamPersistedFile DeepCloneWithStreamRepresentation(IStreamRepresentation streamRepresentation)
        {
            var result = new StreamPersistedFile(
                                 this.Id?.DeepClone(),
        ...
        /// <returns>New <see cref="StreamPersistedFile" /> using the specified <paramref name="fileName" /> for <see cref="FileName" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public StreamPersistedFile DeepCloneWithFileName(string fileName)
        {
            var result = new StreamPersistedFile(
                                 this.Id?.DeepClone(),
                                 this.StreamRepresentation?.DeepClone(),
        ...
        /// <summary>
        /// Deep clones this object with a new <see cref="ByteCount" />.
        /// </summary>
        /// <param name="byteCount">The new <see cref="ByteCount" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="StreamPersistedFile" /> using the specified <paramref name="byteCount" /> for <see cref="ByteCount" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public StreamPersistedFile DeepCloneWithByteCount(long byteCount)
        {
            var result = new StreamPersistedFile(
                                 this.Id?.DeepClone(),
                                 this.StreamRepresentation?.DeepClone(),
        ...
        {
            var result = Invariant($"Naos.Database.Domain.StreamPersistedFile: Id = {this.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, StreamRepresentation = {this.StreamRepresentation?.ToString() ?? "<null>"}, FileName = {this.FileName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, ByteCount = {this.ByteCount.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ByteCount, options, propertyPathTracker, nameof(this.ByteCount));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
