    ...
    public partial class CheckJobsReport : IModel<CheckJobsReport>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.JobNameToInformationMap, options, propertyPathTracker, nameof(this.JobNameToInformationMap));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
