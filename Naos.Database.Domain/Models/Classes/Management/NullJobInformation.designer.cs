...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class NullJobInformation : IModel<NullJobInformation>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="NullJobInformation"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(NullJobInformation left, NullJobInformation right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="NullJobInformation"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(NullJobInformation left, NullJobInformation right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(NullJobInformation other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as NullJobInformation);
        ...
        /// <inheritdoc />
        public NullJobInformation DeepClone()
        {
        ...
        /// <returns>New <see cref="NullJobInformation" /> using the specified <paramref name="jobName" /> for <see cref="JobName" /> and a deep clone of every other property.</returns>
        ...
        public NullJobInformation DeepCloneWithJobName(string jobName)
        {
            var result = new NullJobInformation(
                                 jobName);
        ...
        {
            var result = Invariant($"Naos.Database.Domain.NullJobInformation: JobName = {this.JobName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
