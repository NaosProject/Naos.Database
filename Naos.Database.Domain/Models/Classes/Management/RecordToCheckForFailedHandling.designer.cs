...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class RecordToCheckForFailedHandling : IModel<RecordToCheckForFailedHandling>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="RecordToCheckForFailedHandling"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(RecordToCheckForFailedHandling left, RecordToCheckForFailedHandling right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="RecordToCheckForFailedHandling"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(RecordToCheckForFailedHandling left, RecordToCheckForFailedHandling right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(RecordToCheckForFailedHandling other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as RecordToCheckForFailedHandling);
        ...
        /// <inheritdoc />
        public RecordToCheckForFailedHandling DeepClone()
        {
        ...
        /// <returns>New <see cref="RecordToCheckForFailedHandling" /> using the specified <paramref name="id" /> for <see cref="Id" /> and a deep clone of every other property.</returns>
        ...
        public RecordToCheckForFailedHandling DeepCloneWithId(string id)
        {
            var result = new RecordToCheckForFailedHandling(
                                 id,
                                 this.Concern?.DeepClone(),
        ...
        /// <returns>New <see cref="RecordToCheckForFailedHandling" /> using the specified <paramref name="concern" /> for <see cref="Concern" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public RecordToCheckForFailedHandling DeepCloneWithConcern(string concern)
        {
            var result = new RecordToCheckForFailedHandling(
                                 this.Id?.DeepClone(),
                                 concern,
        ...
        /// <returns>New <see cref="RecordToCheckForFailedHandling" /> using the specified <paramref name="recordFilter" /> for <see cref="RecordFilter" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public RecordToCheckForFailedHandling DeepCloneWithRecordFilter(RecordFilter recordFilter)
        {
            var result = new RecordToCheckForFailedHandling(
                                 this.Id?.DeepClone(),
                                 this.Concern?.DeepClone(),
        ...
        {
            var result = Invariant($"Naos.Database.Domain.RecordToCheckForFailedHandling: Id = {this.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Concern = {this.Concern?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, RecordFilter = {this.RecordFilter?.ToString() ?? "<null>"}.");
