    ...
    public partial class FileStreamRepresentation : IModel<FileStreamRepresentation>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.FileSystemDatabaseLocators, options, propertyPathTracker, nameof(this.FileSystemDatabaseLocators));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
