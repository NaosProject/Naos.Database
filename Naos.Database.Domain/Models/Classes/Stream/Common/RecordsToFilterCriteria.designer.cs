...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class RecordsToFilterCriteria : IModel<RecordsToFilterCriteria>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="RecordsToFilterCriteria"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(RecordsToFilterCriteria left, RecordsToFilterCriteria right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="RecordsToFilterCriteria"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(RecordsToFilterCriteria left, RecordsToFilterCriteria right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(RecordsToFilterCriteria other)
        {
            ...
            var result = this.RecordsToFilterSelectionStrategy.IsEqualTo(other.RecordsToFilterSelectionStrategy)
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as RecordsToFilterCriteria);
        ...
        /// <inheritdoc />
        public RecordsToFilterCriteria DeepClone()
        {
        ...
        /// <returns>New <see cref="RecordsToFilterCriteria" /> using the specified <paramref name="recordsToFilterSelectionStrategy" /> for <see cref="RecordsToFilterSelectionStrategy" /> and a deep clone of every other property.</returns>
        ...
        public RecordsToFilterCriteria DeepCloneWithRecordsToFilterSelectionStrategy(RecordsToFilterSelectionStrategy recordsToFilterSelectionStrategy)
        {
            var result = new RecordsToFilterCriteria(
        ...
        /// <returns>New <see cref="RecordsToFilterCriteria" /> using the specified <paramref name="versionMatchStrategy" /> for <see cref="VersionMatchStrategy" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public RecordsToFilterCriteria DeepCloneWithVersionMatchStrategy(VersionMatchStrategy versionMatchStrategy)
        {
            var result = new RecordsToFilterCriteria(
                                 this.RecordsToFilterSelectionStrategy.DeepClone(),
        ...
        {
            var result = Invariant($"Naos.Database.Domain.RecordsToFilterCriteria: RecordsToFilterSelectionStrategy = {this.RecordsToFilterSelectionStrategy.ToString() ?? "<null>"}, VersionMatchStrategy = {this.VersionMatchStrategy.ToString() ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.RecordsToFilterSelectionStrategy, options, propertyPathTracker, nameof(this.RecordsToFilterSelectionStrategy));
