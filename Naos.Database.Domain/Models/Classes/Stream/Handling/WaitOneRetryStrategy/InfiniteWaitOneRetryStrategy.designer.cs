...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class InfiniteWaitOneRetryStrategy : IModel<InfiniteWaitOneRetryStrategy>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="InfiniteWaitOneRetryStrategy"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(InfiniteWaitOneRetryStrategy left, InfiniteWaitOneRetryStrategy right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="InfiniteWaitOneRetryStrategy"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(InfiniteWaitOneRetryStrategy left, InfiniteWaitOneRetryStrategy right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(InfiniteWaitOneRetryStrategy other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as InfiniteWaitOneRetryStrategy);

        /// <inheritdoc />
        public override int GetHashCode() => HashCodeHelper.Initialize()
            .Hash("InfiniteWaitOneRetryStrategy")
            .Value;

        /// <inheritdoc />
        public new InfiniteWaitOneRetryStrategy DeepClone() => (InfiniteWaitOneRetryStrategy)this.DeepCloneInternal();

        /// <inheritdoc />
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        protected override WaitOneRetryStrategyBase DeepCloneInternal()
        {
            var result = new InfiniteWaitOneRetryStrategy();
        ...
        {
            var result = Invariant($"Naos.Database.Domain.InfiniteWaitOneRetryStrategy: <no properties>.");
