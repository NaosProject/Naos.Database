    ...
    public partial class CreateStreamResult : IModel<CreateStreamResult>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.AlreadyExisted, options, propertyPathTracker, nameof(this.AlreadyExisted));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.WasCreated, options, propertyPathTracker, nameof(this.WasCreated));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
