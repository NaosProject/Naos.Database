    ...
    public partial class PruneSummary : IModel<PruneSummary>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.InternalRecordIdsRemoved, options, propertyPathTracker, nameof(this.InternalRecordIdsRemoved));
