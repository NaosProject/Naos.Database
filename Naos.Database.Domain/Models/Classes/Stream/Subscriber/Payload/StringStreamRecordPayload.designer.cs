...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class StringStreamRecordPayload : IModel<StringStreamRecordPayload>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="StringStreamRecordPayload"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(StringStreamRecordPayload left, StringStreamRecordPayload right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="StringStreamRecordPayload"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(StringStreamRecordPayload left, StringStreamRecordPayload right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(StringStreamRecordPayload other)
        {
            ...
            var result = this.SerializedPayload.IsEqualTo(other.SerializedPayload, StringComparer.Ordinal);

            return result;
        }

        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as StringStreamRecordPayload);
        ...
        /// <inheritdoc />
        public new StringStreamRecordPayload DeepClone() => (StringStreamRecordPayload)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="StringStreamRecordPayload" /> using the specified <paramref name="serializedPayload" /> for <see cref="SerializedPayload" /> and a deep clone of every other property.</returns>
        ...
        public StringStreamRecordPayload DeepCloneWithSerializedPayload(string serializedPayload)
        {
        ...
        {
            var result = Invariant($"Naos.Database.Domain.StringStreamRecordPayload: SerializedPayload = {this.SerializedPayload?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
