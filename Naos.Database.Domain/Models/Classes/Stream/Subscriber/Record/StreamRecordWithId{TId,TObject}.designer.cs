...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class StreamRecordWithId<TId, TObject> : IModel<StreamRecordWithId<TId, TObject>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="StreamRecordWithId{TId, TObject}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(StreamRecordWithId<TId, TObject> left, StreamRecordWithId<TId, TObject> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="StreamRecordWithId{TId, TObject}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(StreamRecordWithId<TId, TObject> left, StreamRecordWithId<TId, TObject> right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(StreamRecordWithId<TId, TObject> other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as StreamRecordWithId<TId, TObject>);
        ...
        /// <inheritdoc />
        public StreamRecordWithId<TId, TObject> DeepClone()
        {
            var result = new StreamRecordWithId<TId, TObject>(
                                 this.InternalRecordId.DeepClone(),
                                 this.Metadata?.DeepClone(),
                                 this.Payload == null ? default : this.Payload.DeepClone());
        ...
        /// <returns>New <see cref="StreamRecordWithId{TId, TObject}" /> using the specified <paramref name="internalRecordId" /> for <see cref="InternalRecordId" /> and a deep clone of every other property.</returns>
        ...
        public StreamRecordWithId<TId, TObject> DeepCloneWithInternalRecordId(long internalRecordId)
        {
            var result = new StreamRecordWithId<TId, TObject>(
                                 internalRecordId,
                                 this.Metadata?.DeepClone(),
        ...
        /// <returns>New <see cref="StreamRecordWithId{TId, TObject}" /> using the specified <paramref name="metadata" /> for <see cref="Metadata" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public StreamRecordWithId<TId, TObject> DeepCloneWithMetadata(StreamRecordMetadata<TId> metadata)
        {
            var result = new StreamRecordWithId<TId, TObject>(
                                 this.InternalRecordId.DeepClone(),
                                 metadata,
        ...
        /// <returns>New <see cref="StreamRecordWithId{TId, TObject}" /> using the specified <paramref name="payload" /> for <see cref="Payload" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public StreamRecordWithId<TId, TObject> DeepCloneWithPayload(TObject payload)
        {
            var result = new StreamRecordWithId<TId, TObject>(
                                 this.InternalRecordId.DeepClone(),
                                 this.Metadata?.DeepClone(),
