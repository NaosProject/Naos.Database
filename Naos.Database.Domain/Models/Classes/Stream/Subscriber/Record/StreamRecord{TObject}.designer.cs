...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class StreamRecord<TObject> : IModel<StreamRecord<TObject>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="StreamRecord{TObject}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(StreamRecord<TObject> left, StreamRecord<TObject> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="StreamRecord{TObject}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(StreamRecord<TObject> left, StreamRecord<TObject> right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(StreamRecord<TObject> other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as StreamRecord<TObject>);
        ...
        /// <inheritdoc />
        public StreamRecord<TObject> DeepClone()
        {
            var result = new StreamRecord<TObject>(
        ...
        /// <returns>New <see cref="StreamRecord{TObject}" /> using the specified <paramref name="internalRecordId" /> for <see cref="InternalRecordId" /> and a deep clone of every other property.</returns>
        ...
        public StreamRecord<TObject> DeepCloneWithInternalRecordId(long internalRecordId)
        {
            var result = new StreamRecord<TObject>(
                                 internalRecordId,
                                 this.Metadata?.DeepClone(),
        ...
        /// <returns>New <see cref="StreamRecord{TObject}" /> using the specified <paramref name="metadata" /> for <see cref="Metadata" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public StreamRecord<TObject> DeepCloneWithMetadata(StreamRecordMetadata metadata)
        {
            var result = new StreamRecord<TObject>(
                                 this.InternalRecordId.DeepClone(),
                                 metadata,
        ...
        /// <returns>New <see cref="StreamRecord{TObject}" /> using the specified <paramref name="payload" /> for <see cref="Payload" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public StreamRecord<TObject> DeepCloneWithPayload(TObject payload)
        {
            var result = new StreamRecord<TObject>(
                                 this.InternalRecordId.DeepClone(),
                                 this.Metadata?.DeepClone(),
