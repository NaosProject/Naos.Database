    ...
    public partial class PutRecordResult : IModel<PutRecordResult>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.InternalRecordIdOfPutRecord, options, propertyPathTracker, nameof(this.InternalRecordIdOfPutRecord));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ExistingRecordIds, options, propertyPathTracker, nameof(this.ExistingRecordIds));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.PrunedRecordIds, options, propertyPathTracker, nameof(this.PrunedRecordIds));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
