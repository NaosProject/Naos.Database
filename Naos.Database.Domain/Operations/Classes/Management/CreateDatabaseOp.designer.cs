    ...
    public partial class CreateDatabaseOp : IModel<CreateDatabaseOp>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Definition, options, propertyPathTracker, nameof(this.Definition));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ExistingDatabaseStrategy, options, propertyPathTracker, nameof(this.ExistingDatabaseStrategy));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
