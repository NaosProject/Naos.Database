    ...
    public partial class GetStreamFromRepresentationOp<TStreamRepresentation, TStream> : IModel<GetStreamFromRepresentationOp<TStreamRepresentation, TStream>>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.TypedStreamRepresentation, options, propertyPathTracker, nameof(this.TypedStreamRepresentation));
