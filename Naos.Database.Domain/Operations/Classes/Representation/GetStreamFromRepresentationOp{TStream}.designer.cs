...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class GetStreamFromRepresentationOp<TStream> : IModel<GetStreamFromRepresentationOp<TStream>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="GetStreamFromRepresentationOp{TStream}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(GetStreamFromRepresentationOp<TStream> left, GetStreamFromRepresentationOp<TStream> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="GetStreamFromRepresentationOp{TStream}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(GetStreamFromRepresentationOp<TStream> left, GetStreamFromRepresentationOp<TStream> right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(GetStreamFromRepresentationOp<TStream> other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as GetStreamFromRepresentationOp<TStream>);
        ...
        /// <inheritdoc />
        public new GetStreamFromRepresentationOp<TStream> DeepClone() => (GetStreamFromRepresentationOp<TStream>)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="GetStreamFromRepresentationOp{TStream}" /> using the specified <paramref name="streamRepresentation" /> for <see cref="StreamRepresentation" /> and a deep clone of every other property.</returns>
        ...
        public GetStreamFromRepresentationOp<TStream> DeepCloneWithStreamRepresentation(IStreamRepresentation streamRepresentation)
        {
            var result = new GetStreamFromRepresentationOp<TStream>(
