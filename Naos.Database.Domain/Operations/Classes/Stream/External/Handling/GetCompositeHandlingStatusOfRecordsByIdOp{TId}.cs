// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetCompositeHandlingStatusOfRecordsByIdOp{TId}.cs" company="Naos Project">
...
namespace Naos.Database.Domain
{
    ...
    public partial class GetCompositeHandlingStatusOfRecordsByIdOp<TId> : ReturningOperationBase<CompositeHandlingStatus>, IHaveHandleRecordConcern
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCompositeHandlingStatusOfRecordsByIdOp{TId}"/> class.
        /// </summary>
