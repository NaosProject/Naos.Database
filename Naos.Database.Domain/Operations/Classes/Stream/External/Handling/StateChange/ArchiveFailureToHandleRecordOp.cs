// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ArchiveFailureToHandleRecordOp.cs" company="Naos Project">
...
namespace Naos.Database.Domain
{
    ...
    /// <summary>
    /// Marks a record that was handled for a specified concern as having executed with an error; handling has failed and was then archived.
    /// </summary>
    public partial class ArchiveFailureToHandleRecordOp : VoidOperationBase, IHaveInternalRecordId, IHaveTags, IHaveHandleRecordConcern, IHaveDetails
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchiveFailureToHandleRecordOp"/> class.
        /// </summary>
        ...
        public ArchiveFailureToHandleRecordOp(
