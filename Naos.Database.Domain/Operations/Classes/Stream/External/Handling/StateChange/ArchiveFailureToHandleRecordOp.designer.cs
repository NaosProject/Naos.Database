...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class ArchiveFailureToHandleRecordOp : IModel<ArchiveFailureToHandleRecordOp>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ArchiveFailureToHandleRecordOp"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(ArchiveFailureToHandleRecordOp left, ArchiveFailureToHandleRecordOp right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ArchiveFailureToHandleRecordOp"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(ArchiveFailureToHandleRecordOp left, ArchiveFailureToHandleRecordOp right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(ArchiveFailureToHandleRecordOp other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ArchiveFailureToHandleRecordOp);
        ...
        /// <inheritdoc />
        public new ArchiveFailureToHandleRecordOp DeepClone() => (ArchiveFailureToHandleRecordOp)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="ArchiveFailureToHandleRecordOp" /> using the specified <paramref name="internalRecordId" /> for <see cref="InternalRecordId" /> and a deep clone of every other property.</returns>
        ...
        public ArchiveFailureToHandleRecordOp DeepCloneWithInternalRecordId(long internalRecordId)
        {
        ...
        /// <returns>New <see cref="ArchiveFailureToHandleRecordOp" /> using the specified <paramref name="concern" /> for <see cref="Concern" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ArchiveFailureToHandleRecordOp DeepCloneWithConcern(string concern)
        {
            var result = new ArchiveFailureToHandleRecordOp(
        ...
        /// <returns>New <see cref="ArchiveFailureToHandleRecordOp" /> using the specified <paramref name="details" /> for <see cref="Details" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ArchiveFailureToHandleRecordOp DeepCloneWithDetails(string details)
        {
            var result = new ArchiveFailureToHandleRecordOp(
                                 this.InternalRecordId.DeepClone(),
                                 this.Concern?.DeepClone(),
        ...
        /// <returns>New <see cref="ArchiveFailureToHandleRecordOp" /> using the specified <paramref name="tags" /> for <see cref="Tags" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ArchiveFailureToHandleRecordOp DeepCloneWithTags(IReadOnlyCollection<NamedValue<string>> tags)
        {
            var result = new ArchiveFailureToHandleRecordOp(
                                 this.InternalRecordId.DeepClone(),
                                 this.Concern?.DeepClone(),
        ...
        /// <returns>New <see cref="ArchiveFailureToHandleRecordOp" /> using the specified <paramref name="inheritRecordTags" /> for <see cref="InheritRecordTags" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ArchiveFailureToHandleRecordOp DeepCloneWithInheritRecordTags(bool inheritRecordTags)
        {
            var result = new ArchiveFailureToHandleRecordOp(
                                 this.InternalRecordId.DeepClone(),
                                 this.Concern?.DeepClone(),
