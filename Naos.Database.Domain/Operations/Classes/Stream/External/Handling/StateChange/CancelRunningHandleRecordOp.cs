// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CancelRunningHandleRecordOp.cs" company="Naos Project">
...
namespace Naos.Database.Domain
{
    ...
    /// This is used for external cancellation.
    /// When the handling cancels itself, <see cref="SelfCancelRunningHandleRecordOp"/> is used.
    /// </summary>
    public partial class CancelRunningHandleRecordOp : VoidOperationBase, IHaveInternalRecordId, IHaveTags, IHaveHandleRecordConcern, IHaveDetails
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelRunningHandleRecordOp"/> class.
        /// </summary>
        ...
        public CancelRunningHandleRecordOp(
