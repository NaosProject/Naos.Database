...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class CompleteRunningHandleRecordOp : IModel<CompleteRunningHandleRecordOp>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="CompleteRunningHandleRecordOp"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(CompleteRunningHandleRecordOp left, CompleteRunningHandleRecordOp right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="CompleteRunningHandleRecordOp"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(CompleteRunningHandleRecordOp left, CompleteRunningHandleRecordOp right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(CompleteRunningHandleRecordOp other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as CompleteRunningHandleRecordOp);
        ...
        /// <inheritdoc />
        public new CompleteRunningHandleRecordOp DeepClone() => (CompleteRunningHandleRecordOp)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="CompleteRunningHandleRecordOp" /> using the specified <paramref name="internalRecordId" /> for <see cref="InternalRecordId" /> and a deep clone of every other property.</returns>
        ...
        public CompleteRunningHandleRecordOp DeepCloneWithInternalRecordId(long internalRecordId)
        {
        ...
        /// <returns>New <see cref="CompleteRunningHandleRecordOp" /> using the specified <paramref name="concern" /> for <see cref="Concern" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public CompleteRunningHandleRecordOp DeepCloneWithConcern(string concern)
        {
            var result = new CompleteRunningHandleRecordOp(
        ...
        /// <returns>New <see cref="CompleteRunningHandleRecordOp" /> using the specified <paramref name="details" /> for <see cref="Details" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public CompleteRunningHandleRecordOp DeepCloneWithDetails(string details)
        {
            var result = new CompleteRunningHandleRecordOp(
                                 this.InternalRecordId.DeepClone(),
                                 this.Concern?.DeepClone(),
        ...
        /// <returns>New <see cref="CompleteRunningHandleRecordOp" /> using the specified <paramref name="tags" /> for <see cref="Tags" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public CompleteRunningHandleRecordOp DeepCloneWithTags(IReadOnlyCollection<NamedValue<string>> tags)
        {
            var result = new CompleteRunningHandleRecordOp(
                                 this.InternalRecordId.DeepClone(),
                                 this.Concern?.DeepClone(),
        ...
        /// <returns>New <see cref="CompleteRunningHandleRecordOp" /> using the specified <paramref name="inheritRecordTags" /> for <see cref="InheritRecordTags" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public CompleteRunningHandleRecordOp DeepCloneWithInheritRecordTags(bool inheritRecordTags)
        {
            var result = new CompleteRunningHandleRecordOp(
                                 this.InternalRecordId.DeepClone(),
                                 this.Concern?.DeepClone(),
