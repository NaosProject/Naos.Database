// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ResetCompletedHandleRecordOp.cs" company="Naos Project">
...
namespace Naos.Database.Domain
{
    ...
    /// <summary>
    /// Resets a record that was handled for a specified concern, whose execution resulted in a successful completion.
    /// This makes the record available for handling for that concern.
    /// </summary>
    public partial class ResetCompletedHandleRecordOp : VoidOperationBase, IHaveInternalRecordId, IHaveTags, IHaveHandleRecordConcern, IHaveDetails
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResetCompletedHandleRecordOp"/> class.
        /// </summary>
        ...
        public ResetCompletedHandleRecordOp(
