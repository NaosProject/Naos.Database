// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetAllRecordsMetadataOp.cs" company="Naos Project">
...
namespace Naos.Database.Domain
{
    ...
    /// </remarks>
    public partial class GetAllRecordsMetadataOp : ReturningOperationBase<IReadOnlyList<StreamRecordMetadata>>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAllRecordsMetadataOp"/> class.
        /// </summary>
