// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetAllRecordsMetadataOp{TId}.cs" company="Naos Project">
...
namespace Naos.Database.Domain
{
    ...
    /// unless <see cref="RecordNotFoundStrategy"/> instructs protocol to throw.
    /// </remarks>
    /// <typeparam name="TId">The type of the identifier of the object.</typeparam>
    public partial class GetAllRecordsMetadataOp<TId> : ReturningOperationBase<IReadOnlyList<StreamRecordMetadata<TId>>>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAllRecordsMetadataOp{TId}"/> class.
        /// </summary>
        ...
        public GetAllRecordsMetadataOp(
