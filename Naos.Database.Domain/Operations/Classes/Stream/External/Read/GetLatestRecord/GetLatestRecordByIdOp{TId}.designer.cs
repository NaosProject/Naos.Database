...
namespace Naos.Database.Domain
{
    ...
    public partial class GetLatestRecordByIdOp<TId> : IModel<GetLatestRecordByIdOp<TId>>
    {
        ...
        /// <returns>New <see cref="GetLatestRecordByIdOp{TId}" /> using the specified <paramref name="typeSelectionStrategy" /> for <see cref="TypeSelectionStrategy" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public GetLatestRecordByIdOp<TId> DeepCloneWithTypeSelectionStrategy(TypeSelectionStrategy typeSelectionStrategy)
        {
            var result = new GetLatestRecordByIdOp<TId>(
                                 this.Id == null ? default : this.Id.DeepClone(),
                                 this.ObjectType?.DeepClone(),
