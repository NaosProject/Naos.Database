...
namespace Naos.Database.Domain
{
    ...
    public partial class StandardGetHandlingStatusOp : IModel<StandardGetHandlingStatusOp>
    {
        ...
        {
            var result = Invariant($"Naos.Database.Domain.StandardGetHandlingStatusOp: Concern = {this.Concern?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, RecordFilter = {this.RecordFilter?.ToString() ?? "<null>"}, SpecifiedResourceLocator = {this.SpecifiedResourceLocator?.ToString() ?? "<null>"}.");
