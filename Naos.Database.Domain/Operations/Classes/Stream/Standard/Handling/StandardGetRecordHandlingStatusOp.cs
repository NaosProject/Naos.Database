...
namespace Naos.Database.Domain
{
    ...
    /// Handles a record.
    /// </summary>
    public partial class StandardGetRecordHandlingStatusOp : ReturningOperationBase<IReadOnlyCollection<HandlingStatus>>, ISpecifyResourceLocator, IHaveHandleRecordConcern
    {
        /// <summary>
