...
namespace Naos.Database.Domain
{
    ...
    public partial class StandardUpdateStreamHandlingOp : VoidOperationBase, IHaveDetails, ISpecifyResourceLocator
    {
        ...
        {
            if (newStatus != HandlingStatus.DisabledForStream && newStatus != HandlingStatus.AvailableByDefault)
            {
                throw new ArgumentException(Invariant($"The {nameof(newStatus)} of '{newStatus}' is not supported; must be {HandlingStatus.DisabledForStream} or {HandlingStatus.AvailableByDefault}."));
            }
            ...
            if (acceptableCurrentStatuses.Any(_ => _ != HandlingStatus.DisabledForStream && _ != HandlingStatus.AvailableByDefault))
            {
                throw new ArgumentException(Invariant($"The {nameof(acceptableCurrentStatuses)} has unsupported statuses; must be {HandlingStatus.DisabledForStream} or {HandlingStatus.AvailableByDefault}."));
            }
