    ...
    public partial class StandardDeleteStreamOp : IModel<StandardDeleteStreamOp>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.StreamNotFoundStrategy, options, propertyPathTracker, nameof(this.StreamNotFoundStrategy));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
