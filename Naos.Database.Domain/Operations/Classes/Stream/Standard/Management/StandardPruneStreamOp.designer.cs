    ...
    public partial class StandardPruneStreamOp : IModel<StandardPruneStreamOp>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.RecordTimestampUtc, options, propertyPathTracker, nameof(this.RecordTimestampUtc));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
