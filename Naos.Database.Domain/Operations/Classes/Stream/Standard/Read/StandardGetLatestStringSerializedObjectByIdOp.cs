// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StandardGetLatestStringSerializedObjectByIdOp.cs" company="Naos Project">
...
namespace Naos.Database.Domain
{
    ...
    /// </remarks>
    public partial class StandardGetLatestStringSerializedObjectByIdOp : ReturningOperationBase<string>, ISpecifyResourceLocator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StandardGetLatestStringSerializedObjectByIdOp"/> class.
        /// </summary>
        ...
        public StandardGetLatestStringSerializedObjectByIdOp(
