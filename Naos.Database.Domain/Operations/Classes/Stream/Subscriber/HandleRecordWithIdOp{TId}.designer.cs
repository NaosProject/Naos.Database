...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class HandleRecordWithIdOp<TId> : IModel<HandleRecordWithIdOp<TId>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="HandleRecordWithIdOp{TId}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(HandleRecordWithIdOp<TId> left, HandleRecordWithIdOp<TId> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="HandleRecordWithIdOp{TId}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(HandleRecordWithIdOp<TId> left, HandleRecordWithIdOp<TId> right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(HandleRecordWithIdOp<TId> other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as HandleRecordWithIdOp<TId>);
        ...
        /// <inheritdoc />
        public new HandleRecordWithIdOp<TId> DeepClone() => (HandleRecordWithIdOp<TId>)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="HandleRecordWithIdOp{TId}" /> using the specified <paramref name="recordToHandle" /> for <see cref="RecordToHandle" /> and a deep clone of every other property.</returns>
        ...
        public HandleRecordWithIdOp<TId> DeepCloneWithRecordToHandle(StreamRecordWithId<TId> recordToHandle)
        {
            var result = new HandleRecordWithIdOp<TId>(
                                 recordToHandle);
