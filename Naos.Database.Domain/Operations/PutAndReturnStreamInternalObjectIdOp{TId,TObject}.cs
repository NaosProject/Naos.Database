...
namespace Naos.Database.Domain
{
    ...
    public partial class PutAndReturnStreamInternalObjectIdOp<TId, TObject> : ReturningOperationBase<long>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutAndReturnStreamInternalObjectIdOp{TId, TObject}"/> class.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <param name="objectToPut">The object to put into a stream.</param>
        public PutAndReturnStreamInternalObjectIdOp(TId id, TObject objectToPut)
        {
            this.Id = id;
