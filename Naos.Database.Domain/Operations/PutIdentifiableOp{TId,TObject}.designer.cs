...
namespace Naos.Database.Domain
{
    ...
    [Serializable]
    public partial class PutIdentifiableOp<TId, TObject> : IModel<PutIdentifiableOp<TId, TObject>>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="PutIdentifiableOp{TId, TObject}"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(PutIdentifiableOp<TId, TObject> left, PutIdentifiableOp<TId, TObject> right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="PutIdentifiableOp{TId, TObject}"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(PutIdentifiableOp<TId, TObject> left, PutIdentifiableOp<TId, TObject> right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(PutIdentifiableOp<TId, TObject> other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as PutIdentifiableOp<TId, TObject>);
        ...
        /// <inheritdoc />
        public new PutIdentifiableOp<TId, TObject> DeepClone() => (PutIdentifiableOp<TId, TObject>)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="PutIdentifiableOp{TId, TObject}" /> using the specified <paramref name="objectToPut" /> for <see cref="ObjectToPut" /> and a deep clone of every other property.</returns>
        ...
        public PutIdentifiableOp<TId, TObject> DeepCloneWithObjectToPut(TObject objectToPut)
        {
            var result = new PutIdentifiableOp<TId, TObject>(
                                 objectToPut,
        ...
        /// <returns>New <see cref="PutIdentifiableOp{TId, TObject}" /> using the specified <paramref name="tags" /> for <see cref="Tags" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public PutIdentifiableOp<TId, TObject> DeepCloneWithTags(IReadOnlyDictionary<string, string> tags)
        {
            var result = new PutIdentifiableOp<TId, TObject>(
