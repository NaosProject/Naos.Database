// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StandardGetAllRecordsMetadataByIdOp.cs" company="Naos Project">
...
namespace Naos.Database.Domain
{
    ...
    /// </remarks>
    public partial class StandardGetAllRecordsMetadataByIdOp : ReturningOperationBase<IReadOnlyList<StreamRecordMetadata>>, ISpecifyResourceLocator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StandardGetAllRecordsMetadataByIdOp"/> class.
        /// </summary>
        ...
        public StandardGetAllRecordsMetadataByIdOp(
