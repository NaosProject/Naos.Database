// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StandardGetLatestRecordMetadataByIdOp.cs" company="Naos Project">
...
namespace Naos.Database.Domain
{
    ...
    /// </remarks>
    public partial class StandardGetLatestRecordMetadataByIdOp : ReturningOperationBase<StreamRecordMetadata>, ISpecifyResourceLocator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StandardGetLatestRecordMetadataByIdOp"/> class.
        /// </summary>
        ...
        public StandardGetLatestRecordMetadataByIdOp(
