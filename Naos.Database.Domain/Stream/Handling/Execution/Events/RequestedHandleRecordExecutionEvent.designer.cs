...
namespace Naos.Database.Domain
{
    ...
    public partial class RequestedHandleRecordExecutionEvent : IModel<RequestedHandleRecordExecutionEvent>
    {
        ...
        /// <returns>New <see cref="RequestedHandleRecordExecutionEvent" /> using the specified <paramref name="recordToHandle" /> for <see cref="RecordToHandle" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public RequestedHandleRecordExecutionEvent DeepCloneWithRecordToHandle(StreamRecord recordToHandle)
        {
            var result = new RequestedHandleRecordExecutionEvent(
                                 this.Id,
                                 this.TimestampUtc,
        ...
        {
            var result = Invariant($"Naos.Database.Domain.RequestedHandleRecordExecutionEvent: TimestampUtc = {this.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Id = {this.Id.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, RecordToHandle = {this.RecordToHandle?.ToString() ?? "<null>"}.");
