...
namespace Naos.Database.Domain
{
    ...
    public partial class GetHandlingHistoryOfRecordOp : IModel<GetHandlingHistoryOfRecordOp>
    {
        ...
        {
            var result = Invariant($"Naos.Database.Domain.GetHandlingHistoryOfRecordOp: InternalRecordId = {this.InternalRecordId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
