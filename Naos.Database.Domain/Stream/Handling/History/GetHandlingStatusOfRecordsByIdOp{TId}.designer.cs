...
namespace Naos.Database.Domain
{
    ...
    public partial class GetHandlingStatusOfRecordsByIdOp<TId> : IModel<GetHandlingStatusOfRecordsByIdOp<TId>>
    {
        ...
        {
            var result = Invariant($"Naos.Database.Domain.{this.GetType().ToStringReadable()}: IdsToMatch = {this.IdsToMatch?.ToString() ?? "<null>"}, TypeVersionMatchStrategy = {this.TypeVersionMatchStrategy.ToString() ?? "<null>"}.");
