// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StreamRecordHandlingEntry{TObject}.cs" company="Naos Project">
...
namespace Naos.Database.Domain
{
    ...
    public partial class StreamRecordHandlingEntry<TObject> : IHaveTags, IModelViaCodeGen, IHaveTimestampUtc
    {
        /// <summary>
