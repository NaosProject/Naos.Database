...
namespace Naos.Database.Domain
{
    ...
    public partial class TryHandleRecordOp<TObject> : IModel<TryHandleRecordOp<TObject>>
    {
        ...
        /// <returns>New <see cref="TryHandleRecordOp{TObject}" /> using the specified <paramref name="recordToHandle" /> for <see cref="RecordToHandle" /> and a deep clone of every other property.</returns>
        ...
        public TryHandleRecordOp<TObject> DeepCloneWithRecordToHandle(StreamRecord<TObject> recordToHandle)
        {
