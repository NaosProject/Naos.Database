...
namespace Naos.Database.Domain
{
    ...
    public partial class TryHandleRecordWithIdOp<TId, TObject> : ReturningOperationBase<StreamRecordWithId<TId, TObject>>, ISpecifyResourceLocator, IHaveTags, IHaveDetails
    {
        /// <summary>
