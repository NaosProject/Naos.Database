...
namespace Naos.Database.Domain
{
    ...
    public partial class TryHandleRecordWithIdOp<TId, TObject> : IModel<TryHandleRecordWithIdOp<TId, TObject>>
    {
        ...
        /// <returns>New <see cref="TryHandleRecordWithIdOp{TId, TObject}" /> using the specified <paramref name="recordToHandle" /> for <see cref="RecordToHandle" /> and a deep clone of every other property.</returns>
        ...
        public TryHandleRecordWithIdOp<TId, TObject> DeepCloneWithRecordToHandle(StreamRecordWithId<TId, TObject> recordToHandle)
        {
