...
namespace Naos.Database.Domain
{
    ...
    public partial class TryHandleRecordWithIdOp<TId> : IModel<TryHandleRecordWithIdOp<TId>>
    {
        ...
        /// <returns>New <see cref="TryHandleRecordWithIdOp{TId}" /> using the specified <paramref name="recordToHandle" /> for <see cref="RecordToHandle" /> and a deep clone of every other property.</returns>
        ...
        public TryHandleRecordWithIdOp<TId> DeepCloneWithRecordToHandle(StreamRecordWithId<TId> recordToHandle)
        {
