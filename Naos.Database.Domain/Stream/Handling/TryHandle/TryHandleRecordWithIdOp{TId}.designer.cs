...
namespace Naos.Database.Domain
{
    ...
    public partial class TryHandleRecordWithIdOp<TId> : IModel<TryHandleRecordWithIdOp<TId>>
    {
        ...
        /// <returns>New <see cref="TryHandleRecordWithIdOp{TId}" /> using the specified <paramref name="typeVersionMatchStrategy" /> for <see cref="TypeVersionMatchStrategy" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public TryHandleRecordWithIdOp<TId> DeepCloneWithTypeVersionMatchStrategy(TypeVersionMatchStrategy typeVersionMatchStrategy)
        {
            var result = new TryHandleRecordWithIdOp<TId>(
                                 this.Concern?.DeepClone(),
                                 this.ObjectType?.DeepClone(),
        ...
        /// <returns>New <see cref="TryHandleRecordWithIdOp{TId}" /> using the specified <paramref name="orderRecordsStrategy" /> for <see cref="OrderRecordsStrategy" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public TryHandleRecordWithIdOp<TId> DeepCloneWithOrderRecordsStrategy(OrderRecordsStrategy orderRecordsStrategy)
        {
            var result = new TryHandleRecordWithIdOp<TId>(
                                 this.Concern?.DeepClone(),
                                 this.ObjectType?.DeepClone(),
        ...
        /// <returns>New <see cref="TryHandleRecordWithIdOp{TId}" /> using the specified <paramref name="specifiedResourceLocator" /> for <see cref="SpecifiedResourceLocator" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public TryHandleRecordWithIdOp<TId> DeepCloneWithSpecifiedResourceLocator(IResourceLocator specifiedResourceLocator)
        {
            var result = new TryHandleRecordWithIdOp<TId>(
                                 this.Concern?.DeepClone(),
                                 this.ObjectType?.DeepClone(),
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public TryHandleRecordWithIdOp<TId> DeepCloneWithTags(IReadOnlyDictionary<string, string> tags)
        {
            var result = new TryHandleRecordWithIdOp<TId>(
                                 this.Concern?.DeepClone(),
                                 this.ObjectType?.DeepClone(),
