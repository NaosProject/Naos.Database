...
namespace Naos.Database.Domain
{
    ...
    public partial class PruneBeforeInternalRecordIdOp : IModel<PruneBeforeInternalRecordIdOp>
    {
        ...
        /// <returns>New <see cref="PruneBeforeInternalRecordIdOp" /> using the specified <paramref name="tags" /> for <see cref="Tags" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public PruneBeforeInternalRecordIdOp DeepCloneWithTags(IReadOnlyDictionary<string, string> tags)
        {
            var result = new PruneBeforeInternalRecordIdOp(
                                 this.MaxInternalRecordId,
                                 this.Details?.DeepClone(),
        ...
        {
            var result = Invariant($"Naos.Database.Domain.PruneBeforeInternalRecordIdOp: MaxInternalRecordId = {this.MaxInternalRecordId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {this.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Tags = {this.Tags?.ToString() ?? "<null>"}.");
