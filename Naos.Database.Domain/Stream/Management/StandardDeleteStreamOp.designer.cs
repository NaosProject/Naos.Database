...
namespace Naos.Database.Domain
{
    ...
    public partial class StandardDeleteStreamOp : IModel<StandardDeleteStreamOp>
    {
        ...
        {
            var result = Invariant($"Naos.Database.Domain.DeleteStreamOp: StreamRepresentation = {this.StreamRepresentation?.ToString() ?? "<null>"}, StreamNotFoundStrategy = {this.StreamNotFoundStrategy.ToString() ?? "<null>"}.");
