...
namespace Naos.Database.Domain
{
    ...
    public partial class UniqueLongIssuedEvent : IModel<UniqueLongIssuedEvent>
    {
        ...
        {
            var result = Invariant($"Naos.Database.Domain.UniqueLongIssuedEvent: TimestampUtc = {this.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Id = {this.Id.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Details = {this.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
