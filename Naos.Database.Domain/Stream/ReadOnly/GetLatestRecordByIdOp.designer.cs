...
namespace Naos.Database.Domain
{
    ...
    public partial class GetLatestRecordByIdOp : IModel<GetLatestRecordByIdOp>
    {
        ...
        /// <returns>New <see cref="GetLatestRecordByIdOp" /> using the specified <paramref name="locator" /> for <see cref="Locator" /> and a deep clone of every other property.</returns>
        ...
        public GetLatestRecordByIdOp DeepCloneWithLocator(IResourceLocator locator)
        {
