...
namespace Naos.Database.Domain
{
    ...
    public partial class GetLatestRecordByIdOp<TId> : IModel<GetLatestRecordByIdOp<TId>>
    {
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public GetLatestRecordByIdOp<TId> DeepCloneWithObjectType(TypeRepresentationWithAndWithoutVersion objectType)
        {
            var result = new GetLatestRecordByIdOp<TId>(
        ...
        {
            var result = Invariant($"Naos.Database.Domain.{this.GetType().ToStringReadable()}: Id = {this.Id?.ToString() ?? "<null>"}, ObjectType = {this.ObjectType?.ToString() ?? "<null>"}, TypeVersionMatchStrategy = {this.TypeVersionMatchStrategy.ToString() ?? "<null>"}.");
