// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetLatestRecordMetadataByIdOp.cs" company="Naos Project">
...
namespace Naos.Database.Domain
{
    ...
    /// </summary>
    public partial class GetLatestRecordMetadataByIdOp : ReturningOperationBase<StreamRecordMetadata>, ISpecifyResourceLocator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLatestRecordMetadataByIdOp"/> class.
        /// </summary>
