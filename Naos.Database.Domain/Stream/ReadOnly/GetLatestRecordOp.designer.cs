...
namespace Naos.Database.Domain
{
    ...
    public partial class GetLatestRecordOp : IModel<GetLatestRecordOp>
    {
        ...
        /// <returns>New <see cref="GetLatestRecordOp" /> using the specified <paramref name="internalRecordId" /> for <see cref="InternalRecordId" /> and a deep clone of every other property.</returns>
        ...
        public GetLatestRecordOp DeepCloneWithInternalRecordId(long? internalRecordId)
        {
