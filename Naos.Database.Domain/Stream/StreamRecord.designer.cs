...
namespace Naos.Database.Protocol.Memory
{
    ...
    public partial class StreamRecord : IModel<StreamRecord>
    {
        ...
        /// <returns>New <see cref="StreamRecord" /> using the specified <paramref name="id" /> for <see cref="Id" /> and a deep clone of every other property.</returns>
        ...
        public StreamRecord DeepCloneWithId(long id)
        {
            var result = new StreamRecord(
                                 id,
                                 this.Metadata?.DeepClone(),
        ...
        {
            var result = Invariant($"Naos.Database.Protocol.Memory.StreamRecord: Id = {this.Id.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Metadata = {this.Metadata?.ToString() ?? "<null>"}, Payload = {this.Payload?.ToString() ?? "<null>"}.");
