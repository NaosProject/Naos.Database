...
namespace Naos.Database.Domain
{
    ...
    public partial class PutWithIdOp<TId, TObject> : IModel<PutWithIdOp<TId, TObject>>
    {
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public PutWithIdOp<TId, TObject> DeepCloneWithTags(IReadOnlyDictionary<string, string> tags)
        {
            var result = new PutWithIdOp<TId, TObject>(
                                 DeepCloneGeneric(this.Id),
                                 DeepCloneGeneric(this.ObjectToPut),
        ...
        /// <returns>New <see cref="PutWithIdOp{TId, TObject}" /> using the specified <paramref name="existingRecordEncounteredStrategy" /> for <see cref="ExistingRecordEncounteredStrategy" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public PutWithIdOp<TId, TObject> DeepCloneWithExistingRecordEncounteredStrategy(ExistingRecordEncounteredStrategy existingRecordEncounteredStrategy)
        {
            var result = new PutWithIdOp<TId, TObject>(
                                 DeepCloneGeneric(this.Id),
                                 DeepCloneGeneric(this.ObjectToPut),
        ...
        /// <returns>New <see cref="PutWithIdOp{TId, TObject}" /> using the specified <paramref name="typeVersionMatchStrategy" /> for <see cref="TypeVersionMatchStrategy" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public PutWithIdOp<TId, TObject> DeepCloneWithTypeVersionMatchStrategy(TypeVersionMatchStrategy typeVersionMatchStrategy)
        {
            var result = new PutWithIdOp<TId, TObject>(
                                 DeepCloneGeneric(this.Id),
                                 DeepCloneGeneric(this.ObjectToPut),
