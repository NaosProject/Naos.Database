...
#endif
{
    ...
    public static partial class HandlerFactory
    {
        ...
        /// </summary>
        private static readonly IReadOnlyDictionary<Type, Type> MessageTypeToHandlerTypeMap = DiscoverHandlersInAssemblies(new[] { typeof(BackupDatabaseMessage).Assembly, typeof(BackupDatabaseMessageHandler).Assembly });
    }
