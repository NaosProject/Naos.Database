...
namespace Naos.Database.Protocol.FileSystem
{
    ...
    public static class FilePathExtensions
    {
        ...
        [SuppressMessage("Microsoft.Performance", "CA1810:InitializeReferenceTypeStaticFieldsInline", Justification = "All are declared in static constructor.")]
        ...
        {
            return input.ToString(Invariant($"D{minimumNumberOfDigits}"), CultureInfo.InvariantCulture);
        }
