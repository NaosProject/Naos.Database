...
namespace Naos.Database.SqlServer.Administration
{
    ...
    public static class SqlServerDatabaseManager
    {
            ...
            SqlInfoMessageEventHandler infoMessageCallback = null)
        {
            ...
            {
                connection.InfoMessage += infoMessageCallback;
            }
        ...
        public static async Task RunOperationOnSqlConnectionAsync(this Func<SqlConnection, Task> asyncAction, string connectionString, SqlInfoMessageEventHandler infoMessageCallback = null)
        {
            ...
            using (var connection = OpenConnection(connectionString, infoMessageCallback))
            {
        ...
        /// Runs the specified operation against the <see cref="Database" /> object.
        /// </summary>
        /// <param name="asyncAction">Operation to run against the SMO database, <see cref="Naos.Database" />.</param>
        /// <param name="connectionString">Database connection string.</param>
        /// <param name="infoMessageCallback">Optional callback to capture information messages sent on connection.</param>
        /// <returns>Task for async.</returns>
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Smo", Justification = "Spelling/name is correct.")]
        public static async Task RunOperationOnSmoDatabaseAsync(Func<Database, Task> asyncAction, string connectionString, SqlInfoMessageEventHandler infoMessageCallback = null)
        {
            ...
            await RunOperationOnSqlConnectionAsync(ConnectionAction, connectionString, infoMessageCallback);
        }

        /// <summary>
        /// Runs the specified operation against the <see cref="Naos.Database" /> object.
        /// </summary>
        /// <param name="asyncAction">Operation to run against the SMO database, <see cref="Naos.Database" />.</param>
