...
namespace Naos.Recipes.RunWithRetry
{
    ...
    internal static class Run
    {
        ...
        public static void RunUntilCompletion(this Task task, TimeSpan pollingInterval = default(TimeSpan), TaskWaitingStrategy taskWaitingStrategy = TaskWaitingStrategy.Sleep)
        {
            TaskUntilCompletion(task, pollingInterval, taskWaitingStrategy);
        }

        public static T RunUntilCompletion<T>(this Task<T> task, TimeSpan pollingInterval = default(TimeSpan), TaskWaitingStrategy taskWaitingStrategy = TaskWaitingStrategy.Sleep)
        {
            return TaskUntilCompletion(task, pollingInterval, taskWaitingStrategy);
        }
    }
