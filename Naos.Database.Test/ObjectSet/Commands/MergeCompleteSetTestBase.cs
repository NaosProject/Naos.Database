...
namespace Naos.Database.Test
{
    ...
    public abstract class MergeCompleteSetTestBase
    {
        ...
        {
            var ex = Record.Exception(() => Database.ModelCommands.MergeCompleteSetAsync(null).RunUntilCompletion());
        ...
        {
            var ex = Record.Exception(() => Database.StorageModelCommands.MergeCompleteSetAsync(null).RunUntilCompletion());
